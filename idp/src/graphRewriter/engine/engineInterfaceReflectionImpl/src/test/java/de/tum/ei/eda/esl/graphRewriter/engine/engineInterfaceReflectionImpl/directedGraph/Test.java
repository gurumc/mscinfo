...
public class Test {
	...
	public static void main(String[] args) throws NoSuchMethodException, SecurityException {	
		Graph<Node, Edge> hostGraph = HostGraphTwo.createSampleGraph();
		
		Graph<PatternNE, PatternNE> lhs = LHSGraphTwo.createPatternGraph();
		Graph<RewriterNE, RewriterNE> rhs = RHSGraphTwo.createPatternGraph();
		Rule rule = new Rule();
	...
	public static Graph<Node,Edge> constructMatchedSubgraph(Graph<Node, Edge> hostGraph, Graph<PatternNE, PatternNE> lhs, Match<Node, Edge> match) {

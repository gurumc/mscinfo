...
public class HierConnectionsTypeImpl extends MinimalEObjectImpl.Container implements HierConnectionsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getHierConnectionsType();
	}
	...
	public EList<HierConnectionType> getHierConnection() {
		if (hierConnection == null) {
			hierConnection = new EObjectContainmentEList<HierConnectionType>(HierConnectionType.class, this, spiritPackage.HIER_CONNECTIONS_TYPE__HIER_CONNECTION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.HIER_CONNECTIONS_TYPE__HIER_CONNECTION:

 ...
 * @generated
 */
public class ComponentInstanceTypeImpl extends MinimalEObjectImpl.Container implements ComponentInstanceType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getComponentInstanceType();
	}
	...
	public void setInstanceName(String newInstanceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__INSTANCE_NAME, oldInstanceName, instanceName));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetComponentRef(LibraryRefType newComponentRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__COMPONENT_REF, oldComponentRef, newComponentRef);
	...
	public void setComponentRef(LibraryRefType newComponentRef) {
		if (newComponentRef != componentRef) {
			...
			if (componentRef != null)
				msgs = ((InternalEObject)componentRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_INSTANCE_TYPE__COMPONENT_REF, null, msgs);
			if (newComponentRef != null)
				msgs = ((InternalEObject)newComponentRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_INSTANCE_TYPE__COMPONENT_REF, null, msgs);
			msgs = basicSetComponentRef(newComponentRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__COMPONENT_REF, newComponentRef, newComponentRef));
	}
	...
	public NotificationChain basicSetConfigurableElementValues(ConfigurableElementValuesType newConfigurableElementValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__CONFIGURABLE_ELEMENT_VALUES, oldConfigurableElementValues, newConfigurableElementValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfigurableElementValues(ConfigurableElementValuesType newConfigurableElementValues) {
		if (newConfigurableElementValues != configurableElementValues) {
			...
			if (configurableElementValues != null)
				msgs = ((InternalEObject)configurableElementValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_INSTANCE_TYPE__CONFIGURABLE_ELEMENT_VALUES, null, msgs);
			if (newConfigurableElementValues != null)
				msgs = ((InternalEObject)newConfigurableElementValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_INSTANCE_TYPE__CONFIGURABLE_ELEMENT_VALUES, null, msgs);
			msgs = basicSetConfigurableElementValues(newConfigurableElementValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__CONFIGURABLE_ELEMENT_VALUES, newConfigurableElementValues, newConfigurableElementValues));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_INSTANCE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_INSTANCE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_INSTANCE_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.COMPONENT_INSTANCE_TYPE__COMPONENT_REF:
				return basicSetComponentRef(null, msgs);
			case spiritPackage.COMPONENT_INSTANCE_TYPE__CONFIGURABLE_ELEMENT_VALUES:
				return basicSetConfigurableElementValues(null, msgs);
			case spiritPackage.COMPONENT_INSTANCE_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.COMPONENT_INSTANCE_TYPE__INSTANCE_NAME:
				return getInstanceName();
			case spiritPackage.COMPONENT_INSTANCE_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.COMPONENT_INSTANCE_TYPE__DESCRIPTION:

 ...
 * @generated
 */
public class QualifierType1Impl extends MinimalEObjectImpl.Container implements QualifierType1 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getQualifierType1();
	}
	...
	public void setIsAddress(boolean newIsAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.QUALIFIER_TYPE1__IS_ADDRESS, oldIsAddress, isAddress, !oldIsAddressESet));
	}
	...
	public void unsetIsAddress() {
		...
		isAddressESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.QUALIFIER_TYPE1__IS_ADDRESS, oldIsAddress, IS_ADDRESS_EDEFAULT, oldIsAddressESet));
	}
	...
	public void setIsData(boolean newIsData) {
		...
		isDataESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.QUALIFIER_TYPE1__IS_DATA, oldIsData, isData, !oldIsDataESet));
	}
	...
	public void unsetIsData() {
		...
		isDataESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.QUALIFIER_TYPE1__IS_DATA, oldIsData, IS_DATA_EDEFAULT, oldIsDataESet));
	}
	...
	public void setIsClock(boolean newIsClock) {
		...
		isClockESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.QUALIFIER_TYPE1__IS_CLOCK, oldIsClock, isClock, !oldIsClockESet));
	}
	...
	public void unsetIsClock() {
		...
		isClockESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.QUALIFIER_TYPE1__IS_CLOCK, oldIsClock, IS_CLOCK_EDEFAULT, oldIsClockESet));
	}
	...
	public void setIsReset(boolean newIsReset) {
		...
		isResetESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.QUALIFIER_TYPE1__IS_RESET, oldIsReset, isReset, !oldIsResetESet));
	}
	...
	public void unsetIsReset() {
		...
		isResetESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.QUALIFIER_TYPE1__IS_RESET, oldIsReset, IS_RESET_EDEFAULT, oldIsResetESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.QUALIFIER_TYPE1__IS_ADDRESS:
				return isIsAddress();
			case spiritPackage.QUALIFIER_TYPE1__IS_DATA:
				return isIsData();
			case spiritPackage.QUALIFIER_TYPE1__IS_CLOCK:
				return isIsClock();
			case spiritPackage.QUALIFIER_TYPE1__IS_RESET:
				return isIsReset();
		}

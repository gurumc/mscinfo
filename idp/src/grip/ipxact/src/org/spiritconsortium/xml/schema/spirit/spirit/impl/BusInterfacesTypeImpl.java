...
public class BusInterfacesTypeImpl extends MinimalEObjectImpl.Container implements BusInterfacesType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getBusInterfacesType();
	}
	...
	public EList<BusInterfaceType> getBusInterface() {
		if (busInterface == null) {
			busInterface = new EObjectContainmentEList<BusInterfaceType>(BusInterfaceType.class, this, spiritPackage.BUS_INTERFACES_TYPE__BUS_INTERFACE);
		}
		return busInterface;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.BUS_INTERFACES_TYPE__BUS_INTERFACE:

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Type Name Type11</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.TypeNameType11Impl#getValue <em>Value</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.TypeNameType11Impl#isConstrained <em>Constrained</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.TypeNameType11Impl#isImplicit <em>Implicit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TypeNameType11Impl extends MinimalEObjectImpl.Container implements TypeNameType11 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getTypeNameType11();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TYPE_NAME_TYPE11__VALUE, oldValue, value));
	}
	...
	public void setConstrained(boolean newConstrained) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TYPE_NAME_TYPE11__CONSTRAINED, oldConstrained, constrained, !oldConstrainedESet));
	}
	...
	public void unsetConstrained() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.TYPE_NAME_TYPE11__CONSTRAINED, oldConstrained, CONSTRAINED_EDEFAULT, oldConstrainedESet));
	}
	...
	public void setImplicit(boolean newImplicit) {
		...
		implicitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TYPE_NAME_TYPE11__IMPLICIT, oldImplicit, implicit, !oldImplicitESet));
	}
	...
	public void unsetImplicit() {
		...
		implicitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.TYPE_NAME_TYPE11__IMPLICIT, oldImplicit, IMPLICIT_EDEFAULT, oldImplicitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.TYPE_NAME_TYPE11__VALUE:
				return getValue();
			case spiritPackage.TYPE_NAME_TYPE11__CONSTRAINED:
				return isConstrained();
			case spiritPackage.TYPE_NAME_TYPE11__IMPLICIT:
				return isImplicit();
		}

 ...
 * @generated
 */
public class ExecutableImageTypeImpl extends MinimalEObjectImpl.Container implements ExecutableImageType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getExecutableImageType();
	}
	...
	public NotificationChain basicSetName(NameType2 newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__NAME, oldName, newName);
	...
	public void setName(NameType2 newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__NAME, null, msgs);
			if (newName != null)
				msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__NAME, null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__NAME, newName, newName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetLanguageTools(LanguageToolsType newLanguageTools, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__LANGUAGE_TOOLS, oldLanguageTools, newLanguageTools);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLanguageTools(LanguageToolsType newLanguageTools) {
		if (newLanguageTools != languageTools) {
			...
			if (languageTools != null)
				msgs = ((InternalEObject)languageTools).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__LANGUAGE_TOOLS, null, msgs);
			if (newLanguageTools != null)
				msgs = ((InternalEObject)newLanguageTools).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__LANGUAGE_TOOLS, null, msgs);
			msgs = basicSetLanguageTools(newLanguageTools, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__LANGUAGE_TOOLS, newLanguageTools, newLanguageTools));
	}
	...
	public NotificationChain basicSetFileSetRefGroup(FileSetRefGroupType1 newFileSetRefGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__FILE_SET_REF_GROUP, oldFileSetRefGroup, newFileSetRefGroup);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFileSetRefGroup(FileSetRefGroupType1 newFileSetRefGroup) {
		if (newFileSetRefGroup != fileSetRefGroup) {
			...
			if (fileSetRefGroup != null)
				msgs = ((InternalEObject)fileSetRefGroup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__FILE_SET_REF_GROUP, null, msgs);
			if (newFileSetRefGroup != null)
				msgs = ((InternalEObject)newFileSetRefGroup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__FILE_SET_REF_GROUP, null, msgs);
			msgs = basicSetFileSetRefGroup(newFileSetRefGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__FILE_SET_REF_GROUP, newFileSetRefGroup, newFileSetRefGroup));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.EXECUTABLE_IMAGE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__ID, oldId, id));
	}
	...
	public void setImageType(String newImageType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXECUTABLE_IMAGE_TYPE__IMAGE_TYPE, oldImageType, imageType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__NAME:
				return basicSetName(null, msgs);
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__LANGUAGE_TOOLS:
				return basicSetLanguageTools(null, msgs);
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__FILE_SET_REF_GROUP:
				return basicSetFileSetRefGroup(null, msgs);
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__NAME:
				return getName();
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__DESCRIPTION:
			...
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__ID:
				return getId();
			case spiritPackage.EXECUTABLE_IMAGE_TYPE__IMAGE_TYPE:
				return getImageType();
		}

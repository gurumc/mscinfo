 ...
 * @generated
 */
public class GeneratorChainTypeImpl extends MinimalEObjectImpl.Container implements GeneratorChainType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<String> chainGroup;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getGeneratorChainType();
	}
	...
	public void setVendor(String newVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setLibrary(String newLibrary) {
		...
		library = newLibrary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__VERSION, oldVersion, version));
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, spiritPackage.GENERATOR_CHAIN_TYPE__GROUP);
		}
		return group;
	}
	 ...
	 * @generated
	 */
	public EList<GeneratorChainSelectorType> getGeneratorChainSelector() {
		return getGroup().list(spiritPackage.eINSTANCE.getGeneratorChainType_GeneratorChainSelector());
	}
	 ...
	 * @generated
	 */
	public EList<GeneratorSelectorType> getComponentGeneratorSelector() {
		return getGroup().list(spiritPackage.eINSTANCE.getGeneratorChainType_ComponentGeneratorSelector());
	}
	 ...
	 * @generated
	 */
	public EList<GeneratorType> getGenerator() {
		return getGroup().list(spiritPackage.eINSTANCE.getGeneratorChainType_Generator());
	}
	 ...
	 * @generated
	 */
	public EList<String> getChainGroup() {
		if (chainGroup == null) {
			chainGroup = new EDataTypeEList<String>(String.class, this, spiritPackage.GENERATOR_CHAIN_TYPE__CHAIN_GROUP);
		}
		return chainGroup;
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetChoices(ChoicesType newChoices, NotificationChain msgs) {
		...
		choices = newChoices;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__CHOICES, oldChoices, newChoices);
	...
	public void setChoices(ChoicesType newChoices) {
		if (newChoices != choices) {
			...
			if (choices != null)
				msgs = ((InternalEObject)choices).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_CHAIN_TYPE__CHOICES, null, msgs);
			if (newChoices != null)
				msgs = ((InternalEObject)newChoices).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_CHAIN_TYPE__CHOICES, null, msgs);
			msgs = basicSetChoices(newChoices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__CHOICES, newChoices, newChoices));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setHidden(boolean newHidden) {
		...
		hiddenESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_CHAIN_TYPE__HIDDEN, oldHidden, hidden, !oldHiddenESet));
	}
	...
	public void unsetHidden() {
		...
		hiddenESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.GENERATOR_CHAIN_TYPE__HIDDEN, oldHidden, HIDDEN_EDEFAULT, oldHiddenESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.GENERATOR_CHAIN_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case spiritPackage.GENERATOR_CHAIN_TYPE__GENERATOR_CHAIN_SELECTOR:
				return ((InternalEList<?>)getGeneratorChainSelector()).basicRemove(otherEnd, msgs);
			case spiritPackage.GENERATOR_CHAIN_TYPE__COMPONENT_GENERATOR_SELECTOR:
				return ((InternalEList<?>)getComponentGeneratorSelector()).basicRemove(otherEnd, msgs);
			case spiritPackage.GENERATOR_CHAIN_TYPE__GENERATOR:
				return ((InternalEList<?>)getGenerator()).basicRemove(otherEnd, msgs);
			case spiritPackage.GENERATOR_CHAIN_TYPE__CHOICES:
				return basicSetChoices(null, msgs);
			case spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR:
				return getVendor();
			case spiritPackage.GENERATOR_CHAIN_TYPE__LIBRARY:
				return getLibrary();
			case spiritPackage.GENERATOR_CHAIN_TYPE__NAME:
				return getName();
			case spiritPackage.GENERATOR_CHAIN_TYPE__VERSION:
				return getVersion();
			case spiritPackage.GENERATOR_CHAIN_TYPE__GROUP:
			...
			case spiritPackage.GENERATOR_CHAIN_TYPE__GENERATOR:
				return getGenerator();
			case spiritPackage.GENERATOR_CHAIN_TYPE__CHAIN_GROUP:
				return getChainGroup();
			case spiritPackage.GENERATOR_CHAIN_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.GENERATOR_CHAIN_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.GENERATOR_CHAIN_TYPE__CHOICES:
				return getChoices();
			case spiritPackage.GENERATOR_CHAIN_TYPE__VENDOR_EXTENSIONS:
				return getVendorExtensions();
			case spiritPackage.GENERATOR_CHAIN_TYPE__HIDDEN:
				return isHidden();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.GENERATOR_CHAIN_TYPE__GENERATOR_CHAIN_SELECTOR:
				...
				getGeneratorChainSelector().addAll((Collection<? extends GeneratorChainSelectorType>)newValue);
				return;
			case spiritPackage.GENERATOR_CHAIN_TYPE__COMPONENT_GENERATOR_SELECTOR:
				getComponentGeneratorSelector().clear();
				getComponentGeneratorSelector().addAll((Collection<? extends GeneratorSelectorType>)newValue);
				return;
			case spiritPackage.GENERATOR_CHAIN_TYPE__GENERATOR:
				getGenerator().clear();
				getGenerator().addAll((Collection<? extends GeneratorType>)newValue);
				return;
			case spiritPackage.GENERATOR_CHAIN_TYPE__CHAIN_GROUP:
				getChainGroup().clear();
				getChainGroup().addAll((Collection<? extends String>)newValue);
				return;
			case spiritPackage.GENERATOR_CHAIN_TYPE__DISPLAY_NAME:

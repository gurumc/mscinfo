...
public class TransportMethodsTypeImpl extends MinimalEObjectImpl.Container implements TransportMethodsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getTransportMethodsType();
	}
	...
	public void setTransportMethod(TransportMethodType newTransportMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TRANSPORT_METHODS_TYPE__TRANSPORT_METHOD, oldTransportMethod, transportMethod, !oldTransportMethodESet));
	}
	...
	public void unsetTransportMethod() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.TRANSPORT_METHODS_TYPE__TRANSPORT_METHOD, oldTransportMethod, TRANSPORT_METHOD_EDEFAULT, oldTransportMethodESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.TRANSPORT_METHODS_TYPE__TRANSPORT_METHOD:

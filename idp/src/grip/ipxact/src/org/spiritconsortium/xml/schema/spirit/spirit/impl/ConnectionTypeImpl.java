...
public class ConnectionTypeImpl extends MinimalEObjectImpl.Container implements ConnectionType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getConnectionType();
	}
	...
	public void setMaxConnections(BigInteger newMaxConnections) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONNECTION_TYPE__MAX_CONNECTIONS, oldMaxConnections, maxConnections, !oldMaxConnectionsESet));
	}
	...
	public void unsetMaxConnections() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.CONNECTION_TYPE__MAX_CONNECTIONS, oldMaxConnections, MAX_CONNECTIONS_EDEFAULT, oldMaxConnectionsESet));
	}
	...
	public void setMinConnections(BigInteger newMinConnections) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONNECTION_TYPE__MIN_CONNECTIONS, oldMinConnections, minConnections, !oldMinConnectionsESet));
	}
	...
	public void unsetMinConnections() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.CONNECTION_TYPE__MIN_CONNECTIONS, oldMinConnections, MIN_CONNECTIONS_EDEFAULT, oldMinConnectionsESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.CONNECTION_TYPE__MAX_CONNECTIONS:
				return getMaxConnections();
			case spiritPackage.CONNECTION_TYPE__MIN_CONNECTIONS:

 ...
 * @generated
 */
public class MemoryMapRefTypeImpl extends MinimalEObjectImpl.Container implements MemoryMapRefType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getMemoryMapRefType();
	}
	...
	public void setMemoryMapRef(String newMemoryMapRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_REF_TYPE__MEMORY_MAP_REF, oldMemoryMapRef, memoryMapRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.MEMORY_MAP_REF_TYPE__MEMORY_MAP_REF:

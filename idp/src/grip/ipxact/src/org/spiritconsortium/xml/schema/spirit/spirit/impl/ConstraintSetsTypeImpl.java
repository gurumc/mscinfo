...
public class ConstraintSetsTypeImpl extends MinimalEObjectImpl.Container implements ConstraintSetsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getConstraintSetsType();
	}
	...
	public EList<ConstraintSetType> getConstraintSet() {
		if (constraintSet == null) {
			constraintSet = new EObjectContainmentEList<ConstraintSetType>(ConstraintSetType.class, this, spiritPackage.CONSTRAINT_SETS_TYPE__CONSTRAINT_SET);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CONSTRAINT_SETS_TYPE__CONSTRAINT_SET:

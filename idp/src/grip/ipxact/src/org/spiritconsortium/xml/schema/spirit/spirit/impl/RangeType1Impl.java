...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Range Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getValue <em>Value</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getBitStringLength <em>Bit String Length</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getChoiceRef <em>Choice Ref</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getConfigGroups <em>Config Groups</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getDependency <em>Dependency</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getId <em>Id</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getOrder <em>Order</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getPrompt <em>Prompt</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getRangeType <em>Range Type</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getResolve <em>Resolve</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.RangeType1Impl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RangeType1Impl extends MinimalEObjectImpl.Container implements RangeType1 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getRangeType1();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__VALUE, oldValue, value));
	}
	...
	public void setBitStringLength(BigInteger newBitStringLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__BIT_STRING_LENGTH, oldBitStringLength, bitStringLength));
	}
	...
	public void setChoiceRef(String newChoiceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__CHOICE_REF, oldChoiceRef, choiceRef));
	}
	...
	public void setConfigGroups(List<String> newConfigGroups) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__CONFIG_GROUPS, oldConfigGroups, configGroups));
	}
	...
	public void setDependency(String newDependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__DEPENDENCY, oldDependency, dependency));
	}
	...
	public void setFormat(FormatType newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.RANGE_TYPE1__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__ID, oldId, id));
	}
	...
	public void setMaximum(String newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMinimum(String newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setOrder(float newOrder) {
		...
		orderESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__ORDER, oldOrder, order, !oldOrderESet));
	}
	...
	public void unsetOrder() {
		...
		orderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.RANGE_TYPE1__ORDER, oldOrder, ORDER_EDEFAULT, oldOrderESet));
	}
	...
	public void setPrompt(String newPrompt) {
		...
		prompt = newPrompt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__PROMPT, oldPrompt, prompt));
	}
	...
	public void setRangeType(RangeTypeType newRangeType) {
		...
		rangeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__RANGE_TYPE, oldRangeType, rangeType, !oldRangeTypeESet));
	}
	...
	public void unsetRangeType() {
		...
		rangeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.RANGE_TYPE1__RANGE_TYPE, oldRangeType, RANGE_TYPE_EDEFAULT, oldRangeTypeESet));
	}
	...
	public void setResolve(ResolveType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RANGE_TYPE1__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.RANGE_TYPE1__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, spiritPackage.RANGE_TYPE1__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.RANGE_TYPE1__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.RANGE_TYPE1__VALUE:
				return getValue();
			case spiritPackage.RANGE_TYPE1__BIT_STRING_LENGTH:
				return getBitStringLength();
			case spiritPackage.RANGE_TYPE1__CHOICE_REF:
				return getChoiceRef();
			case spiritPackage.RANGE_TYPE1__CONFIG_GROUPS:
				return getConfigGroups();
			case spiritPackage.RANGE_TYPE1__DEPENDENCY:
				return getDependency();
			case spiritPackage.RANGE_TYPE1__FORMAT:
				return getFormat();
			case spiritPackage.RANGE_TYPE1__ID:
				return getId();
			case spiritPackage.RANGE_TYPE1__MAXIMUM:
				return getMaximum();
			case spiritPackage.RANGE_TYPE1__MINIMUM:
				return getMinimum();
			case spiritPackage.RANGE_TYPE1__ORDER:
				return getOrder();
			case spiritPackage.RANGE_TYPE1__PROMPT:
				return getPrompt();
			case spiritPackage.RANGE_TYPE1__RANGE_TYPE:
				return getRangeType();
			case spiritPackage.RANGE_TYPE1__RESOLVE:
				return getResolve();
			case spiritPackage.RANGE_TYPE1__ANY_ATTRIBUTE:

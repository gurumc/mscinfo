 ...
 * @generated
 */
public class AbstractorType1Impl extends MinimalEObjectImpl.Container implements AbstractorType1 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractorType1();
	}
	...
	public void setVendor(String newVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__VENDOR, oldVendor, vendor));
	}
	...
	public void setLibrary(String newLibrary) {
		...
		library = newLibrary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__VERSION, oldVersion, version));
	}
	...
	public NotificationChain basicSetAbstractorMode(AbstractorModeType1 newAbstractorMode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_MODE, oldAbstractorMode, newAbstractorMode);
	...
	public void setAbstractorMode(AbstractorModeType1 newAbstractorMode) {
		if (newAbstractorMode != abstractorMode) {
			...
			if (abstractorMode != null)
				msgs = ((InternalEObject)abstractorMode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_MODE, null, msgs);
			if (newAbstractorMode != null)
				msgs = ((InternalEObject)newAbstractorMode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_MODE, null, msgs);
			msgs = basicSetAbstractorMode(newAbstractorMode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_MODE, newAbstractorMode, newAbstractorMode));
	}
	...
	public NotificationChain basicSetBusType(LibraryRefType newBusType, NotificationChain msgs) {
		...
		busType = newBusType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__BUS_TYPE, oldBusType, newBusType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBusType(LibraryRefType newBusType) {
		if (newBusType != busType) {
			NotificationChain msgs = null;
			if (busType != null)
				msgs = ((InternalEObject)busType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__BUS_TYPE, null, msgs);
			if (newBusType != null)
				msgs = ((InternalEObject)newBusType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__BUS_TYPE, null, msgs);
			msgs = basicSetBusType(newBusType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__BUS_TYPE, newBusType, newBusType));
	}
	...
	public NotificationChain basicSetAbstractorInterfaces(AbstractorInterfacesType newAbstractorInterfaces, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_INTERFACES, oldAbstractorInterfaces, newAbstractorInterfaces);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAbstractorInterfaces(AbstractorInterfacesType newAbstractorInterfaces) {
		if (newAbstractorInterfaces != abstractorInterfaces) {
			...
			if (abstractorInterfaces != null)
				msgs = ((InternalEObject)abstractorInterfaces).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_INTERFACES, null, msgs);
			if (newAbstractorInterfaces != null)
				msgs = ((InternalEObject)newAbstractorInterfaces).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_INTERFACES, null, msgs);
			msgs = basicSetAbstractorInterfaces(newAbstractorInterfaces, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_INTERFACES, newAbstractorInterfaces, newAbstractorInterfaces));
	}
	...
	public NotificationChain basicSetModel(AbstractorModelType newModel, NotificationChain msgs) {
		...
		model = newModel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__MODEL, oldModel, newModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setModel(AbstractorModelType newModel) {
		if (newModel != model) {
			NotificationChain msgs = null;
			if (model != null)
				msgs = ((InternalEObject)model).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__MODEL, null, msgs);
			if (newModel != null)
				msgs = ((InternalEObject)newModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__MODEL, null, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__MODEL, newModel, newModel));
	}
	...
	public NotificationChain basicSetAbstractorGenerators(AbstractorGeneratorsType newAbstractorGenerators, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_GENERATORS, oldAbstractorGenerators, newAbstractorGenerators);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAbstractorGenerators(AbstractorGeneratorsType newAbstractorGenerators) {
		if (newAbstractorGenerators != abstractorGenerators) {
			...
			if (abstractorGenerators != null)
				msgs = ((InternalEObject)abstractorGenerators).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_GENERATORS, null, msgs);
			if (newAbstractorGenerators != null)
				msgs = ((InternalEObject)newAbstractorGenerators).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_GENERATORS, null, msgs);
			msgs = basicSetAbstractorGenerators(newAbstractorGenerators, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_GENERATORS, newAbstractorGenerators, newAbstractorGenerators));
	}
	...
	public NotificationChain basicSetChoices(ChoicesType newChoices, NotificationChain msgs) {
		...
		choices = newChoices;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__CHOICES, oldChoices, newChoices);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setChoices(ChoicesType newChoices) {
		if (newChoices != choices) {
			NotificationChain msgs = null;
			if (choices != null)
				msgs = ((InternalEObject)choices).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__CHOICES, null, msgs);
			if (newChoices != null)
				msgs = ((InternalEObject)newChoices).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__CHOICES, null, msgs);
			msgs = basicSetChoices(newChoices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__CHOICES, newChoices, newChoices));
	}
	...
	public NotificationChain basicSetFileSets(FileSetsType newFileSets, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__FILE_SETS, oldFileSets, newFileSets);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFileSets(FileSetsType newFileSets) {
		if (newFileSets != fileSets) {
			NotificationChain msgs = null;
			if (fileSets != null)
				msgs = ((InternalEObject)fileSets).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__FILE_SETS, null, msgs);
			if (newFileSets != null)
				msgs = ((InternalEObject)newFileSets).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__FILE_SETS, null, msgs);
			msgs = basicSetFileSets(newFileSets, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__FILE_SETS, newFileSets, newFileSets));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE1__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE1__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_MODE:
				return basicSetAbstractorMode(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__BUS_TYPE:
				return basicSetBusType(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_INTERFACES:
				return basicSetAbstractorInterfaces(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__MODEL:
				return basicSetModel(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_GENERATORS:
				return basicSetAbstractorGenerators(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__CHOICES:
				return basicSetChoices(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__FILE_SETS:
				return basicSetFileSets(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE1__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_TYPE1__VENDOR:
				return getVendor();
			case spiritPackage.ABSTRACTOR_TYPE1__LIBRARY:
				return getLibrary();
			case spiritPackage.ABSTRACTOR_TYPE1__NAME:
				return getName();
			case spiritPackage.ABSTRACTOR_TYPE1__VERSION:
				return getVersion();
			case spiritPackage.ABSTRACTOR_TYPE1__ABSTRACTOR_MODE:
			...
			case spiritPackage.ABSTRACTOR_TYPE1__FILE_SETS:
				return getFileSets();
			case spiritPackage.ABSTRACTOR_TYPE1__DESCRIPTION:

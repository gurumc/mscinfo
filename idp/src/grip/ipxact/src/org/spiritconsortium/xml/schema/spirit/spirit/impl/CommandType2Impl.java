...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Command Type2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getValue <em>Value</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getBitStringLength <em>Bit String Length</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getChoiceRef <em>Choice Ref</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getConfigGroups <em>Config Groups</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getDependency <em>Dependency</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getId <em>Id</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getOrder <em>Order</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getPrompt <em>Prompt</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getRangeType <em>Range Type</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getResolve <em>Resolve</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CommandType2Impl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CommandType2Impl extends MinimalEObjectImpl.Container implements CommandType2 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getCommandType2();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__VALUE, oldValue, value));
	}
	...
	public void setBitStringLength(BigInteger newBitStringLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__BIT_STRING_LENGTH, oldBitStringLength, bitStringLength));
	}
	...
	public void setChoiceRef(String newChoiceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__CHOICE_REF, oldChoiceRef, choiceRef));
	}
	...
	public void setConfigGroups(List<String> newConfigGroups) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__CONFIG_GROUPS, oldConfigGroups, configGroups));
	}
	...
	public void setDependency(String newDependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__DEPENDENCY, oldDependency, dependency));
	}
	...
	public void setFormat(FormatType newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.COMMAND_TYPE2__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__ID, oldId, id));
	}
	...
	public void setMaximum(String newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMinimum(String newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setOrder(float newOrder) {
		...
		orderESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__ORDER, oldOrder, order, !oldOrderESet));
	}
	...
	public void unsetOrder() {
		...
		orderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.COMMAND_TYPE2__ORDER, oldOrder, ORDER_EDEFAULT, oldOrderESet));
	}
	...
	public void setPrompt(String newPrompt) {
		...
		prompt = newPrompt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__PROMPT, oldPrompt, prompt));
	}
	...
	public void setRangeType(RangeTypeType newRangeType) {
		...
		rangeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__RANGE_TYPE, oldRangeType, rangeType, !oldRangeTypeESet));
	}
	...
	public void unsetRangeType() {
		...
		rangeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.COMMAND_TYPE2__RANGE_TYPE, oldRangeType, RANGE_TYPE_EDEFAULT, oldRangeTypeESet));
	}
	...
	public void setResolve(ResolveType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMMAND_TYPE2__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.COMMAND_TYPE2__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, spiritPackage.COMMAND_TYPE2__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.COMMAND_TYPE2__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.COMMAND_TYPE2__VALUE:
				return getValue();
			case spiritPackage.COMMAND_TYPE2__BIT_STRING_LENGTH:
				return getBitStringLength();
			case spiritPackage.COMMAND_TYPE2__CHOICE_REF:
				return getChoiceRef();
			case spiritPackage.COMMAND_TYPE2__CONFIG_GROUPS:
				return getConfigGroups();
			case spiritPackage.COMMAND_TYPE2__DEPENDENCY:
				return getDependency();
			case spiritPackage.COMMAND_TYPE2__FORMAT:
				return getFormat();
			case spiritPackage.COMMAND_TYPE2__ID:
				return getId();
			case spiritPackage.COMMAND_TYPE2__MAXIMUM:
				return getMaximum();
			case spiritPackage.COMMAND_TYPE2__MINIMUM:
				return getMinimum();
			case spiritPackage.COMMAND_TYPE2__ORDER:
				return getOrder();
			case spiritPackage.COMMAND_TYPE2__PROMPT:
				return getPrompt();
			case spiritPackage.COMMAND_TYPE2__RANGE_TYPE:
				return getRangeType();
			case spiritPackage.COMMAND_TYPE2__RESOLVE:
				return getResolve();
			case spiritPackage.COMMAND_TYPE2__ANY_ATTRIBUTE:

 ...
 * @generated
 */
public class ExternalPortReferenceTypeImpl extends MinimalEObjectImpl.Container implements ExternalPortReferenceType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getExternalPortReferenceType();
	}
	...
	public void setLeft(BigInteger newLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXTERNAL_PORT_REFERENCE_TYPE__LEFT, oldLeft, left));
	}
	...
	public void setPortRef(String newPortRef) {
		...
		portRef = newPortRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXTERNAL_PORT_REFERENCE_TYPE__PORT_REF, oldPortRef, portRef));
	}
	...
	public void setRight(BigInteger newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.EXTERNAL_PORT_REFERENCE_TYPE__RIGHT, oldRight, right));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.EXTERNAL_PORT_REFERENCE_TYPE__LEFT:
				return getLeft();
			case spiritPackage.EXTERNAL_PORT_REFERENCE_TYPE__PORT_REF:
				return getPortRef();
			case spiritPackage.EXTERNAL_PORT_REFERENCE_TYPE__RIGHT:
				return getRight();
		}

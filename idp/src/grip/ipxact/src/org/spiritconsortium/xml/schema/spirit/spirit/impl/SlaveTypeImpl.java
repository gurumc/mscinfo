...
public class SlaveTypeImpl extends MinimalEObjectImpl.Container implements SlaveType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getSlaveType();
	}
	...
	public NotificationChain basicSetMemoryMapRef(MemoryMapRefType newMemoryMapRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.SLAVE_TYPE__MEMORY_MAP_REF, oldMemoryMapRef, newMemoryMapRef);
	...
	public void setMemoryMapRef(MemoryMapRefType newMemoryMapRef) {
		if (newMemoryMapRef != memoryMapRef) {
			...
			if (memoryMapRef != null)
				msgs = ((InternalEObject)memoryMapRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.SLAVE_TYPE__MEMORY_MAP_REF, null, msgs);
			if (newMemoryMapRef != null)
				msgs = ((InternalEObject)newMemoryMapRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.SLAVE_TYPE__MEMORY_MAP_REF, null, msgs);
			msgs = basicSetMemoryMapRef(newMemoryMapRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.SLAVE_TYPE__MEMORY_MAP_REF, newMemoryMapRef, newMemoryMapRef));
	}
	...
	public EList<BridgeType> getBridge() {
		if (bridge == null) {
			bridge = new EObjectContainmentEList<BridgeType>(BridgeType.class, this, spiritPackage.SLAVE_TYPE__BRIDGE);
		}
		return bridge;
	}
	...
	public EList<FileSetRefGroupType> getFileSetRefGroup() {
		if (fileSetRefGroup == null) {
			fileSetRefGroup = new EObjectContainmentEList<FileSetRefGroupType>(FileSetRefGroupType.class, this, spiritPackage.SLAVE_TYPE__FILE_SET_REF_GROUP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.SLAVE_TYPE__MEMORY_MAP_REF:
				return basicSetMemoryMapRef(null, msgs);
			case spiritPackage.SLAVE_TYPE__BRIDGE:
				return ((InternalEList<?>)getBridge()).basicRemove(otherEnd, msgs);
			case spiritPackage.SLAVE_TYPE__FILE_SET_REF_GROUP:

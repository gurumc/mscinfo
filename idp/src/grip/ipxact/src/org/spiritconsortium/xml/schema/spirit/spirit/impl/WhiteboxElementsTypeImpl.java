...
public class WhiteboxElementsTypeImpl extends MinimalEObjectImpl.Container implements WhiteboxElementsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getWhiteboxElementsType();
	}
	...
	public EList<WhiteboxElementType> getWhiteboxElement() {
		if (whiteboxElement == null) {
			whiteboxElement = new EObjectContainmentEList<WhiteboxElementType>(WhiteboxElementType.class, this, spiritPackage.WHITEBOX_ELEMENTS_TYPE__WHITEBOX_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.WHITEBOX_ELEMENTS_TYPE__WHITEBOX_ELEMENT:

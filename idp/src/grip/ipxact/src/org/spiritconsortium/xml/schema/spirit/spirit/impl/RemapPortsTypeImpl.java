...
public class RemapPortsTypeImpl extends MinimalEObjectImpl.Container implements RemapPortsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getRemapPortsType();
	}
	...
	public EList<RemapPortType> getRemapPort() {
		if (remapPort == null) {
			remapPort = new EObjectContainmentEList<RemapPortType>(RemapPortType.class, this, spiritPackage.REMAP_PORTS_TYPE__REMAP_PORT);
		}
		return remapPort;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.REMAP_PORTS_TYPE__REMAP_PORT:

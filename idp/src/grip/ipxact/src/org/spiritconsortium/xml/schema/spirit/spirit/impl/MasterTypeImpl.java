...
public class MasterTypeImpl extends MinimalEObjectImpl.Container implements MasterType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getMasterType();
	}
	...
	public NotificationChain basicSetAddressSpaceRef(AddressSpaceRefType newAddressSpaceRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.MASTER_TYPE__ADDRESS_SPACE_REF, oldAddressSpaceRef, newAddressSpaceRef);
	...
	public void setAddressSpaceRef(AddressSpaceRefType newAddressSpaceRef) {
		if (newAddressSpaceRef != addressSpaceRef) {
			...
			if (addressSpaceRef != null)
				msgs = ((InternalEObject)addressSpaceRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MASTER_TYPE__ADDRESS_SPACE_REF, null, msgs);
			if (newAddressSpaceRef != null)
				msgs = ((InternalEObject)newAddressSpaceRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MASTER_TYPE__ADDRESS_SPACE_REF, null, msgs);
			msgs = basicSetAddressSpaceRef(newAddressSpaceRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MASTER_TYPE__ADDRESS_SPACE_REF, newAddressSpaceRef, newAddressSpaceRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.MASTER_TYPE__ADDRESS_SPACE_REF:

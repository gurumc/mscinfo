...
public class MirroredSlaveTypeImpl extends MinimalEObjectImpl.Container implements MirroredSlaveType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getMirroredSlaveType();
	}
	...
	public NotificationChain basicSetBaseAddresses(BaseAddressesType newBaseAddresses, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.MIRRORED_SLAVE_TYPE__BASE_ADDRESSES, oldBaseAddresses, newBaseAddresses);
	...
	public void setBaseAddresses(BaseAddressesType newBaseAddresses) {
		if (newBaseAddresses != baseAddresses) {
			...
			if (baseAddresses != null)
				msgs = ((InternalEObject)baseAddresses).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MIRRORED_SLAVE_TYPE__BASE_ADDRESSES, null, msgs);
			if (newBaseAddresses != null)
				msgs = ((InternalEObject)newBaseAddresses).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MIRRORED_SLAVE_TYPE__BASE_ADDRESSES, null, msgs);
			msgs = basicSetBaseAddresses(newBaseAddresses, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MIRRORED_SLAVE_TYPE__BASE_ADDRESSES, newBaseAddresses, newBaseAddresses));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.MIRRORED_SLAVE_TYPE__BASE_ADDRESSES:

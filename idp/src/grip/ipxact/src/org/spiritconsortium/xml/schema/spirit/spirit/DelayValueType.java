 ...
 * <!-- end-model-doc -->
 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getDelayValueType()
 * @model extendedMetaData="name='delayValueType'"
 * @generated
 */
public enum DelayValueType implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<DelayValueType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

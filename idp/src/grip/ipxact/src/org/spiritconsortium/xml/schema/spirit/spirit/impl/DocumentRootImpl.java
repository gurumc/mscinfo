...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	 ...
	 * @ordered
	 */
	protected static final PortAccessTypeType PORT_ACCESS_TYPE_EDEFAULT = PortAccessTypeType.REF;
	 ...
	 * @ordered
	 */
	protected static final FormatType FORMAT_EDEFAULT = FormatType.BIT_STRING;
	 ...
	 * @ordered
	 */
	protected static final BankAlignmentType BANK_ALIGNMENT_EDEFAULT = BankAlignmentType.SERIAL;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getDocumentRoot();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, spiritPackage.DOCUMENT_ROOT__MIXED);
		}
		return mixed;
	}
	...
	public EMap<String, String> getXMLNSPrefixMap() {
		if (xMLNSPrefixMap == null) {
			xMLNSPrefixMap = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, spiritPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
		}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, spiritPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
		}
	...
	public CellSpecificationType getCellSpecification() {
		return (CellSpecificationType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_CellSpecification(), true);
	}
	...
	public NotificationChain basicSetCellSpecification(CellSpecificationType newCellSpecification, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_CellSpecification(), newCellSpecification, msgs);
	}
	...
	public void setCellSpecification(CellSpecificationType newCellSpecification) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_CellSpecification(), newCellSpecification);
	}
	...
	public ChoicesType getChoices() {
		return (ChoicesType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Choices(), true);
	}
	...
	public NotificationChain basicSetChoices(ChoicesType newChoices, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Choices(), newChoices, msgs);
	}
	...
	public void setChoices(ChoicesType newChoices) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Choices(), newChoices);
	}
	...
	public ClockDriverType1 getClockDriver() {
		return (ClockDriverType1)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ClockDriver(), true);
	}
	...
	public NotificationChain basicSetClockDriver(ClockDriverType1 newClockDriver, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ClockDriver(), newClockDriver, msgs);
	}
	...
	public void setClockDriver(ClockDriverType1 newClockDriver) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ClockDriver(), newClockDriver);
	}
	...
	public ConstraintSetType getConstraintSet() {
		return (ConstraintSetType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSet(), true);
	}
	...
	public NotificationChain basicSetConstraintSet(ConstraintSetType newConstraintSet, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSet(), newConstraintSet, msgs);
	}
	...
	public void setConstraintSet(ConstraintSetType newConstraintSet) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSet(), newConstraintSet);
	}
	...
	public String getConstraintSetRef() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSetRef(), true);
	}
	...
	public void setConstraintSetRef(String newConstraintSetRef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSetRef(), newConstraintSetRef);
	}
	...
	public ConstraintSetsType getConstraintSets() {
		return (ConstraintSetsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSets(), true);
	}
	...
	public NotificationChain basicSetConstraintSets(ConstraintSetsType newConstraintSets, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSets(), newConstraintSets, msgs);
	}
	...
	public void setConstraintSets(ConstraintSetsType newConstraintSets) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ConstraintSets(), newConstraintSets);
	}
	...
	public DefaultValueType getDefaultValue() {
		return (DefaultValueType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_DefaultValue(), true);
	}
	...
	public NotificationChain basicSetDefaultValue(DefaultValueType newDefaultValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_DefaultValue(), newDefaultValue, msgs);
	}
	...
	public void setDefaultValue(DefaultValueType newDefaultValue) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_DefaultValue(), newDefaultValue);
	}
	...
	public String getDependency() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Dependency(), true);
	}
	...
	public void setDependency(String newDependency) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Dependency(), newDependency);
	}
	...
	public String getDescription() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Description(), true);
	}
	...
	public void setDescription(String newDescription) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Description(), newDescription);
	}
	...
	public String getDisplayName() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_DisplayName(), true);
	}
	...
	public void setDisplayName(String newDisplayName) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_DisplayName(), newDisplayName);
	}
	...
	public DriveConstraintType getDriveConstraint() {
		return (DriveConstraintType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_DriveConstraint(), true);
	}
	...
	public NotificationChain basicSetDriveConstraint(DriveConstraintType newDriveConstraint, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_DriveConstraint(), newDriveConstraint, msgs);
	}
	...
	public void setDriveConstraint(DriveConstraintType newDriveConstraint) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_DriveConstraint(), newDriveConstraint);
	}
	...
	public DriverType getDriver() {
		return (DriverType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Driver(), true);
	}
	...
	public NotificationChain basicSetDriver(DriverType newDriver, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Driver(), newDriver, msgs);
	}
	...
	public void setDriver(DriverType newDriver) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Driver(), newDriver);
	}
	...
	public ExecutableImageType getExecutableImage() {
		return (ExecutableImageType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ExecutableImage(), true);
	}
	...
	public NotificationChain basicSetExecutableImage(ExecutableImageType newExecutableImage, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ExecutableImage(), newExecutableImage, msgs);
	}
	...
	public void setExecutableImage(ExecutableImageType newExecutableImage) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ExecutableImage(), newExecutableImage);
	}
	...
	public FileType getFile() {
		return (FileType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_File(), true);
	}
	...
	public NotificationChain basicSetFile(FileType newFile, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_File(), newFile, msgs);
	}
	...
	public void setFile(FileType newFile) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_File(), newFile);
	}
	...
	public FileSetType getFileSet() {
		return (FileSetType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_FileSet(), true);
	}
	...
	public NotificationChain basicSetFileSet(FileSetType newFileSet, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_FileSet(), newFileSet, msgs);
	}
	...
	public void setFileSet(FileSetType newFileSet) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_FileSet(), newFileSet);
	}
	...
	public FileSetRefType getFileSetRef() {
		return (FileSetRefType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_FileSetRef(), true);
	}
	...
	public NotificationChain basicSetFileSetRef(FileSetRefType newFileSetRef, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_FileSetRef(), newFileSetRef, msgs);
	}
	...
	public void setFileSetRef(FileSetRefType newFileSetRef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_FileSetRef(), newFileSetRef);
	}
	...
	public FileSetsType getFileSets() {
		return (FileSetsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_FileSets(), true);
	}
	...
	public NotificationChain basicSetFileSets(FileSetsType newFileSets, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_FileSets(), newFileSets, msgs);
	}
	...
	public void setFileSets(FileSetsType newFileSets) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_FileSets(), newFileSets);
	}
	...
	public String getGeneratorRef() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_GeneratorRef(), true);
	}
	...
	public void setGeneratorRef(String newGeneratorRef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_GeneratorRef(), newGeneratorRef);
	}
	...
	public InitiativeType1 getInitiative() {
		return (InitiativeType1)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Initiative(), true);
	}
	...
	public void setInitiative(InitiativeType1 newInitiative) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Initiative(), newInitiative);
	}
	...
	public LoadConstraintType getLoadConstraint() {
		return (LoadConstraintType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_LoadConstraint(), true);
	}
	...
	public NotificationChain basicSetLoadConstraint(LoadConstraintType newLoadConstraint, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_LoadConstraint(), newLoadConstraint, msgs);
	}
	...
	public void setLoadConstraint(LoadConstraintType newLoadConstraint) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_LoadConstraint(), newLoadConstraint);
	}
	...
	public ModelType getModel() {
		return (ModelType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Model(), true);
	}
	...
	public NotificationChain basicSetModel(ModelType newModel, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Model(), newModel, msgs);
	}
	...
	public void setModel(ModelType newModel) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Model(), newModel);
	}
	...
	public OtherClockDriverType getOtherClockDriver() {
		return (OtherClockDriverType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_OtherClockDriver(), true);
	}
	...
	public NotificationChain basicSetOtherClockDriver(OtherClockDriverType newOtherClockDriver, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_OtherClockDriver(), newOtherClockDriver, msgs);
	}
	...
	public void setOtherClockDriver(OtherClockDriverType newOtherClockDriver) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_OtherClockDriver(), newOtherClockDriver);
	}
	...
	public NameValuePairType getParameter() {
		return (NameValuePairType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Parameter(), true);
	}
	...
	public NotificationChain basicSetParameter(NameValuePairType newParameter, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Parameter(), newParameter, msgs);
	}
	...
	public void setParameter(NameValuePairType newParameter) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Parameter(), newParameter);
	}
	...
	public ParametersType1 getParameters() {
		return (ParametersType1)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Parameters(), true);
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Parameters(), newParameters, msgs);
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Parameters(), newParameters);
	}
	 ...
	 * @generated
	 */
	public PortType1 getPort() {
		return (PortType1)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Port(), true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPort(PortType1 newPort, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Port(), newPort, msgs);
	}
	 ...
	 * @generated
	 */
	public void setPort(PortType1 newPort) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Port(), newPort);
	}
	...
	public String getPortAccessHandle() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_PortAccessHandle(), true);
	}
	...
	public void setPortAccessHandle(String newPortAccessHandle) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_PortAccessHandle(), newPortAccessHandle);
	}
	...
	public PortAccessTypeType getPortAccessType() {
		return (PortAccessTypeType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_PortAccessType(), true);
	}
	...
	public void setPortAccessType(PortAccessTypeType newPortAccessType) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_PortAccessType(), newPortAccessType);
	}
	...
	public RequiresDriverType getRequiresDriver() {
		return (RequiresDriverType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_RequiresDriver(), true);
	}
	...
	public NotificationChain basicSetRequiresDriver(RequiresDriverType newRequiresDriver, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_RequiresDriver(), newRequiresDriver, msgs);
	}
	...
	public void setRequiresDriver(RequiresDriverType newRequiresDriver) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_RequiresDriver(), newRequiresDriver);
	}
	...
	public ServiceTypeDefType getServiceTypeDef() {
		return (ServiceTypeDefType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ServiceTypeDef(), true);
	}
	...
	public NotificationChain basicSetServiceTypeDef(ServiceTypeDefType newServiceTypeDef, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ServiceTypeDef(), newServiceTypeDef, msgs);
	}
	...
	public void setServiceTypeDef(ServiceTypeDefType newServiceTypeDef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ServiceTypeDef(), newServiceTypeDef);
	}
	...
	public ServiceTypeDefsType getServiceTypeDefs() {
		return (ServiceTypeDefsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ServiceTypeDefs(), true);
	}
	...
	public NotificationChain basicSetServiceTypeDefs(ServiceTypeDefsType newServiceTypeDefs, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ServiceTypeDefs(), newServiceTypeDefs, msgs);
	}
	...
	public void setServiceTypeDefs(ServiceTypeDefsType newServiceTypeDefs) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ServiceTypeDefs(), newServiceTypeDefs);
	}
	...
	public SingleShotDriverType getSingleShotDriver() {
		return (SingleShotDriverType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_SingleShotDriver(), true);
	}
	...
	public NotificationChain basicSetSingleShotDriver(SingleShotDriverType newSingleShotDriver, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_SingleShotDriver(), newSingleShotDriver, msgs);
	}
	...
	public void setSingleShotDriver(SingleShotDriverType newSingleShotDriver) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_SingleShotDriver(), newSingleShotDriver);
	}
	...
	public TimingConstraintType getTimingConstraint() {
		return (TimingConstraintType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_TimingConstraint(), true);
	}
	...
	public NotificationChain basicSetTimingConstraint(TimingConstraintType newTimingConstraint, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_TimingConstraint(), newTimingConstraint, msgs);
	}
	...
	public void setTimingConstraint(TimingConstraintType newTimingConstraint) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_TimingConstraint(), newTimingConstraint);
	}
	...
	public TransTypeDefType getTransTypeDef() {
		return (TransTypeDefType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_TransTypeDef(), true);
	}
	...
	public NotificationChain basicSetTransTypeDef(TransTypeDefType newTransTypeDef, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_TransTypeDef(), newTransTypeDef, msgs);
	}
	...
	public void setTransTypeDef(TransTypeDefType newTransTypeDef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_TransTypeDef(), newTransTypeDef);
	}
	...
	public VectorType2 getVector() {
		return (VectorType2)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Vector(), true);
	}
	...
	public NotificationChain basicSetVector(VectorType2 newVector, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Vector(), newVector, msgs);
	}
	...
	public void setVector(VectorType2 newVector) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Vector(), newVector);
	}
	...
	public VendorExtensionsType getVendorExtensions() {
		return (VendorExtensionsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_VendorExtensions(), true);
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_VendorExtensions(), newVendorExtensions, msgs);
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_VendorExtensions(), newVendorExtensions);
	}
	...
	public WireTypeDefType getWireTypeDef() {
		return (WireTypeDefType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_WireTypeDef(), true);
	}
	...
	public NotificationChain basicSetWireTypeDef(WireTypeDefType newWireTypeDef, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_WireTypeDef(), newWireTypeDef, msgs);
	}
	...
	public void setWireTypeDef(WireTypeDefType newWireTypeDef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_WireTypeDef(), newWireTypeDef);
	}
	...
	public WireTypeDefsType getWireTypeDefs() {
		return (WireTypeDefsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_WireTypeDefs(), true);
	}
	...
	public NotificationChain basicSetWireTypeDefs(WireTypeDefsType newWireTypeDefs, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_WireTypeDefs(), newWireTypeDefs, msgs);
	}
	...
	public void setWireTypeDefs(WireTypeDefsType newWireTypeDefs) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_WireTypeDefs(), newWireTypeDefs);
	}
	...
	public void setBitStringLength(BigInteger newBitStringLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__BIT_STRING_LENGTH, oldBitStringLength, bitStringLength));
	}
	...
	public void setCellStrength(CellStrengthValueType newCellStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__CELL_STRENGTH, oldCellStrength, cellStrength, !oldCellStrengthESet));
	}
	...
	public void unsetCellStrength() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__CELL_STRENGTH, oldCellStrength, CELL_STRENGTH_EDEFAULT, oldCellStrengthESet));
	}
	...
	public void setChoiceRef(String newChoiceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__CHOICE_REF, oldChoiceRef, choiceRef));
	}
	...
	public void setClockEdge(EdgeValueType newClockEdge) {
		...
		clockEdgeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__CLOCK_EDGE, oldClockEdge, clockEdge, !oldClockEdgeESet));
	}
	...
	public void unsetClockEdge() {
		...
		clockEdgeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__CLOCK_EDGE, oldClockEdge, CLOCK_EDGE_EDEFAULT, oldClockEdgeESet));
	}
	...
	public void setConfigGroups(List<String> newConfigGroups) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__CONFIG_GROUPS, oldConfigGroups, configGroups));
	}
	...
	public void setConstraintSetId(String newConstraintSetId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__CONSTRAINT_SET_ID, oldConstraintSetId, constraintSetId, !oldConstraintSetIdESet));
	}
	...
	public void unsetConstraintSetId() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__CONSTRAINT_SET_ID, oldConstraintSetId, CONSTRAINT_SET_ID_EDEFAULT, oldConstraintSetIdESet));
	}
	...
	public void setDelayType(DelayValueType newDelayType) {
		...
		delayTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__DELAY_TYPE, oldDelayType, delayType, !oldDelayTypeESet));
	}
	...
	public void unsetDelayType() {
		...
		delayTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__DELAY_TYPE, oldDelayType, DELAY_TYPE_EDEFAULT, oldDelayTypeESet));
	}
	...
	public void setDependency1(String newDependency1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__DEPENDENCY1, oldDependency1, dependency1));
	}
	...
	public void setFormat(FormatType newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__ID, oldId, id));
	}
	...
	public void setMaximum(String newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMinimum(String newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setOrder(float newOrder) {
		...
		orderESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__ORDER, oldOrder, order, !oldOrderESet));
	}
	...
	public void unsetOrder() {
		...
		orderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__ORDER, oldOrder, ORDER_EDEFAULT, oldOrderESet));
	}
	...
	public void setPrompt(String newPrompt) {
		...
		prompt = newPrompt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__PROMPT, oldPrompt, prompt));
	}
	...
	public void setRangeType(RangeTypeType newRangeType) {
		...
		rangeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__RANGE_TYPE, oldRangeType, rangeType, !oldRangeTypeESet));
	}
	...
	public void unsetRangeType() {
		...
		rangeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__RANGE_TYPE, oldRangeType, RANGE_TYPE_EDEFAULT, oldRangeTypeESet));
	}
	...
	public void setResolve(ResolveType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public AccessType getAccess() {
		return (AccessType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Access(), true);
	}
	...
	public void setAccess(AccessType newAccess) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Access(), newAccess);
	}
	...
	public AddressBlockType getAddressBlock() {
		return (AddressBlockType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AddressBlock(), true);
	}
	...
	public NotificationChain basicSetAddressBlock(AddressBlockType newAddressBlock, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AddressBlock(), newAddressBlock, msgs);
	}
	...
	public void setAddressBlock(AddressBlockType newAddressBlock) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AddressBlock(), newAddressBlock);
	}
	...
	public AddrSpaceRefType getAddressSpaceRef() {
		return (AddrSpaceRefType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AddressSpaceRef(), true);
	}
	...
	public NotificationChain basicSetAddressSpaceRef(AddrSpaceRefType newAddressSpaceRef, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AddressSpaceRef(), newAddressSpaceRef, msgs);
	}
	...
	public void setAddressSpaceRef(AddrSpaceRefType newAddressSpaceRef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AddressSpaceRef(), newAddressSpaceRef);
	}
	...
	public AddressSpacesType getAddressSpaces() {
		return (AddressSpacesType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AddressSpaces(), true);
	}
	...
	public NotificationChain basicSetAddressSpaces(AddressSpacesType newAddressSpaces, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AddressSpaces(), newAddressSpaces, msgs);
	}
	...
	public void setAddressSpaces(AddressSpacesType newAddressSpaces) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AddressSpaces(), newAddressSpaces);
	}
	...
	public BigInteger getAddressUnitBits() {
		return (BigInteger)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AddressUnitBits(), true);
	}
	...
	public void setAddressUnitBits(BigInteger newAddressUnitBits) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AddressUnitBits(), newAddressUnitBits);
	}
	...
	public AddressBankType getBank() {
		return (AddressBankType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Bank(), true);
	}
	...
	public NotificationChain basicSetBank(AddressBankType newBank, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Bank(), newBank, msgs);
	}
	...
	public void setBank(AddressBankType newBank) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Bank(), newBank);
	}
	...
	public BaseAddressType1 getBaseAddress() {
		return (BaseAddressType1)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_BaseAddress(), true);
	}
	...
	public NotificationChain basicSetBaseAddress(BaseAddressType1 newBaseAddress, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_BaseAddress(), newBaseAddress, msgs);
	}
	...
	public void setBaseAddress(BaseAddressType1 newBaseAddress) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_BaseAddress(), newBaseAddress);
	}
	...
	public EnumeratedValuesType getEnumeratedValues() {
		return (EnumeratedValuesType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_EnumeratedValues(), true);
	}
	...
	public NotificationChain basicSetEnumeratedValues(EnumeratedValuesType newEnumeratedValues, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_EnumeratedValues(), newEnumeratedValues, msgs);
	}
	...
	public void setEnumeratedValues(EnumeratedValuesType newEnumeratedValues) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_EnumeratedValues(), newEnumeratedValues);
	}
	...
	public MemoryMapRefType getMemoryMapRef() {
		return (MemoryMapRefType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_MemoryMapRef(), true);
	}
	...
	public NotificationChain basicSetMemoryMapRef(MemoryMapRefType newMemoryMapRef, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_MemoryMapRef(), newMemoryMapRef, msgs);
	}
	...
	public void setMemoryMapRef(MemoryMapRefType newMemoryMapRef) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_MemoryMapRef(), newMemoryMapRef);
	}
	...
	public MemoryMapsType getMemoryMaps() {
		return (MemoryMapsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_MemoryMaps(), true);
	}
	...
	public NotificationChain basicSetMemoryMaps(MemoryMapsType newMemoryMaps, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_MemoryMaps(), newMemoryMaps, msgs);
	}
	...
	public void setMemoryMaps(MemoryMapsType newMemoryMaps) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_MemoryMaps(), newMemoryMaps);
	}
	...
	public RegisterFileType getRegisterFile() {
		return (RegisterFileType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_RegisterFile(), true);
	}
	...
	public NotificationChain basicSetRegisterFile(RegisterFileType newRegisterFile, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_RegisterFile(), newRegisterFile, msgs);
	}
	...
	public void setRegisterFile(RegisterFileType newRegisterFile) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_RegisterFile(), newRegisterFile);
	}
	...
	public boolean isVolatile() {
		return (Boolean)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Volatile(), true);
	}
	...
	public void setVolatile(boolean newVolatile) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Volatile(), newVolatile);
	}
	...
	public void setAddressSpaceRef1(String newAddressSpaceRef1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__ADDRESS_SPACE_REF1, oldAddressSpaceRef1, addressSpaceRef1));
	}
	...
	public void setBankAlignment(BankAlignmentType newBankAlignment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__BANK_ALIGNMENT, oldBankAlignment, bankAlignment, !oldBankAlignmentESet));
	}
	...
	public void unsetBankAlignment() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.DOCUMENT_ROOT__BANK_ALIGNMENT, oldBankAlignment, BANK_ALIGNMENT_EDEFAULT, oldBankAlignmentESet));
	}
	...
	public void setMasterRef(String newMasterRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__MASTER_REF, oldMasterRef, masterRef));
	}
	...
	public void setMemoryMapRef1(String newMemoryMapRef1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__MEMORY_MAP_REF1, oldMemoryMapRef1, memoryMapRef1));
	}
	...
	public void setSegmentRef(String newSegmentRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DOCUMENT_ROOT__SEGMENT_REF, oldSegmentRef, segmentRef));
	}
	...
	public AbstractionDefinitionType getAbstractionDefinition() {
		return (AbstractionDefinitionType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AbstractionDefinition(), true);
	}
	...
	public NotificationChain basicSetAbstractionDefinition(AbstractionDefinitionType newAbstractionDefinition, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AbstractionDefinition(), newAbstractionDefinition, msgs);
	}
	...
	public void setAbstractionDefinition(AbstractionDefinitionType newAbstractionDefinition) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AbstractionDefinition(), newAbstractionDefinition);
	}
	...
	public AbstractorType1 getAbstractor() {
		return (AbstractorType1)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Abstractor(), true);
	}
	...
	public NotificationChain basicSetAbstractor(AbstractorType1 newAbstractor, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Abstractor(), newAbstractor, msgs);
	}
	...
	public void setAbstractor(AbstractorType1 newAbstractor) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Abstractor(), newAbstractor);
	}
	...
	public InstanceGeneratorType getAbstractorGenerator() {
		return (InstanceGeneratorType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AbstractorGenerator(), true);
	}
	...
	public NotificationChain basicSetAbstractorGenerator(InstanceGeneratorType newAbstractorGenerator, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AbstractorGenerator(), newAbstractorGenerator, msgs);
	}
	...
	public void setAbstractorGenerator(InstanceGeneratorType newAbstractorGenerator) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AbstractorGenerator(), newAbstractorGenerator);
	}
	...
	public AbstractorGeneratorsType getAbstractorGenerators() {
		return (AbstractorGeneratorsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AbstractorGenerators(), true);
	}
	...
	public NotificationChain basicSetAbstractorGenerators(AbstractorGeneratorsType newAbstractorGenerators, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AbstractorGenerators(), newAbstractorGenerators, msgs);
	}
	...
	public void setAbstractorGenerators(AbstractorGeneratorsType newAbstractorGenerators) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AbstractorGenerators(), newAbstractorGenerators);
	}
	...
	public AdHocConnectionType getAdHocConnection() {
		return (AdHocConnectionType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AdHocConnection(), true);
	}
	...
	public NotificationChain basicSetAdHocConnection(AdHocConnectionType newAdHocConnection, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AdHocConnection(), newAdHocConnection, msgs);
	}
	...
	public void setAdHocConnection(AdHocConnectionType newAdHocConnection) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AdHocConnection(), newAdHocConnection);
	}
	...
	public AdHocConnectionsType getAdHocConnections() {
		return (AdHocConnectionsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_AdHocConnections(), true);
	}
	...
	public NotificationChain basicSetAdHocConnections(AdHocConnectionsType newAdHocConnections, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_AdHocConnections(), newAdHocConnections, msgs);
	}
	...
	public void setAdHocConnections(AdHocConnectionsType newAdHocConnections) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_AdHocConnections(), newAdHocConnections);
	}
	...
	public BigInteger getBitsInLau() {
		return (BigInteger)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_BitsInLau(), true);
	}
	...
	public void setBitsInLau(BigInteger newBitsInLau) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_BitsInLau(), newBitsInLau);
	}
	...
	public BusDefinitionType getBusDefinition() {
		return (BusDefinitionType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_BusDefinition(), true);
	}
	...
	public NotificationChain basicSetBusDefinition(BusDefinitionType newBusDefinition, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_BusDefinition(), newBusDefinition, msgs);
	}
	...
	public void setBusDefinition(BusDefinitionType newBusDefinition) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_BusDefinition(), newBusDefinition);
	}
	...
	public BusInterfaceType getBusInterface() {
		return (BusInterfaceType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_BusInterface(), true);
	}
	...
	public NotificationChain basicSetBusInterface(BusInterfaceType newBusInterface, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_BusInterface(), newBusInterface, msgs);
	}
	...
	public void setBusInterface(BusInterfaceType newBusInterface) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_BusInterface(), newBusInterface);
	}
	...
	public BusInterfacesType getBusInterfaces() {
		return (BusInterfacesType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_BusInterfaces(), true);
	}
	...
	public NotificationChain basicSetBusInterfaces(BusInterfacesType newBusInterfaces, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_BusInterfaces(), newBusInterfaces, msgs);
	}
	...
	public void setBusInterfaces(BusInterfacesType newBusInterfaces) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_BusInterfaces(), newBusInterfaces);
	}
	...
	public ChannelsType getChannels() {
		return (ChannelsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Channels(), true);
	}
	...
	public NotificationChain basicSetChannels(ChannelsType newChannels, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Channels(), newChannels, msgs);
	}
	...
	public void setChannels(ChannelsType newChannels) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Channels(), newChannels);
	}
	...
	public ComponentType getComponent() {
		return (ComponentType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Component(), true);
	}
	...
	public NotificationChain basicSetComponent(ComponentType newComponent, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Component(), newComponent, msgs);
	}
	...
	public void setComponent(ComponentType newComponent) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Component(), newComponent);
	}
	...
	public ComponentGeneratorType getComponentGenerator() {
		return (ComponentGeneratorType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ComponentGenerator(), true);
	}
	...
	public NotificationChain basicSetComponentGenerator(ComponentGeneratorType newComponentGenerator, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ComponentGenerator(), newComponentGenerator, msgs);
	}
	...
	public void setComponentGenerator(ComponentGeneratorType newComponentGenerator) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ComponentGenerator(), newComponentGenerator);
	}
	...
	public ComponentGeneratorsType getComponentGenerators() {
		return (ComponentGeneratorsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ComponentGenerators(), true);
	}
	...
	public NotificationChain basicSetComponentGenerators(ComponentGeneratorsType newComponentGenerators, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ComponentGenerators(), newComponentGenerators, msgs);
	}
	...
	public void setComponentGenerators(ComponentGeneratorsType newComponentGenerators) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ComponentGenerators(), newComponentGenerators);
	}
	...
	public ComponentInstanceType getComponentInstance() {
		return (ComponentInstanceType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ComponentInstance(), true);
	}
	...
	public NotificationChain basicSetComponentInstance(ComponentInstanceType newComponentInstance, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ComponentInstance(), newComponentInstance, msgs);
	}
	...
	public void setComponentInstance(ComponentInstanceType newComponentInstance) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ComponentInstance(), newComponentInstance);
	}
	...
	public ComponentInstancesType getComponentInstances() {
		return (ComponentInstancesType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ComponentInstances(), true);
	}
	...
	public NotificationChain basicSetComponentInstances(ComponentInstancesType newComponentInstances, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ComponentInstances(), newComponentInstances, msgs);
	}
	...
	public void setComponentInstances(ComponentInstancesType newComponentInstances) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ComponentInstances(), newComponentInstances);
	}
	...
	public ConfigurableElementValueType getConfigurableElementValue() {
		return (ConfigurableElementValueType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ConfigurableElementValue(), true);
	}
	...
	public NotificationChain basicSetConfigurableElementValue(ConfigurableElementValueType newConfigurableElementValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ConfigurableElementValue(), newConfigurableElementValue, msgs);
	}
	...
	public void setConfigurableElementValue(ConfigurableElementValueType newConfigurableElementValue) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ConfigurableElementValue(), newConfigurableElementValue);
	}
	...
	public ConfigurableElementValuesType getConfigurableElementValues() {
		return (ConfigurableElementValuesType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_ConfigurableElementValues(), true);
	}
	...
	public NotificationChain basicSetConfigurableElementValues(ConfigurableElementValuesType newConfigurableElementValues, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_ConfigurableElementValues(), newConfigurableElementValues, msgs);
	}
	...
	public void setConfigurableElementValues(ConfigurableElementValuesType newConfigurableElementValues) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_ConfigurableElementValues(), newConfigurableElementValues);
	}
	...
	public DesignType getDesign() {
		return (DesignType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Design(), true);
	}
	...
	public NotificationChain basicSetDesign(DesignType newDesign, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Design(), newDesign, msgs);
	}
	...
	public void setDesign(DesignType newDesign) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Design(), newDesign);
	}
	...
	public DesignConfigurationType getDesignConfiguration() {
		return (DesignConfigurationType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_DesignConfiguration(), true);
	}
	...
	public NotificationChain basicSetDesignConfiguration(DesignConfigurationType newDesignConfiguration, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_DesignConfiguration(), newDesignConfiguration, msgs);
	}
	...
	public void setDesignConfiguration(DesignConfigurationType newDesignConfiguration) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_DesignConfiguration(), newDesignConfiguration);
	}
	...
	public GeneratorType getGenerator() {
		return (GeneratorType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Generator(), true);
	}
	...
	public NotificationChain basicSetGenerator(GeneratorType newGenerator, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Generator(), newGenerator, msgs);
	}
	...
	public void setGenerator(GeneratorType newGenerator) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Generator(), newGenerator);
	}
	...
	public GeneratorChainType getGeneratorChain() {
		return (GeneratorChainType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_GeneratorChain(), true);
	}
	...
	public NotificationChain basicSetGeneratorChain(GeneratorChainType newGeneratorChain, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_GeneratorChain(), newGeneratorChain, msgs);
	}
	...
	public void setGeneratorChain(GeneratorChainType newGeneratorChain) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_GeneratorChain(), newGeneratorChain);
	}
	...
	public String getGroup() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Group(), true);
	}
	...
	public void setGroup(String newGroup) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Group(), newGroup);
	}
	...
	public GroupSelectorType getGroupSelector() {
		return (GroupSelectorType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_GroupSelector(), true);
	}
	...
	public NotificationChain basicSetGroupSelector(GroupSelectorType newGroupSelector, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_GroupSelector(), newGroupSelector, msgs);
	}
	...
	public void setGroupSelector(GroupSelectorType newGroupSelector) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_GroupSelector(), newGroupSelector);
	}
	...
	public String getInstanceName() {
		return (String)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_InstanceName(), true);
	}
	...
	public void setInstanceName(String newInstanceName) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_InstanceName(), newInstanceName);
	}
	...
	public InterconnectionType getInterconnection() {
		return (InterconnectionType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Interconnection(), true);
	}
	...
	public NotificationChain basicSetInterconnection(InterconnectionType newInterconnection, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Interconnection(), newInterconnection, msgs);
	}
	...
	public void setInterconnection(InterconnectionType newInterconnection) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Interconnection(), newInterconnection);
	}
	...
	public InterconnectionsType getInterconnections() {
		return (InterconnectionsType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Interconnections(), true);
	}
	...
	public NotificationChain basicSetInterconnections(InterconnectionsType newInterconnections, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Interconnections(), newInterconnections, msgs);
	}
	...
	public void setInterconnections(InterconnectionsType newInterconnections) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Interconnections(), newInterconnections);
	}
	...
	public MonitorInterconnectionType getMonitorInterconnection() {
		return (MonitorInterconnectionType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_MonitorInterconnection(), true);
	}
	...
	public NotificationChain basicSetMonitorInterconnection(MonitorInterconnectionType newMonitorInterconnection, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_MonitorInterconnection(), newMonitorInterconnection, msgs);
	}
	...
	public void setMonitorInterconnection(MonitorInterconnectionType newMonitorInterconnection) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_MonitorInterconnection(), newMonitorInterconnection);
	}
	...
	public PhaseType getPhase() {
		return (PhaseType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Phase(), true);
	}
	...
	public NotificationChain basicSetPhase(PhaseType newPhase, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_Phase(), newPhase, msgs);
	}
	...
	public void setPhase(PhaseType newPhase) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Phase(), newPhase);
	}
	...
	public PresenceType getPresence() {
		return (PresenceType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_Presence(), true);
	}
	...
	public void setPresence(PresenceType newPresence) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_Presence(), newPresence);
	}
	...
	public RemapStatesType getRemapStates() {
		return (RemapStatesType)getMixed().get(spiritPackage.eINSTANCE.getDocumentRoot_RemapStates(), true);
	}
	...
	public NotificationChain basicSetRemapStates(RemapStatesType newRemapStates, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(spiritPackage.eINSTANCE.getDocumentRoot_RemapStates(), newRemapStates, msgs);
	}
	...
	public void setRemapStates(RemapStatesType newRemapStates) {
		((FeatureMap.Internal)getMixed()).set(spiritPackage.eINSTANCE.getDocumentRoot_RemapStates(), newRemapStates);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.DOCUMENT_ROOT__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case spiritPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP:
				return ((InternalEList<?>)getXMLNSPrefixMap()).basicRemove(otherEnd, msgs);
			case spiritPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION:
				return ((InternalEList<?>)getXSISchemaLocation()).basicRemove(otherEnd, msgs);
			case spiritPackage.DOCUMENT_ROOT__CELL_SPECIFICATION:
				return basicSetCellSpecification(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__CHOICES:
				return basicSetChoices(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__CLOCK_DRIVER:
				return basicSetClockDriver(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__CONSTRAINT_SET:
				return basicSetConstraintSet(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__CONSTRAINT_SETS:
				return basicSetConstraintSets(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__DEFAULT_VALUE:
				return basicSetDefaultValue(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__DRIVE_CONSTRAINT:
				return basicSetDriveConstraint(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__DRIVER:
				return basicSetDriver(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__EXECUTABLE_IMAGE:
				return basicSetExecutableImage(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__FILE:
				return basicSetFile(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__FILE_SET:
				return basicSetFileSet(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__FILE_SET_REF:
				return basicSetFileSetRef(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__FILE_SETS:
				return basicSetFileSets(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__LOAD_CONSTRAINT:
				return basicSetLoadConstraint(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__MODEL:
				return basicSetModel(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__OTHER_CLOCK_DRIVER:
				return basicSetOtherClockDriver(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__PARAMETER:
				return basicSetParameter(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__PORT:
				return basicSetPort(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__REQUIRES_DRIVER:
				return basicSetRequiresDriver(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__SERVICE_TYPE_DEF:
				return basicSetServiceTypeDef(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__SERVICE_TYPE_DEFS:
				return basicSetServiceTypeDefs(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__SINGLE_SHOT_DRIVER:
				return basicSetSingleShotDriver(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__TIMING_CONSTRAINT:
				return basicSetTimingConstraint(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__TRANS_TYPE_DEF:
				return basicSetTransTypeDef(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__VECTOR:
				return basicSetVector(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__VENDOR_EXTENSIONS:
				return basicSetVendorExtensions(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__WIRE_TYPE_DEF:
				return basicSetWireTypeDef(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__WIRE_TYPE_DEFS:
				return basicSetWireTypeDefs(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ADDRESS_BLOCK:
				return basicSetAddressBlock(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ADDRESS_SPACE_REF:
				return basicSetAddressSpaceRef(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ADDRESS_SPACES:
				return basicSetAddressSpaces(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__BANK:
				return basicSetBank(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__BASE_ADDRESS:
				return basicSetBaseAddress(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ENUMERATED_VALUES:
				return basicSetEnumeratedValues(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__MEMORY_MAP_REF:
				return basicSetMemoryMapRef(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__MEMORY_MAPS:
				return basicSetMemoryMaps(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__REGISTER_FILE:
				return basicSetRegisterFile(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ABSTRACTION_DEFINITION:
				return basicSetAbstractionDefinition(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ABSTRACTOR:
				return basicSetAbstractor(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ABSTRACTOR_GENERATOR:
				return basicSetAbstractorGenerator(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__ABSTRACTOR_GENERATORS:
				return basicSetAbstractorGenerators(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__AD_HOC_CONNECTION:
				return basicSetAdHocConnection(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__AD_HOC_CONNECTIONS:
				return basicSetAdHocConnections(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__BUS_DEFINITION:
				return basicSetBusDefinition(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__BUS_INTERFACE:
				return basicSetBusInterface(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__BUS_INTERFACES:
				return basicSetBusInterfaces(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__CHANNELS:
				return basicSetChannels(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__COMPONENT:
				return basicSetComponent(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__COMPONENT_GENERATOR:
				return basicSetComponentGenerator(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__COMPONENT_GENERATORS:
				return basicSetComponentGenerators(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__COMPONENT_INSTANCE:
				return basicSetComponentInstance(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__COMPONENT_INSTANCES:
				return basicSetComponentInstances(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__CONFIGURABLE_ELEMENT_VALUE:
				return basicSetConfigurableElementValue(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__CONFIGURABLE_ELEMENT_VALUES:
				return basicSetConfigurableElementValues(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__DESIGN:
				return basicSetDesign(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__DESIGN_CONFIGURATION:
				return basicSetDesignConfiguration(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__GENERATOR:
				return basicSetGenerator(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__GENERATOR_CHAIN:
				return basicSetGeneratorChain(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__GROUP_SELECTOR:
				return basicSetGroupSelector(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__INTERCONNECTION:
				return basicSetInterconnection(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__INTERCONNECTIONS:
				return basicSetInterconnections(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__MONITOR_INTERCONNECTION:
				return basicSetMonitorInterconnection(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__PHASE:
				return basicSetPhase(null, msgs);
			case spiritPackage.DOCUMENT_ROOT__REMAP_STATES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case spiritPackage.DOCUMENT_ROOT__CONSTRAINT_SET_REF:
				return getConstraintSetRef();
			case spiritPackage.DOCUMENT_ROOT__CONSTRAINT_SETS:
				return getConstraintSets();
			case spiritPackage.DOCUMENT_ROOT__DEFAULT_VALUE:
				return getDefaultValue();
			case spiritPackage.DOCUMENT_ROOT__DEPENDENCY:
				return getDependency();
			case spiritPackage.DOCUMENT_ROOT__DESCRIPTION:
				return getDescription();
			case spiritPackage.DOCUMENT_ROOT__DISPLAY_NAME:
			...
			case spiritPackage.DOCUMENT_ROOT__FILE_SETS:
				return getFileSets();
			case spiritPackage.DOCUMENT_ROOT__GENERATOR_REF:
				return getGeneratorRef();
			case spiritPackage.DOCUMENT_ROOT__INITIATIVE:
			...
			case spiritPackage.DOCUMENT_ROOT__PORT:
				return getPort();
			case spiritPackage.DOCUMENT_ROOT__PORT_ACCESS_HANDLE:
				return getPortAccessHandle();
			case spiritPackage.DOCUMENT_ROOT__PORT_ACCESS_TYPE:
			...
			case spiritPackage.DOCUMENT_ROOT__BIT_STRING_LENGTH:
				return getBitStringLength();
			case spiritPackage.DOCUMENT_ROOT__CELL_STRENGTH:
				return getCellStrength();
			case spiritPackage.DOCUMENT_ROOT__CHOICE_REF:
				return getChoiceRef();
			case spiritPackage.DOCUMENT_ROOT__CLOCK_EDGE:
				return getClockEdge();
			case spiritPackage.DOCUMENT_ROOT__CONFIG_GROUPS:
				return getConfigGroups();
			case spiritPackage.DOCUMENT_ROOT__CONSTRAINT_SET_ID:
				return getConstraintSetId();
			case spiritPackage.DOCUMENT_ROOT__DELAY_TYPE:
				return getDelayType();
			case spiritPackage.DOCUMENT_ROOT__DEPENDENCY1:
				return getDependency1();
			case spiritPackage.DOCUMENT_ROOT__FORMAT:
				return getFormat();
			case spiritPackage.DOCUMENT_ROOT__ID:
				return getId();
			case spiritPackage.DOCUMENT_ROOT__MAXIMUM:
				return getMaximum();
			case spiritPackage.DOCUMENT_ROOT__MINIMUM:
				return getMinimum();
			case spiritPackage.DOCUMENT_ROOT__ORDER:
				return getOrder();
			case spiritPackage.DOCUMENT_ROOT__PROMPT:
				return getPrompt();
			case spiritPackage.DOCUMENT_ROOT__RANGE_TYPE:
				return getRangeType();
			case spiritPackage.DOCUMENT_ROOT__RESOLVE:
				return getResolve();
			case spiritPackage.DOCUMENT_ROOT__ACCESS:
				return getAccess();
			case spiritPackage.DOCUMENT_ROOT__ADDRESS_BLOCK:
			...
			case spiritPackage.DOCUMENT_ROOT__ADDRESS_UNIT_BITS:
			...
			case spiritPackage.DOCUMENT_ROOT__VOLATILE:
				return isVolatile();
			case spiritPackage.DOCUMENT_ROOT__ADDRESS_SPACE_REF1:
				return getAddressSpaceRef1();
			case spiritPackage.DOCUMENT_ROOT__BANK_ALIGNMENT:
				return getBankAlignment();
			case spiritPackage.DOCUMENT_ROOT__MASTER_REF:
				return getMasterRef();
			case spiritPackage.DOCUMENT_ROOT__MEMORY_MAP_REF1:
				return getMemoryMapRef1();
			case spiritPackage.DOCUMENT_ROOT__SEGMENT_REF:
			...
			case spiritPackage.DOCUMENT_ROOT__BITS_IN_LAU:
				return getBitsInLau();
			case spiritPackage.DOCUMENT_ROOT__BUS_DEFINITION:
			...
			case spiritPackage.DOCUMENT_ROOT__GROUP:
				return getGroup();
			case spiritPackage.DOCUMENT_ROOT__GROUP_SELECTOR:
				return getGroupSelector();
			case spiritPackage.DOCUMENT_ROOT__INSTANCE_NAME:
			...
			case spiritPackage.DOCUMENT_ROOT__PHASE:
				return getPhase();
			case spiritPackage.DOCUMENT_ROOT__PRESENCE:
				return getPresence();
			case spiritPackage.DOCUMENT_ROOT__REMAP_STATES:

 ...
 * @generated
 */
public class WhiteboxPathTypeImpl extends MinimalEObjectImpl.Container implements WhiteboxPathType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getWhiteboxPathType();
	}
	...
	public void setPathName(String newPathName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_PATH_TYPE__PATH_NAME, oldPathName, pathName));
	}
	...
	public void setLeft(BigInteger newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_PATH_TYPE__LEFT, oldLeft, left));
	}
	...
	public void setRight(BigInteger newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_PATH_TYPE__RIGHT, oldRight, right));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.WHITEBOX_PATH_TYPE__PATH_NAME:
				return getPathName();
			case spiritPackage.WHITEBOX_PATH_TYPE__LEFT:
				return getLeft();
			case spiritPackage.WHITEBOX_PATH_TYPE__RIGHT:
				return getRight();
		}

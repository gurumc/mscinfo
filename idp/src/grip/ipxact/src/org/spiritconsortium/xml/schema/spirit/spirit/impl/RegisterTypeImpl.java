 ...
 * @generated
 */
public class RegisterTypeImpl extends MinimalEObjectImpl.Container implements RegisterType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getRegisterType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<BigInteger> getDim() {
		if (dim == null) {
			dim = new EDataTypeEList<BigInteger>(BigInteger.class, this, spiritPackage.REGISTER_TYPE__DIM);
		}
		return dim;
	}
	...
	public void setAddressOffset(String newAddressOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__ADDRESS_OFFSET, oldAddressOffset, addressOffset));
	}
	...
	public void setTypeIdentifier(String newTypeIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__TYPE_IDENTIFIER, oldTypeIdentifier, typeIdentifier));
	}
	...
	public NotificationChain basicSetSize(SizeType newSize, NotificationChain msgs) {
		...
		size = newSize;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__SIZE, oldSize, newSize);
	...
	public void setSize(SizeType newSize) {
		if (newSize != size) {
			...
			if (size != null)
				msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__SIZE, null, msgs);
			if (newSize != null)
				msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__SIZE, null, msgs);
			msgs = basicSetSize(newSize, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__SIZE, newSize, newSize));
	}
	...
	public void setVolatile(boolean newVolatile) {
		...
		volatileESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__VOLATILE, oldVolatile, volatile_, !oldVolatileESet));
	}
	...
	public void unsetVolatile() {
		...
		volatileESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.REGISTER_TYPE__VOLATILE, oldVolatile, VOLATILE_EDEFAULT, oldVolatileESet));
	}
	...
	public void setAccess(AccessType newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__ACCESS, oldAccess, access));
	}
	...
	public NotificationChain basicSetReset(ResetType1 newReset, NotificationChain msgs) {
		...
		reset = newReset;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__RESET, oldReset, newReset);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReset(ResetType1 newReset) {
		if (newReset != reset) {
			NotificationChain msgs = null;
			if (reset != null)
				msgs = ((InternalEObject)reset).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__RESET, null, msgs);
			if (newReset != null)
				msgs = ((InternalEObject)newReset).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__RESET, null, msgs);
			msgs = basicSetReset(newReset, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__RESET, newReset, newReset));
	}
	...
	public EList<FieldType> getField() {
		if (field == null) {
			field = new EObjectContainmentEList<FieldType>(FieldType.class, this, spiritPackage.REGISTER_TYPE__FIELD);
		}
		return field;
	}
	...
	public NotificationChain basicSetAlternateRegisters(AlternateRegistersType newAlternateRegisters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__ALTERNATE_REGISTERS, oldAlternateRegisters, newAlternateRegisters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAlternateRegisters(AlternateRegistersType newAlternateRegisters) {
		if (newAlternateRegisters != alternateRegisters) {
			...
			if (alternateRegisters != null)
				msgs = ((InternalEObject)alternateRegisters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__ALTERNATE_REGISTERS, null, msgs);
			if (newAlternateRegisters != null)
				msgs = ((InternalEObject)newAlternateRegisters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__ALTERNATE_REGISTERS, null, msgs);
			msgs = basicSetAlternateRegisters(newAlternateRegisters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__ALTERNATE_REGISTERS, newAlternateRegisters, newAlternateRegisters));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REGISTER_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REGISTER_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.REGISTER_TYPE__SIZE:
				return basicSetSize(null, msgs);
			case spiritPackage.REGISTER_TYPE__RESET:
				return basicSetReset(null, msgs);
			case spiritPackage.REGISTER_TYPE__FIELD:
				return ((InternalEList<?>)getField()).basicRemove(otherEnd, msgs);
			case spiritPackage.REGISTER_TYPE__ALTERNATE_REGISTERS:
				return basicSetAlternateRegisters(null, msgs);
			case spiritPackage.REGISTER_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.REGISTER_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.REGISTER_TYPE__NAME:
				return getName();
			case spiritPackage.REGISTER_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.REGISTER_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.REGISTER_TYPE__DIM:
				return getDim();
			case spiritPackage.REGISTER_TYPE__ADDRESS_OFFSET:
				return getAddressOffset();
			case spiritPackage.REGISTER_TYPE__TYPE_IDENTIFIER:
				return getTypeIdentifier();
			case spiritPackage.REGISTER_TYPE__SIZE:
				return getSize();
			case spiritPackage.REGISTER_TYPE__VOLATILE:
				return isVolatile();
			case spiritPackage.REGISTER_TYPE__ACCESS:
				return getAccess();
			case spiritPackage.REGISTER_TYPE__RESET:
				return getReset();
			case spiritPackage.REGISTER_TYPE__FIELD:
			...
			case spiritPackage.REGISTER_TYPE__ID:
				return getId();
		}

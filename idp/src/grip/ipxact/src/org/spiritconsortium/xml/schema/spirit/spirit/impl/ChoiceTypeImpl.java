...
public class ChoiceTypeImpl extends MinimalEObjectImpl.Container implements ChoiceType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getChoiceType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CHOICE_TYPE__NAME, oldName, name));
	}
	...
	public EList<EnumerationType> getEnumeration() {
		if (enumeration == null) {
			enumeration = new EObjectContainmentEList<EnumerationType>(EnumerationType.class, this, spiritPackage.CHOICE_TYPE__ENUMERATION);
		}
		return enumeration;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CHOICE_TYPE__ENUMERATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.CHOICE_TYPE__NAME:
				return getName();
			case spiritPackage.CHOICE_TYPE__ENUMERATION:

...
public class FileSetRefGroupType1Impl extends MinimalEObjectImpl.Container implements FileSetRefGroupType1 {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFileSetRefGroupType1();
	}
	...
	public EList<FileSetRefType> getFileSetRef() {
		if (fileSetRef == null) {
			fileSetRef = new EObjectContainmentEList<FileSetRefType>(FileSetRefType.class, this, spiritPackage.FILE_SET_REF_GROUP_TYPE1__FILE_SET_REF);
		}
		return fileSetRef;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.FILE_SET_REF_GROUP_TYPE1__FILE_SET_REF:

...
public class ChannelTypeImpl extends MinimalEObjectImpl.Container implements ChannelType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getChannelType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CHANNEL_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CHANNEL_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CHANNEL_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<String> getBusInterfaceRef() {
		if (busInterfaceRef == null) {
			busInterfaceRef = new EDataTypeEList<String>(String.class, this, spiritPackage.CHANNEL_TYPE__BUS_INTERFACE_REF);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.CHANNEL_TYPE__NAME:
				return getName();
			case spiritPackage.CHANNEL_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.CHANNEL_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.CHANNEL_TYPE__BUS_INTERFACE_REF:

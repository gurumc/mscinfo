 ...
 * @generated
 */
public class FileSetRefTypeImpl extends MinimalEObjectImpl.Container implements FileSetRefType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFileSetRefType();
	}
	...
	public void setLocalName(String newLocalName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_SET_REF_TYPE__LOCAL_NAME, oldLocalName, localName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.FILE_SET_REF_TYPE__LOCAL_NAME:
				return getLocalName();
		}

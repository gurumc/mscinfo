...
public class ConfigurableElementValuesTypeImpl extends MinimalEObjectImpl.Container implements ConfigurableElementValuesType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getConfigurableElementValuesType();
	}
	...
	public EList<ConfigurableElementValueType> getConfigurableElementValue() {
		if (configurableElementValue == null) {
			configurableElementValue = new EObjectContainmentEList<ConfigurableElementValueType>(ConfigurableElementValueType.class, this, spiritPackage.CONFIGURABLE_ELEMENT_VALUES_TYPE__CONFIGURABLE_ELEMENT_VALUE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CONFIGURABLE_ELEMENT_VALUES_TYPE__CONFIGURABLE_ELEMENT_VALUE:

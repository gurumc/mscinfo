 ...
 * @generated
 */
public class OnSystemType1Impl extends MinimalEObjectImpl.Container implements OnSystemType1 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getOnSystemType1();
	}
	...
	public void setGroup(String newGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__GROUP, oldGroup, group));
	}
	...
	public void setPresence(PresenceType newPresence) {
		...
		presenceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__PRESENCE, oldPresence, presence, !oldPresenceESet));
	}
	...
	public void unsetPresence() {
		...
		presenceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ON_SYSTEM_TYPE1__PRESENCE, oldPresence, PRESENCE_EDEFAULT, oldPresenceESet));
	}
	...
	public void setWidth(BigInteger newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__WIDTH, oldWidth, width));
	}
	...
	public void setDirection(DirectionType newDirection) {
		...
		directionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__DIRECTION, oldDirection, direction, !oldDirectionESet));
	}
	...
	public void unsetDirection() {
		...
		directionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ON_SYSTEM_TYPE1__DIRECTION, oldDirection, DIRECTION_EDEFAULT, oldDirectionESet));
	}
	...
	public NotificationChain basicSetModeConstraints(AbstractionDefPortConstraintsType newModeConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__MODE_CONSTRAINTS, oldModeConstraints, newModeConstraints);
	...
	public void setModeConstraints(AbstractionDefPortConstraintsType newModeConstraints) {
		if (newModeConstraints != modeConstraints) {
			...
			if (modeConstraints != null)
				msgs = ((InternalEObject)modeConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ON_SYSTEM_TYPE1__MODE_CONSTRAINTS, null, msgs);
			if (newModeConstraints != null)
				msgs = ((InternalEObject)newModeConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ON_SYSTEM_TYPE1__MODE_CONSTRAINTS, null, msgs);
			msgs = basicSetModeConstraints(newModeConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__MODE_CONSTRAINTS, newModeConstraints, newModeConstraints));
	}
	...
	public NotificationChain basicSetMirroredModeConstraints(AbstractionDefPortConstraintsType newMirroredModeConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__MIRRORED_MODE_CONSTRAINTS, oldMirroredModeConstraints, newMirroredModeConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMirroredModeConstraints(AbstractionDefPortConstraintsType newMirroredModeConstraints) {
		if (newMirroredModeConstraints != mirroredModeConstraints) {
			...
			if (mirroredModeConstraints != null)
				msgs = ((InternalEObject)mirroredModeConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ON_SYSTEM_TYPE1__MIRRORED_MODE_CONSTRAINTS, null, msgs);
			if (newMirroredModeConstraints != null)
				msgs = ((InternalEObject)newMirroredModeConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ON_SYSTEM_TYPE1__MIRRORED_MODE_CONSTRAINTS, null, msgs);
			msgs = basicSetMirroredModeConstraints(newMirroredModeConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_SYSTEM_TYPE1__MIRRORED_MODE_CONSTRAINTS, newMirroredModeConstraints, newMirroredModeConstraints));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ON_SYSTEM_TYPE1__MODE_CONSTRAINTS:
				return basicSetModeConstraints(null, msgs);
			case spiritPackage.ON_SYSTEM_TYPE1__MIRRORED_MODE_CONSTRAINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ON_SYSTEM_TYPE1__GROUP:
				return getGroup();
			case spiritPackage.ON_SYSTEM_TYPE1__PRESENCE:
				return getPresence();
			case spiritPackage.ON_SYSTEM_TYPE1__WIDTH:
				return getWidth();
			case spiritPackage.ON_SYSTEM_TYPE1__DIRECTION:
				return getDirection();
			case spiritPackage.ON_SYSTEM_TYPE1__MODE_CONSTRAINTS:

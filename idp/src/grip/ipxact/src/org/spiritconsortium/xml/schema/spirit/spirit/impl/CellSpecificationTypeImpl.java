 ...
 * @generated
 */
public class CellSpecificationTypeImpl extends MinimalEObjectImpl.Container implements CellSpecificationType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getCellSpecificationType();
	}
	...
	public NotificationChain basicSetCellFunction(CellFunctionType newCellFunction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CELL_SPECIFICATION_TYPE__CELL_FUNCTION, oldCellFunction, newCellFunction);
	...
	public void setCellFunction(CellFunctionType newCellFunction) {
		if (newCellFunction != cellFunction) {
			...
			if (cellFunction != null)
				msgs = ((InternalEObject)cellFunction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CELL_SPECIFICATION_TYPE__CELL_FUNCTION, null, msgs);
			if (newCellFunction != null)
				msgs = ((InternalEObject)newCellFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CELL_SPECIFICATION_TYPE__CELL_FUNCTION, null, msgs);
			msgs = basicSetCellFunction(newCellFunction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CELL_SPECIFICATION_TYPE__CELL_FUNCTION, newCellFunction, newCellFunction));
	}
	...
	public NotificationChain basicSetCellClass(CellClassType newCellClass, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CELL_SPECIFICATION_TYPE__CELL_CLASS, oldCellClass, newCellClass);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCellClass(CellClassType newCellClass) {
		if (newCellClass != cellClass) {
			NotificationChain msgs = null;
			if (cellClass != null)
				msgs = ((InternalEObject)cellClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CELL_SPECIFICATION_TYPE__CELL_CLASS, null, msgs);
			if (newCellClass != null)
				msgs = ((InternalEObject)newCellClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CELL_SPECIFICATION_TYPE__CELL_CLASS, null, msgs);
			msgs = basicSetCellClass(newCellClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CELL_SPECIFICATION_TYPE__CELL_CLASS, newCellClass, newCellClass));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CELL_SPECIFICATION_TYPE__CELL_FUNCTION:
				return basicSetCellFunction(null, msgs);
			case spiritPackage.CELL_SPECIFICATION_TYPE__CELL_CLASS:

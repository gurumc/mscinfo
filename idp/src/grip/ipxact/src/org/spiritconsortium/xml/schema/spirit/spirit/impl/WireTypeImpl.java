 ...
 * @generated
 */
public class WireTypeImpl extends MinimalEObjectImpl.Container implements WireType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<OnSystemType1> onSystem;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getWireType();
	}
	...
	public NotificationChain basicSetQualifier(QualifierType1 newQualifier, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__QUALIFIER, oldQualifier, newQualifier);
	...
	public void setQualifier(QualifierType1 newQualifier) {
		if (newQualifier != qualifier) {
			...
			if (qualifier != null)
				msgs = ((InternalEObject)qualifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__QUALIFIER, null, msgs);
			if (newQualifier != null)
				msgs = ((InternalEObject)newQualifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__QUALIFIER, null, msgs);
			msgs = basicSetQualifier(newQualifier, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__QUALIFIER, newQualifier, newQualifier));
	}
	 ...
	 * @generated
	 */
	public EList<OnSystemType1> getOnSystem() {
		if (onSystem == null) {
			onSystem = new EObjectContainmentEList<OnSystemType1>(OnSystemType1.class, this, spiritPackage.WIRE_TYPE__ON_SYSTEM);
		}
		return onSystem;
	}
	...
	public NotificationChain basicSetOnMaster(OnMasterType1 newOnMaster, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__ON_MASTER, oldOnMaster, newOnMaster);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOnMaster(OnMasterType1 newOnMaster) {
		if (newOnMaster != onMaster) {
			NotificationChain msgs = null;
			if (onMaster != null)
				msgs = ((InternalEObject)onMaster).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__ON_MASTER, null, msgs);
			if (newOnMaster != null)
				msgs = ((InternalEObject)newOnMaster).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__ON_MASTER, null, msgs);
			msgs = basicSetOnMaster(newOnMaster, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__ON_MASTER, newOnMaster, newOnMaster));
	}
	...
	public NotificationChain basicSetOnSlave(OnSlaveType1 newOnSlave, NotificationChain msgs) {
		...
		onSlave = newOnSlave;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__ON_SLAVE, oldOnSlave, newOnSlave);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOnSlave(OnSlaveType1 newOnSlave) {
		if (newOnSlave != onSlave) {
			NotificationChain msgs = null;
			if (onSlave != null)
				msgs = ((InternalEObject)onSlave).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__ON_SLAVE, null, msgs);
			if (newOnSlave != null)
				msgs = ((InternalEObject)newOnSlave).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__ON_SLAVE, null, msgs);
			msgs = basicSetOnSlave(newOnSlave, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__ON_SLAVE, newOnSlave, newOnSlave));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public NotificationChain basicSetRequiresDriver(RequiresDriverType newRequiresDriver, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__REQUIRES_DRIVER, oldRequiresDriver, newRequiresDriver);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRequiresDriver(RequiresDriverType newRequiresDriver) {
		if (newRequiresDriver != requiresDriver) {
			...
			if (requiresDriver != null)
				msgs = ((InternalEObject)requiresDriver).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__REQUIRES_DRIVER, null, msgs);
			if (newRequiresDriver != null)
				msgs = ((InternalEObject)newRequiresDriver).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE__REQUIRES_DRIVER, null, msgs);
			msgs = basicSetRequiresDriver(newRequiresDriver, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE__REQUIRES_DRIVER, newRequiresDriver, newRequiresDriver));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.WIRE_TYPE__QUALIFIER:
				return basicSetQualifier(null, msgs);
			case spiritPackage.WIRE_TYPE__ON_SYSTEM:
				return ((InternalEList<?>)getOnSystem()).basicRemove(otherEnd, msgs);
			case spiritPackage.WIRE_TYPE__ON_MASTER:
				return basicSetOnMaster(null, msgs);
			case spiritPackage.WIRE_TYPE__ON_SLAVE:
				return basicSetOnSlave(null, msgs);
			case spiritPackage.WIRE_TYPE__REQUIRES_DRIVER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case spiritPackage.WIRE_TYPE__ON_SLAVE:
				return getOnSlave();
			case spiritPackage.WIRE_TYPE__DEFAULT_VALUE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.WIRE_TYPE__ON_SYSTEM:
				getOnSystem().clear();
				getOnSystem().addAll((Collection<? extends OnSystemType1>)newValue);
				return;
			case spiritPackage.WIRE_TYPE__ON_MASTER:

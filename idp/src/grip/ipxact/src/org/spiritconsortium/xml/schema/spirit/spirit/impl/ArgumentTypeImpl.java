...
public class ArgumentTypeImpl extends NameValuePairTypeImpl implements ArgumentType {
	 ...
	 * @ordered
	 */
	protected static final DataTypeType DATA_TYPE_EDEFAULT = DataTypeType.INT;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getArgumentType();
	}
	...
	public void setDataType(DataTypeType newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ARGUMENT_TYPE__DATA_TYPE, oldDataType, dataType, !oldDataTypeESet));
	}
	...
	public void unsetDataType() {
		...
		dataTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ARGUMENT_TYPE__DATA_TYPE, oldDataType, DATA_TYPE_EDEFAULT, oldDataTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ARGUMENT_TYPE__DATA_TYPE:
				return getDataType();
		}

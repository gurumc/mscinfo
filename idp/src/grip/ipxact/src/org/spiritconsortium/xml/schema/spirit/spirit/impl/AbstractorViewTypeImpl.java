 ...
 * @generated
 */
public class AbstractorViewTypeImpl extends MinimalEObjectImpl.Container implements AbstractorViewType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractorViewType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<String> getEnvIdentifier() {
		if (envIdentifier == null) {
			envIdentifier = new EDataTypeEList<String>(String.class, this, spiritPackage.ABSTRACTOR_VIEW_TYPE__ENV_IDENTIFIER);
		}
	...
	public NotificationChain basicSetLanguage(LanguageType newLanguage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__LANGUAGE, oldLanguage, newLanguage);
	...
	public void setLanguage(LanguageType newLanguage) {
		if (newLanguage != language) {
			...
			if (language != null)
				msgs = ((InternalEObject)language).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_VIEW_TYPE__LANGUAGE, null, msgs);
			if (newLanguage != null)
				msgs = ((InternalEObject)newLanguage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_VIEW_TYPE__LANGUAGE, null, msgs);
			msgs = basicSetLanguage(newLanguage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__LANGUAGE, newLanguage, newLanguage));
	}
	...
	public void setModelName(String newModelName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__MODEL_NAME, oldModelName, modelName));
	}
	...
	public EList<FileBuilderType> getDefaultFileBuilder() {
		if (defaultFileBuilder == null) {
			defaultFileBuilder = new EObjectContainmentEList<FileBuilderType>(FileBuilderType.class, this, spiritPackage.ABSTRACTOR_VIEW_TYPE__DEFAULT_FILE_BUILDER);
		}
	...
	public EList<FileSetRefType> getFileSetRef() {
		if (fileSetRef == null) {
			fileSetRef = new EObjectContainmentEList<FileSetRefType>(FileSetRefType.class, this, spiritPackage.ABSTRACTOR_VIEW_TYPE__FILE_SET_REF);
		}
		return fileSetRef;
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_VIEW_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_VIEW_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_VIEW_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_VIEW_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_VIEW_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__LANGUAGE:
				return basicSetLanguage(null, msgs);
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__DEFAULT_FILE_BUILDER:
				return ((InternalEList<?>)getDefaultFileBuilder()).basicRemove(otherEnd, msgs);
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__FILE_SET_REF:
				return ((InternalEList<?>)getFileSetRef()).basicRemove(otherEnd, msgs);
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__NAME:
				return getName();
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__ENV_IDENTIFIER:
				return getEnvIdentifier();
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__LANGUAGE:
				return getLanguage();
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__MODEL_NAME:
				return getModelName();
			case spiritPackage.ABSTRACTOR_VIEW_TYPE__DEFAULT_FILE_BUILDER:

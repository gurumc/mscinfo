...
public class FileSetsTypeImpl extends MinimalEObjectImpl.Container implements FileSetsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFileSetsType();
	}
	...
	public EList<FileSetType> getFileSet() {
		if (fileSet == null) {
			fileSet = new EObjectContainmentEList<FileSetType>(FileSetType.class, this, spiritPackage.FILE_SETS_TYPE__FILE_SET);
		}
		return fileSet;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.FILE_SETS_TYPE__FILE_SET:

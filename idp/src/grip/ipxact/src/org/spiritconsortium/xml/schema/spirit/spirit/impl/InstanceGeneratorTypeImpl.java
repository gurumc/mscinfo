...
public class InstanceGeneratorTypeImpl extends GeneratorType1Impl implements InstanceGeneratorType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getInstanceGeneratorType();
	}
	...
	public EList<String> getGroup() {
		if (group == null) {
			group = new EDataTypeEList<String>(String.class, this, spiritPackage.INSTANCE_GENERATOR_TYPE__GROUP);
		}
		return group;
	}
	...
	public void setScope(ScopeType newScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INSTANCE_GENERATOR_TYPE__SCOPE, oldScope, scope, !oldScopeESet));
	}
	...
	public void unsetScope() {
		...
		scopeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.INSTANCE_GENERATOR_TYPE__SCOPE, oldScope, SCOPE_EDEFAULT, oldScopeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.INSTANCE_GENERATOR_TYPE__GROUP:
				return getGroup();
			case spiritPackage.INSTANCE_GENERATOR_TYPE__SCOPE:
				return getScope();
		}

 ...
 * @generated
 */
public class ViewConfigurationTypeImpl extends MinimalEObjectImpl.Container implements ViewConfigurationType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getViewConfigurationType();
	}
	...
	public void setInstanceName(String newInstanceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.VIEW_CONFIGURATION_TYPE__INSTANCE_NAME, oldInstanceName, instanceName));
	}
	...
	public void setViewName(String newViewName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.VIEW_CONFIGURATION_TYPE__VIEW_NAME, oldViewName, viewName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.VIEW_CONFIGURATION_TYPE__INSTANCE_NAME:
				return getInstanceName();
			case spiritPackage.VIEW_CONFIGURATION_TYPE__VIEW_NAME:
				return getViewName();
		}

 ...
 * @generated
 */
public class GeneratorSelectorTypeImpl extends MinimalEObjectImpl.Container implements GeneratorSelectorType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getGeneratorSelectorType();
	}
	...
	public NotificationChain basicSetGroupSelector(GroupSelectorType newGroupSelector, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_SELECTOR_TYPE__GROUP_SELECTOR, oldGroupSelector, newGroupSelector);
	...
	public void setGroupSelector(GroupSelectorType newGroupSelector) {
		if (newGroupSelector != groupSelector) {
			...
			if (groupSelector != null)
				msgs = ((InternalEObject)groupSelector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_SELECTOR_TYPE__GROUP_SELECTOR, null, msgs);
			if (newGroupSelector != null)
				msgs = ((InternalEObject)newGroupSelector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_SELECTOR_TYPE__GROUP_SELECTOR, null, msgs);
			msgs = basicSetGroupSelector(newGroupSelector, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_SELECTOR_TYPE__GROUP_SELECTOR, newGroupSelector, newGroupSelector));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.GENERATOR_SELECTOR_TYPE__GROUP_SELECTOR:

...
public class DesignTypeImpl extends MinimalEObjectImpl.Container implements DesignType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getDesignType();
	}
	...
	public void setVendor(String newVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setLibrary(String newLibrary) {
		...
		library = newLibrary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__VERSION, oldVersion, version));
	}
	...
	public NotificationChain basicSetComponentInstances(ComponentInstancesType newComponentInstances, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__COMPONENT_INSTANCES, oldComponentInstances, newComponentInstances);
	...
	public void setComponentInstances(ComponentInstancesType newComponentInstances) {
		if (newComponentInstances != componentInstances) {
			...
			if (componentInstances != null)
				msgs = ((InternalEObject)componentInstances).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__COMPONENT_INSTANCES, null, msgs);
			if (newComponentInstances != null)
				msgs = ((InternalEObject)newComponentInstances).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__COMPONENT_INSTANCES, null, msgs);
			msgs = basicSetComponentInstances(newComponentInstances, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__COMPONENT_INSTANCES, newComponentInstances, newComponentInstances));
	}
	...
	public NotificationChain basicSetInterconnections(InterconnectionsType newInterconnections, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__INTERCONNECTIONS, oldInterconnections, newInterconnections);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInterconnections(InterconnectionsType newInterconnections) {
		if (newInterconnections != interconnections) {
			...
			if (interconnections != null)
				msgs = ((InternalEObject)interconnections).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__INTERCONNECTIONS, null, msgs);
			if (newInterconnections != null)
				msgs = ((InternalEObject)newInterconnections).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__INTERCONNECTIONS, null, msgs);
			msgs = basicSetInterconnections(newInterconnections, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__INTERCONNECTIONS, newInterconnections, newInterconnections));
	}
	...
	public NotificationChain basicSetAdHocConnections(AdHocConnectionsType newAdHocConnections, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__AD_HOC_CONNECTIONS, oldAdHocConnections, newAdHocConnections);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdHocConnections(AdHocConnectionsType newAdHocConnections) {
		if (newAdHocConnections != adHocConnections) {
			...
			if (adHocConnections != null)
				msgs = ((InternalEObject)adHocConnections).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__AD_HOC_CONNECTIONS, null, msgs);
			if (newAdHocConnections != null)
				msgs = ((InternalEObject)newAdHocConnections).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__AD_HOC_CONNECTIONS, null, msgs);
			msgs = basicSetAdHocConnections(newAdHocConnections, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__AD_HOC_CONNECTIONS, newAdHocConnections, newAdHocConnections));
	}
	...
	public NotificationChain basicSetHierConnections(HierConnectionsType newHierConnections, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__HIER_CONNECTIONS, oldHierConnections, newHierConnections);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHierConnections(HierConnectionsType newHierConnections) {
		if (newHierConnections != hierConnections) {
			...
			if (hierConnections != null)
				msgs = ((InternalEObject)hierConnections).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__HIER_CONNECTIONS, null, msgs);
			if (newHierConnections != null)
				msgs = ((InternalEObject)newHierConnections).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__HIER_CONNECTIONS, null, msgs);
			msgs = basicSetHierConnections(newHierConnections, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__HIER_CONNECTIONS, newHierConnections, newHierConnections));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.DESIGN_TYPE__COMPONENT_INSTANCES:
				return basicSetComponentInstances(null, msgs);
			case spiritPackage.DESIGN_TYPE__INTERCONNECTIONS:
				return basicSetInterconnections(null, msgs);
			case spiritPackage.DESIGN_TYPE__AD_HOC_CONNECTIONS:
				return basicSetAdHocConnections(null, msgs);
			case spiritPackage.DESIGN_TYPE__HIER_CONNECTIONS:
				return basicSetHierConnections(null, msgs);
			case spiritPackage.DESIGN_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.DESIGN_TYPE__VENDOR:
				return getVendor();
			case spiritPackage.DESIGN_TYPE__LIBRARY:
				return getLibrary();
			case spiritPackage.DESIGN_TYPE__NAME:
				return getName();
			case spiritPackage.DESIGN_TYPE__VERSION:
				return getVersion();
			case spiritPackage.DESIGN_TYPE__COMPONENT_INSTANCES:
			...
			case spiritPackage.DESIGN_TYPE__DESCRIPTION:

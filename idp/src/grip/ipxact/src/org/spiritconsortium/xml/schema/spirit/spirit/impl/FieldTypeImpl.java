...
public class FieldTypeImpl extends MinimalEObjectImpl.Container implements FieldType {
	 ...
	 * @ordered
	 */
	protected static final ModifiedWriteValueType MODIFIED_WRITE_VALUE_EDEFAULT = ModifiedWriteValueType.ONE_TO_CLEAR;
	 ...
	 * @ordered
	 */
	protected static final ReadActionType READ_ACTION_EDEFAULT = ReadActionType.CLEAR;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFieldType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setBitOffset(BigInteger newBitOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__BIT_OFFSET, oldBitOffset, bitOffset));
	}
	...
	public void setTypeIdentifier(String newTypeIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__TYPE_IDENTIFIER, oldTypeIdentifier, typeIdentifier));
	}
	...
	public NotificationChain basicSetBitWidth(BitWidthType newBitWidth, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__BIT_WIDTH, oldBitWidth, newBitWidth);
	...
	public void setBitWidth(BitWidthType newBitWidth) {
		if (newBitWidth != bitWidth) {
			...
			if (bitWidth != null)
				msgs = ((InternalEObject)bitWidth).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__BIT_WIDTH, null, msgs);
			if (newBitWidth != null)
				msgs = ((InternalEObject)newBitWidth).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__BIT_WIDTH, null, msgs);
			msgs = basicSetBitWidth(newBitWidth, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__BIT_WIDTH, newBitWidth, newBitWidth));
	}
	...
	public void setVolatile(boolean newVolatile) {
		...
		volatileESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__VOLATILE, oldVolatile, volatile_, !oldVolatileESet));
	}
	...
	public void unsetVolatile() {
		...
		volatileESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.FIELD_TYPE__VOLATILE, oldVolatile, VOLATILE_EDEFAULT, oldVolatileESet));
	}
	...
	public void setAccess(AccessType newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__ACCESS, oldAccess, access));
	}
	...
	public NotificationChain basicSetEnumeratedValues(EnumeratedValuesType newEnumeratedValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__ENUMERATED_VALUES, oldEnumeratedValues, newEnumeratedValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEnumeratedValues(EnumeratedValuesType newEnumeratedValues) {
		if (newEnumeratedValues != enumeratedValues) {
			...
			if (enumeratedValues != null)
				msgs = ((InternalEObject)enumeratedValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__ENUMERATED_VALUES, null, msgs);
			if (newEnumeratedValues != null)
				msgs = ((InternalEObject)newEnumeratedValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__ENUMERATED_VALUES, null, msgs);
			msgs = basicSetEnumeratedValues(newEnumeratedValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__ENUMERATED_VALUES, newEnumeratedValues, newEnumeratedValues));
	}
	...
	public void setModifiedWriteValue(ModifiedWriteValueType newModifiedWriteValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__MODIFIED_WRITE_VALUE, oldModifiedWriteValue, modifiedWriteValue, !oldModifiedWriteValueESet));
	}
	...
	public void unsetModifiedWriteValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.FIELD_TYPE__MODIFIED_WRITE_VALUE, oldModifiedWriteValue, MODIFIED_WRITE_VALUE_EDEFAULT, oldModifiedWriteValueESet));
	}
	...
	public NotificationChain basicSetWriteValueConstraint(WriteValueConstraintType newWriteValueConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__WRITE_VALUE_CONSTRAINT, oldWriteValueConstraint, newWriteValueConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWriteValueConstraint(WriteValueConstraintType newWriteValueConstraint) {
		if (newWriteValueConstraint != writeValueConstraint) {
			...
			if (writeValueConstraint != null)
				msgs = ((InternalEObject)writeValueConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__WRITE_VALUE_CONSTRAINT, null, msgs);
			if (newWriteValueConstraint != null)
				msgs = ((InternalEObject)newWriteValueConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__WRITE_VALUE_CONSTRAINT, null, msgs);
			msgs = basicSetWriteValueConstraint(newWriteValueConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__WRITE_VALUE_CONSTRAINT, newWriteValueConstraint, newWriteValueConstraint));
	}
	...
	public void setReadAction(ReadActionType newReadAction) {
		...
		readActionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__READ_ACTION, oldReadAction, readAction, !oldReadActionESet));
	}
	...
	public void unsetReadAction() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.FIELD_TYPE__READ_ACTION, oldReadAction, READ_ACTION_EDEFAULT, oldReadActionESet));
	}
	...
	public NotificationChain basicSetTestable(TestableType newTestable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__TESTABLE, oldTestable, newTestable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTestable(TestableType newTestable) {
		if (newTestable != testable) {
			NotificationChain msgs = null;
			if (testable != null)
				msgs = ((InternalEObject)testable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__TESTABLE, null, msgs);
			if (newTestable != null)
				msgs = ((InternalEObject)newTestable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__TESTABLE, null, msgs);
			msgs = basicSetTestable(newTestable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__TESTABLE, newTestable, newTestable));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FIELD_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FIELD_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.FIELD_TYPE__BIT_WIDTH:
				return basicSetBitWidth(null, msgs);
			case spiritPackage.FIELD_TYPE__ENUMERATED_VALUES:
				return basicSetEnumeratedValues(null, msgs);
			case spiritPackage.FIELD_TYPE__WRITE_VALUE_CONSTRAINT:
				return basicSetWriteValueConstraint(null, msgs);
			case spiritPackage.FIELD_TYPE__TESTABLE:
				return basicSetTestable(null, msgs);
			case spiritPackage.FIELD_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.FIELD_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.FIELD_TYPE__NAME:
				return getName();
			case spiritPackage.FIELD_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.FIELD_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.FIELD_TYPE__BIT_OFFSET:
				return getBitOffset();
			case spiritPackage.FIELD_TYPE__TYPE_IDENTIFIER:
				return getTypeIdentifier();
			case spiritPackage.FIELD_TYPE__BIT_WIDTH:
				return getBitWidth();
			case spiritPackage.FIELD_TYPE__VOLATILE:
				return isVolatile();
			case spiritPackage.FIELD_TYPE__ACCESS:
				return getAccess();
			case spiritPackage.FIELD_TYPE__ENUMERATED_VALUES:
				return getEnumeratedValues();
			case spiritPackage.FIELD_TYPE__MODIFIED_WRITE_VALUE:
				return getModifiedWriteValue();
			case spiritPackage.FIELD_TYPE__WRITE_VALUE_CONSTRAINT:
				return getWriteValueConstraint();
			case spiritPackage.FIELD_TYPE__READ_ACTION:
			...
			case spiritPackage.FIELD_TYPE__ID:
				return getId();
		}

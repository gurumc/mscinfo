...
public class QualifierTypeImpl extends MinimalEObjectImpl.Container implements QualifierType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getQualifierType();
	}
	...
	public void setIsAddress(boolean newIsAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.QUALIFIER_TYPE__IS_ADDRESS, oldIsAddress, isAddress, !oldIsAddressESet));
	}
	...
	public void unsetIsAddress() {
		...
		isAddressESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.QUALIFIER_TYPE__IS_ADDRESS, oldIsAddress, IS_ADDRESS_EDEFAULT, oldIsAddressESet));
	}
	...
	public void setIsData(boolean newIsData) {
		...
		isDataESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.QUALIFIER_TYPE__IS_DATA, oldIsData, isData, !oldIsDataESet));
	}
	...
	public void unsetIsData() {
		...
		isDataESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.QUALIFIER_TYPE__IS_DATA, oldIsData, IS_DATA_EDEFAULT, oldIsDataESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.QUALIFIER_TYPE__IS_ADDRESS:
				return isIsAddress();
			case spiritPackage.QUALIFIER_TYPE__IS_DATA:
				return isIsData();
		}

 ...
 * @generated
 */
public class AbstractionDefPortConstraintsTypeImpl extends MinimalEObjectImpl.Container implements AbstractionDefPortConstraintsType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<TimingConstraintType> timingConstraint;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractionDefPortConstraintsType();
	}
	 ...
	 * @generated
	 */
	public EList<TimingConstraintType> getTimingConstraint() {
		if (timingConstraint == null) {
			timingConstraint = new EObjectContainmentEList<TimingConstraintType>(TimingConstraintType.class, this, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__TIMING_CONSTRAINT);
		}
	...
	public NotificationChain basicSetDriveConstraint(DriveConstraintType newDriveConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT, oldDriveConstraint, newDriveConstraint);
	...
	public void setDriveConstraint(DriveConstraintType newDriveConstraint) {
		if (newDriveConstraint != driveConstraint) {
			...
			if (driveConstraint != null)
				msgs = ((InternalEObject)driveConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT, null, msgs);
			if (newDriveConstraint != null)
				msgs = ((InternalEObject)newDriveConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT, null, msgs);
			msgs = basicSetDriveConstraint(newDriveConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT, newDriveConstraint, newDriveConstraint));
	}
	...
	public NotificationChain basicSetLoadConstraint(LoadConstraintType newLoadConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT, oldLoadConstraint, newLoadConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoadConstraint(LoadConstraintType newLoadConstraint) {
		if (newLoadConstraint != loadConstraint) {
			...
			if (loadConstraint != null)
				msgs = ((InternalEObject)loadConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT, null, msgs);
			if (newLoadConstraint != null)
				msgs = ((InternalEObject)newLoadConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT, null, msgs);
			msgs = basicSetLoadConstraint(newLoadConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT, newLoadConstraint, newLoadConstraint));
	}
	...
	public NotificationChain basicSetDriveConstraint1(DriveConstraintType newDriveConstraint1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT1, oldDriveConstraint1, newDriveConstraint1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDriveConstraint1(DriveConstraintType newDriveConstraint1) {
		if (newDriveConstraint1 != driveConstraint1) {
			...
			if (driveConstraint1 != null)
				msgs = ((InternalEObject)driveConstraint1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT1, null, msgs);
			if (newDriveConstraint1 != null)
				msgs = ((InternalEObject)newDriveConstraint1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT1, null, msgs);
			msgs = basicSetDriveConstraint1(newDriveConstraint1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT1, newDriveConstraint1, newDriveConstraint1));
	}
	...
	public NotificationChain basicSetLoadConstraint1(LoadConstraintType newLoadConstraint1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT1, oldLoadConstraint1, newLoadConstraint1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoadConstraint1(LoadConstraintType newLoadConstraint1) {
		if (newLoadConstraint1 != loadConstraint1) {
			...
			if (loadConstraint1 != null)
				msgs = ((InternalEObject)loadConstraint1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT1, null, msgs);
			if (newLoadConstraint1 != null)
				msgs = ((InternalEObject)newLoadConstraint1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT1, null, msgs);
			msgs = basicSetLoadConstraint1(newLoadConstraint1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT1, newLoadConstraint1, newLoadConstraint1));
	}
	...
	public NotificationChain basicSetLoadConstraint2(LoadConstraintType newLoadConstraint2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT2, oldLoadConstraint2, newLoadConstraint2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoadConstraint2(LoadConstraintType newLoadConstraint2) {
		if (newLoadConstraint2 != loadConstraint2) {
			...
			if (loadConstraint2 != null)
				msgs = ((InternalEObject)loadConstraint2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT2, null, msgs);
			if (newLoadConstraint2 != null)
				msgs = ((InternalEObject)newLoadConstraint2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT2, null, msgs);
			msgs = basicSetLoadConstraint2(newLoadConstraint2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT2, newLoadConstraint2, newLoadConstraint2));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__TIMING_CONSTRAINT:
				return ((InternalEList<?>)getTimingConstraint()).basicRemove(otherEnd, msgs);
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT:
				return basicSetDriveConstraint(null, msgs);
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT:
				return basicSetLoadConstraint(null, msgs);
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT1:
				return basicSetDriveConstraint1(null, msgs);
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT1:
				return basicSetLoadConstraint1(null, msgs);
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__LOAD_CONSTRAINT2:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__TIMING_CONSTRAINT:
				...
				getTimingConstraint().addAll((Collection<? extends TimingConstraintType>)newValue);
				return;
			case spiritPackage.ABSTRACTION_DEF_PORT_CONSTRAINTS_TYPE__DRIVE_CONSTRAINT:

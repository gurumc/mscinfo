...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Maximum Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getBitStringLength <em>Bit String Length</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getChoiceRef <em>Choice Ref</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getConfigGroups <em>Config Groups</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getDependency <em>Dependency</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getPrompt <em>Prompt</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getRangeType <em>Range Type</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getResolve <em>Resolve</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.MaximumTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MaximumTypeImpl extends MinimalEObjectImpl.Container implements MaximumType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getMaximumType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__VALUE, oldValue, value));
	}
	...
	public void setBitStringLength(BigInteger newBitStringLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__BIT_STRING_LENGTH, oldBitStringLength, bitStringLength));
	}
	...
	public void setChoiceRef(String newChoiceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__CHOICE_REF, oldChoiceRef, choiceRef));
	}
	...
	public void setConfigGroups(List<String> newConfigGroups) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__CONFIG_GROUPS, oldConfigGroups, configGroups));
	}
	...
	public void setDependency(String newDependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__DEPENDENCY, oldDependency, dependency));
	}
	...
	public void setFormat(FormatType newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.MAXIMUM_TYPE__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__ID, oldId, id));
	}
	...
	public void setMaximum(String newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMinimum(String newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setOrder(float newOrder) {
		...
		orderESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__ORDER, oldOrder, order, !oldOrderESet));
	}
	...
	public void unsetOrder() {
		...
		orderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.MAXIMUM_TYPE__ORDER, oldOrder, ORDER_EDEFAULT, oldOrderESet));
	}
	...
	public void setPrompt(String newPrompt) {
		...
		prompt = newPrompt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__PROMPT, oldPrompt, prompt));
	}
	...
	public void setRangeType(RangeTypeType newRangeType) {
		...
		rangeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__RANGE_TYPE, oldRangeType, rangeType, !oldRangeTypeESet));
	}
	...
	public void unsetRangeType() {
		...
		rangeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.MAXIMUM_TYPE__RANGE_TYPE, oldRangeType, RANGE_TYPE_EDEFAULT, oldRangeTypeESet));
	}
	...
	public void setResolve(ResolveType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MAXIMUM_TYPE__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.MAXIMUM_TYPE__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, spiritPackage.MAXIMUM_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.MAXIMUM_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.MAXIMUM_TYPE__VALUE:
				return getValue();
			case spiritPackage.MAXIMUM_TYPE__BIT_STRING_LENGTH:
				return getBitStringLength();
			case spiritPackage.MAXIMUM_TYPE__CHOICE_REF:
				return getChoiceRef();
			case spiritPackage.MAXIMUM_TYPE__CONFIG_GROUPS:
				return getConfigGroups();
			case spiritPackage.MAXIMUM_TYPE__DEPENDENCY:
				return getDependency();
			case spiritPackage.MAXIMUM_TYPE__FORMAT:
				return getFormat();
			case spiritPackage.MAXIMUM_TYPE__ID:
				return getId();
			case spiritPackage.MAXIMUM_TYPE__MAXIMUM:
				return getMaximum();
			case spiritPackage.MAXIMUM_TYPE__MINIMUM:
				return getMinimum();
			case spiritPackage.MAXIMUM_TYPE__ORDER:
				return getOrder();
			case spiritPackage.MAXIMUM_TYPE__PROMPT:
				return getPrompt();
			case spiritPackage.MAXIMUM_TYPE__RANGE_TYPE:
				return getRangeType();
			case spiritPackage.MAXIMUM_TYPE__RESOLVE:
				return getResolve();
			case spiritPackage.MAXIMUM_TYPE__ANY_ATTRIBUTE:

...
public class FileTypeImpl extends MinimalEObjectImpl.Container implements FileType {
	 ...
	 * @ordered
	 */
	protected EList<NameValuePairType> define;
	 ...
	 * @ordered
	 */
	protected EList<String> imageType;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFileType();
	}
	...
	public NotificationChain basicSetName(NameType newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__NAME, oldName, newName);
	...
	public void setName(NameType newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__NAME, null, msgs);
			if (newName != null)
				msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__NAME, null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__NAME, newName, newName));
	}
	...
	public FeatureMap getFileType() {
		if (fileType == null) {
			fileType = new BasicFeatureMap(this, spiritPackage.FILE_TYPE__FILE_TYPE);
		}
		return fileType;
	}
	 ...
	 * @generated
	 */
	public EList<FileTypeType> getFileType1() {
		return getFileType().list(spiritPackage.eINSTANCE.getFileType_FileType1());
	}
	 ...
	 * @generated
	 */
	public EList<String> getUserFileType() {
		return getFileType().list(spiritPackage.eINSTANCE.getFileType_UserFileType());
	}
	...
	public NotificationChain basicSetIsIncludeFile(IsIncludeFileType newIsIncludeFile, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__IS_INCLUDE_FILE, oldIsIncludeFile, newIsIncludeFile);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIsIncludeFile(IsIncludeFileType newIsIncludeFile) {
		if (newIsIncludeFile != isIncludeFile) {
			...
			if (isIncludeFile != null)
				msgs = ((InternalEObject)isIncludeFile).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__IS_INCLUDE_FILE, null, msgs);
			if (newIsIncludeFile != null)
				msgs = ((InternalEObject)newIsIncludeFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__IS_INCLUDE_FILE, null, msgs);
			msgs = basicSetIsIncludeFile(newIsIncludeFile, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__IS_INCLUDE_FILE, newIsIncludeFile, newIsIncludeFile));
	}
	...
	public NotificationChain basicSetLogicalName(LogicalNameType newLogicalName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__LOGICAL_NAME, oldLogicalName, newLogicalName);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLogicalName(LogicalNameType newLogicalName) {
		if (newLogicalName != logicalName) {
			NotificationChain msgs = null;
			if (logicalName != null)
				msgs = ((InternalEObject)logicalName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__LOGICAL_NAME, null, msgs);
			if (newLogicalName != null)
				msgs = ((InternalEObject)newLogicalName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__LOGICAL_NAME, null, msgs);
			msgs = basicSetLogicalName(newLogicalName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__LOGICAL_NAME, newLogicalName, newLogicalName));
	}
	...
	public EList<String> getExportedName() {
		if (exportedName == null) {
			exportedName = new EDataTypeEList<String>(String.class, this, spiritPackage.FILE_TYPE__EXPORTED_NAME);
		}
		return exportedName;
	}
	...
	public NotificationChain basicSetBuildCommand(BuildCommandType newBuildCommand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__BUILD_COMMAND, oldBuildCommand, newBuildCommand);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBuildCommand(BuildCommandType newBuildCommand) {
		if (newBuildCommand != buildCommand) {
			...
			if (buildCommand != null)
				msgs = ((InternalEObject)buildCommand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__BUILD_COMMAND, null, msgs);
			if (newBuildCommand != null)
				msgs = ((InternalEObject)newBuildCommand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__BUILD_COMMAND, null, msgs);
			msgs = basicSetBuildCommand(newBuildCommand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__BUILD_COMMAND, newBuildCommand, newBuildCommand));
	}
	...
	public EList<String> getDependency() {
		if (dependency == null) {
			dependency = new EDataTypeEList<String>(String.class, this, spiritPackage.FILE_TYPE__DEPENDENCY);
		}
		return dependency;
	}
	 ...
	 * @generated
	 */
	public EList<NameValuePairType> getDefine() {
		if (define == null) {
			define = new EObjectContainmentEList<NameValuePairType>(NameValuePairType.class, this, spiritPackage.FILE_TYPE__DEFINE);
		}
		return define;
	}
	 ...
	 * @generated
	 */
	public EList<String> getImageType() {
		if (imageType == null) {
			imageType = new EDataTypeEList<String>(String.class, this, spiritPackage.FILE_TYPE__IMAGE_TYPE);
		}
		return imageType;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setFileId(String newFileId) {
		...
		fileId = newFileId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_TYPE__FILE_ID, oldFileId, fileId));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, spiritPackage.FILE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.FILE_TYPE__NAME:
				return basicSetName(null, msgs);
			case spiritPackage.FILE_TYPE__FILE_TYPE:
				return ((InternalEList<?>)getFileType()).basicRemove(otherEnd, msgs);
			case spiritPackage.FILE_TYPE__IS_INCLUDE_FILE:
				return basicSetIsIncludeFile(null, msgs);
			case spiritPackage.FILE_TYPE__LOGICAL_NAME:
				return basicSetLogicalName(null, msgs);
			case spiritPackage.FILE_TYPE__BUILD_COMMAND:
				return basicSetBuildCommand(null, msgs);
			case spiritPackage.FILE_TYPE__DEFINE:
				return ((InternalEList<?>)getDefine()).basicRemove(otherEnd, msgs);
			case spiritPackage.FILE_TYPE__VENDOR_EXTENSIONS:
				return basicSetVendorExtensions(null, msgs);
			case spiritPackage.FILE_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case spiritPackage.FILE_TYPE__FILE_TYPE1:
				return getFileType1();
			case spiritPackage.FILE_TYPE__USER_FILE_TYPE:
				return getUserFileType();
			case spiritPackage.FILE_TYPE__IS_INCLUDE_FILE:
				return getIsIncludeFile();
			case spiritPackage.FILE_TYPE__LOGICAL_NAME:
				return getLogicalName();
			case spiritPackage.FILE_TYPE__EXPORTED_NAME:
				return getExportedName();
			case spiritPackage.FILE_TYPE__BUILD_COMMAND:
				return getBuildCommand();
			case spiritPackage.FILE_TYPE__DEPENDENCY:
				return getDependency();
			case spiritPackage.FILE_TYPE__DEFINE:
				return getDefine();
			case spiritPackage.FILE_TYPE__IMAGE_TYPE:
				return getImageType();
			case spiritPackage.FILE_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.FILE_TYPE__VENDOR_EXTENSIONS:
				return getVendorExtensions();
			case spiritPackage.FILE_TYPE__FILE_ID:
				return getFileId();
			case spiritPackage.FILE_TYPE__ANY_ATTRIBUTE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.FILE_TYPE__FILE_TYPE1:
				getFileType1().clear();
				getFileType1().addAll((Collection<? extends FileTypeType>)newValue);
				return;
			case spiritPackage.FILE_TYPE__USER_FILE_TYPE:
				getUserFileType().clear();
				getUserFileType().addAll((Collection<? extends String>)newValue);
				return;
			case spiritPackage.FILE_TYPE__IS_INCLUDE_FILE:
			...
			case spiritPackage.FILE_TYPE__DEFINE:
				getDefine().clear();
				getDefine().addAll((Collection<? extends NameValuePairType>)newValue);
				return;
			case spiritPackage.FILE_TYPE__IMAGE_TYPE:
				getImageType().clear();
				getImageType().addAll((Collection<? extends String>)newValue);
				return;
			case spiritPackage.FILE_TYPE__DESCRIPTION:

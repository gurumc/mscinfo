...
public class PortMapType1Impl extends MinimalEObjectImpl.Container implements PortMapType1 {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getPortMapType1();
	}
	...
	public NotificationChain basicSetLogicalPort(LogicalPortType1 newLogicalPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_MAP_TYPE1__LOGICAL_PORT, oldLogicalPort, newLogicalPort);
	...
	public void setLogicalPort(LogicalPortType1 newLogicalPort) {
		if (newLogicalPort != logicalPort) {
			...
			if (logicalPort != null)
				msgs = ((InternalEObject)logicalPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_MAP_TYPE1__LOGICAL_PORT, null, msgs);
			if (newLogicalPort != null)
				msgs = ((InternalEObject)newLogicalPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_MAP_TYPE1__LOGICAL_PORT, null, msgs);
			msgs = basicSetLogicalPort(newLogicalPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_MAP_TYPE1__LOGICAL_PORT, newLogicalPort, newLogicalPort));
	}
	...
	public NotificationChain basicSetPhysicalPort(PhysicalPortType1 newPhysicalPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_MAP_TYPE1__PHYSICAL_PORT, oldPhysicalPort, newPhysicalPort);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPhysicalPort(PhysicalPortType1 newPhysicalPort) {
		if (newPhysicalPort != physicalPort) {
			...
			if (physicalPort != null)
				msgs = ((InternalEObject)physicalPort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_MAP_TYPE1__PHYSICAL_PORT, null, msgs);
			if (newPhysicalPort != null)
				msgs = ((InternalEObject)newPhysicalPort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_MAP_TYPE1__PHYSICAL_PORT, null, msgs);
			msgs = basicSetPhysicalPort(newPhysicalPort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_MAP_TYPE1__PHYSICAL_PORT, newPhysicalPort, newPhysicalPort));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.PORT_MAP_TYPE1__LOGICAL_PORT:
				return basicSetLogicalPort(null, msgs);
			case spiritPackage.PORT_MAP_TYPE1__PHYSICAL_PORT:

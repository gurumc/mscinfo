 ...
 * @generated
 */
public class AbstractorTypeImpl extends MinimalEObjectImpl.Container implements AbstractorType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractorType();
	}
	...
	public void setInstanceName(String newInstanceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__INSTANCE_NAME, oldInstanceName, instanceName));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetAbstractorRef(LibraryRefType newAbstractorRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__ABSTRACTOR_REF, oldAbstractorRef, newAbstractorRef);
	...
	public void setAbstractorRef(LibraryRefType newAbstractorRef) {
		if (newAbstractorRef != abstractorRef) {
			...
			if (abstractorRef != null)
				msgs = ((InternalEObject)abstractorRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE__ABSTRACTOR_REF, null, msgs);
			if (newAbstractorRef != null)
				msgs = ((InternalEObject)newAbstractorRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE__ABSTRACTOR_REF, null, msgs);
			msgs = basicSetAbstractorRef(newAbstractorRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__ABSTRACTOR_REF, newAbstractorRef, newAbstractorRef));
	}
	...
	public NotificationChain basicSetConfigurableElementValues(ConfigurableElementValuesType newConfigurableElementValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__CONFIGURABLE_ELEMENT_VALUES, oldConfigurableElementValues, newConfigurableElementValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfigurableElementValues(ConfigurableElementValuesType newConfigurableElementValues) {
		if (newConfigurableElementValues != configurableElementValues) {
			...
			if (configurableElementValues != null)
				msgs = ((InternalEObject)configurableElementValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE__CONFIGURABLE_ELEMENT_VALUES, null, msgs);
			if (newConfigurableElementValues != null)
				msgs = ((InternalEObject)newConfigurableElementValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_TYPE__CONFIGURABLE_ELEMENT_VALUES, null, msgs);
			msgs = basicSetConfigurableElementValues(newConfigurableElementValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__CONFIGURABLE_ELEMENT_VALUES, newConfigurableElementValues, newConfigurableElementValues));
	}
	...
	public void setViewName(String newViewName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_TYPE__VIEW_NAME, oldViewName, viewName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_TYPE__ABSTRACTOR_REF:
				return basicSetAbstractorRef(null, msgs);
			case spiritPackage.ABSTRACTOR_TYPE__CONFIGURABLE_ELEMENT_VALUES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_TYPE__INSTANCE_NAME:
				return getInstanceName();
			case spiritPackage.ABSTRACTOR_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.ABSTRACTOR_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.ABSTRACTOR_TYPE__ABSTRACTOR_REF:
				return getAbstractorRef();
			case spiritPackage.ABSTRACTOR_TYPE__CONFIGURABLE_ELEMENT_VALUES:
				return getConfigurableElementValues();
			case spiritPackage.ABSTRACTOR_TYPE__VIEW_NAME:
				return getViewName();
		}

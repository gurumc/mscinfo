 ...
 * @generated
 */
public class ResetType1Impl extends MinimalEObjectImpl.Container implements ResetType1 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getResetType1();
	}
	...
	public NotificationChain basicSetValue(ValueType1 newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.RESET_TYPE1__VALUE, oldValue, newValue);
	...
	public void setValue(ValueType1 newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.RESET_TYPE1__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.RESET_TYPE1__VALUE, null, msgs);
			msgs = basicSetValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RESET_TYPE1__VALUE, newValue, newValue));
	}
	...
	public NotificationChain basicSetMask(MaskType1 newMask, NotificationChain msgs) {
		...
		mask = newMask;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.RESET_TYPE1__MASK, oldMask, newMask);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMask(MaskType1 newMask) {
		if (newMask != mask) {
			NotificationChain msgs = null;
			if (mask != null)
				msgs = ((InternalEObject)mask).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.RESET_TYPE1__MASK, null, msgs);
			if (newMask != null)
				msgs = ((InternalEObject)newMask).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.RESET_TYPE1__MASK, null, msgs);
			msgs = basicSetMask(newMask, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.RESET_TYPE1__MASK, newMask, newMask));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.RESET_TYPE1__VALUE:
				return basicSetValue(null, msgs);
			case spiritPackage.RESET_TYPE1__MASK:

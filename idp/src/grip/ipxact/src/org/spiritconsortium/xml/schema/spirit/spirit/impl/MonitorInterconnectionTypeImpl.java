 ...
 * @generated
 */
public class MonitorInterconnectionTypeImpl extends MinimalEObjectImpl.Container implements MonitorInterconnectionType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<HierInterface> monitorInterface;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getMonitorInterconnectionType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MONITOR_INTERCONNECTION_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MONITOR_INTERCONNECTION_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MONITOR_INTERCONNECTION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetMonitoredActiveInterface(HierInterface newMonitoredActiveInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITORED_ACTIVE_INTERFACE, oldMonitoredActiveInterface, newMonitoredActiveInterface);
	...
	public void setMonitoredActiveInterface(HierInterface newMonitoredActiveInterface) {
		if (newMonitoredActiveInterface != monitoredActiveInterface) {
			...
			if (monitoredActiveInterface != null)
				msgs = ((InternalEObject)monitoredActiveInterface).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITORED_ACTIVE_INTERFACE, null, msgs);
			if (newMonitoredActiveInterface != null)
				msgs = ((InternalEObject)newMonitoredActiveInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITORED_ACTIVE_INTERFACE, null, msgs);
			msgs = basicSetMonitoredActiveInterface(newMonitoredActiveInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITORED_ACTIVE_INTERFACE, newMonitoredActiveInterface, newMonitoredActiveInterface));
	}
	 ...
	 * @generated
	 */
	public EList<HierInterface> getMonitorInterface() {
		if (monitorInterface == null) {
			monitorInterface = new EObjectContainmentEList<HierInterface>(HierInterface.class, this, spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITOR_INTERFACE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITORED_ACTIVE_INTERFACE:
				return basicSetMonitoredActiveInterface(null, msgs);
			case spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITOR_INTERFACE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.MONITOR_INTERCONNECTION_TYPE__NAME:
				return getName();
			case spiritPackage.MONITOR_INTERCONNECTION_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.MONITOR_INTERCONNECTION_TYPE__DESCRIPTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.MONITOR_INTERCONNECTION_TYPE__MONITOR_INTERFACE:
				...
				getMonitorInterface().addAll((Collection<? extends HierInterface>)newValue);
				return;
		}

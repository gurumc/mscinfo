 ...
 * @generated
 */
public class AddressBlockTypeImpl extends MinimalEObjectImpl.Container implements AddressBlockType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAddressBlockType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetBaseAddress(BaseAddressType1 newBaseAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__BASE_ADDRESS, oldBaseAddress, newBaseAddress);
	...
	public void setBaseAddress(BaseAddressType1 newBaseAddress) {
		if (newBaseAddress != baseAddress) {
			...
			if (baseAddress != null)
				msgs = ((InternalEObject)baseAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__BASE_ADDRESS, null, msgs);
			if (newBaseAddress != null)
				msgs = ((InternalEObject)newBaseAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__BASE_ADDRESS, null, msgs);
			msgs = basicSetBaseAddress(newBaseAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__BASE_ADDRESS, newBaseAddress, newBaseAddress));
	}
	...
	public void setTypeIdentifier(String newTypeIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__TYPE_IDENTIFIER, oldTypeIdentifier, typeIdentifier));
	}
	...
	public NotificationChain basicSetRange(RangeType2 newRange, NotificationChain msgs) {
		...
		range = newRange;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__RANGE, oldRange, newRange);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRange(RangeType2 newRange) {
		if (newRange != range) {
			NotificationChain msgs = null;
			if (range != null)
				msgs = ((InternalEObject)range).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__RANGE, null, msgs);
			if (newRange != null)
				msgs = ((InternalEObject)newRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__RANGE, null, msgs);
			msgs = basicSetRange(newRange, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__RANGE, newRange, newRange));
	}
	...
	public NotificationChain basicSetWidth(WidthType newWidth, NotificationChain msgs) {
		...
		width = newWidth;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__WIDTH, oldWidth, newWidth);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWidth(WidthType newWidth) {
		if (newWidth != width) {
			NotificationChain msgs = null;
			if (width != null)
				msgs = ((InternalEObject)width).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__WIDTH, null, msgs);
			if (newWidth != null)
				msgs = ((InternalEObject)newWidth).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__WIDTH, null, msgs);
			msgs = basicSetWidth(newWidth, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__WIDTH, newWidth, newWidth));
	}
	...
	public void setUsage(UsageType1 newUsage) {
		...
		usageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__USAGE, oldUsage, usage, !oldUsageESet));
	}
	...
	public void unsetUsage() {
		...
		usageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ADDRESS_BLOCK_TYPE__USAGE, oldUsage, USAGE_EDEFAULT, oldUsageESet));
	}
	...
	public void setVolatile(boolean newVolatile) {
		...
		volatileESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__VOLATILE, oldVolatile, volatile_, !oldVolatileESet));
	}
	...
	public void unsetVolatile() {
		...
		volatileESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ADDRESS_BLOCK_TYPE__VOLATILE, oldVolatile, VOLATILE_EDEFAULT, oldVolatileESet));
	}
	...
	public void setAccess(AccessType newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__ACCESS, oldAccess, access));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public EList<RegisterType> getRegister() {
		if (register == null) {
			register = new EObjectContainmentEList<RegisterType>(RegisterType.class, this, spiritPackage.ADDRESS_BLOCK_TYPE__REGISTER);
		}
		return register;
	}
	...
	public EList<RegisterFileType> getRegisterFile() {
		if (registerFile == null) {
			registerFile = new EObjectContainmentEList<RegisterFileType>(RegisterFileType.class, this, spiritPackage.ADDRESS_BLOCK_TYPE__REGISTER_FILE);
		}
		return registerFile;
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_BLOCK_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_BLOCK_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ADDRESS_BLOCK_TYPE__BASE_ADDRESS:
				return basicSetBaseAddress(null, msgs);
			case spiritPackage.ADDRESS_BLOCK_TYPE__RANGE:
				return basicSetRange(null, msgs);
			case spiritPackage.ADDRESS_BLOCK_TYPE__WIDTH:
				return basicSetWidth(null, msgs);
			case spiritPackage.ADDRESS_BLOCK_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.ADDRESS_BLOCK_TYPE__REGISTER:
				return ((InternalEList<?>)getRegister()).basicRemove(otherEnd, msgs);
			case spiritPackage.ADDRESS_BLOCK_TYPE__REGISTER_FILE:
				return ((InternalEList<?>)getRegisterFile()).basicRemove(otherEnd, msgs);
			case spiritPackage.ADDRESS_BLOCK_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ADDRESS_BLOCK_TYPE__NAME:
				return getName();
			case spiritPackage.ADDRESS_BLOCK_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.ADDRESS_BLOCK_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.ADDRESS_BLOCK_TYPE__BASE_ADDRESS:
				return getBaseAddress();
			case spiritPackage.ADDRESS_BLOCK_TYPE__TYPE_IDENTIFIER:
				return getTypeIdentifier();
			case spiritPackage.ADDRESS_BLOCK_TYPE__RANGE:
				return getRange();
			case spiritPackage.ADDRESS_BLOCK_TYPE__WIDTH:
				return getWidth();
			case spiritPackage.ADDRESS_BLOCK_TYPE__USAGE:
				return getUsage();
			case spiritPackage.ADDRESS_BLOCK_TYPE__VOLATILE:
				return isVolatile();
			case spiritPackage.ADDRESS_BLOCK_TYPE__ACCESS:
				return getAccess();
			case spiritPackage.ADDRESS_BLOCK_TYPE__PARAMETERS:
			...
			case spiritPackage.ADDRESS_BLOCK_TYPE__ID:
				return getId();
		}

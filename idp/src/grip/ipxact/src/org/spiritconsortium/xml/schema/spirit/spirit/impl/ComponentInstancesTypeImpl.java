...
public class ComponentInstancesTypeImpl extends MinimalEObjectImpl.Container implements ComponentInstancesType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getComponentInstancesType();
	}
	...
	public EList<ComponentInstanceType> getComponentInstance() {
		if (componentInstance == null) {
			componentInstance = new EObjectContainmentEList<ComponentInstanceType>(ComponentInstanceType.class, this, spiritPackage.COMPONENT_INSTANCES_TYPE__COMPONENT_INSTANCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.COMPONENT_INSTANCES_TYPE__COMPONENT_INSTANCE:

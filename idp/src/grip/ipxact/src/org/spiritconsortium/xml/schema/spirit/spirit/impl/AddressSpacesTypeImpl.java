...
public class AddressSpacesTypeImpl extends MinimalEObjectImpl.Container implements AddressSpacesType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAddressSpacesType();
	}
	...
	public EList<AddressSpaceType> getAddressSpace() {
		if (addressSpace == null) {
			addressSpace = new EObjectContainmentEList<AddressSpaceType>(AddressSpaceType.class, this, spiritPackage.ADDRESS_SPACES_TYPE__ADDRESS_SPACE);
		}
		return addressSpace;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ADDRESS_SPACES_TYPE__ADDRESS_SPACE:

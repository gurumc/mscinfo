 ...
 * @generated
 */
public class ConstraintSetTypeImpl extends MinimalEObjectImpl.Container implements ConstraintSetType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getConstraintSetType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetVector(VectorType11 newVector, NotificationChain msgs) {
		...
		vector = newVector;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__VECTOR, oldVector, newVector);
	...
	public void setVector(VectorType11 newVector) {
		if (newVector != vector) {
			...
			if (vector != null)
				msgs = ((InternalEObject)vector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CONSTRAINT_SET_TYPE__VECTOR, null, msgs);
			if (newVector != null)
				msgs = ((InternalEObject)newVector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CONSTRAINT_SET_TYPE__VECTOR, null, msgs);
			msgs = basicSetVector(newVector, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__VECTOR, newVector, newVector));
	}
	...
	public NotificationChain basicSetDriveConstraint(DriveConstraintType newDriveConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__DRIVE_CONSTRAINT, oldDriveConstraint, newDriveConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDriveConstraint(DriveConstraintType newDriveConstraint) {
		if (newDriveConstraint != driveConstraint) {
			...
			if (driveConstraint != null)
				msgs = ((InternalEObject)driveConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CONSTRAINT_SET_TYPE__DRIVE_CONSTRAINT, null, msgs);
			if (newDriveConstraint != null)
				msgs = ((InternalEObject)newDriveConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CONSTRAINT_SET_TYPE__DRIVE_CONSTRAINT, null, msgs);
			msgs = basicSetDriveConstraint(newDriveConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__DRIVE_CONSTRAINT, newDriveConstraint, newDriveConstraint));
	}
	...
	public NotificationChain basicSetLoadConstraint(LoadConstraintType newLoadConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__LOAD_CONSTRAINT, oldLoadConstraint, newLoadConstraint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoadConstraint(LoadConstraintType newLoadConstraint) {
		if (newLoadConstraint != loadConstraint) {
			...
			if (loadConstraint != null)
				msgs = ((InternalEObject)loadConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CONSTRAINT_SET_TYPE__LOAD_CONSTRAINT, null, msgs);
			if (newLoadConstraint != null)
				msgs = ((InternalEObject)newLoadConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CONSTRAINT_SET_TYPE__LOAD_CONSTRAINT, null, msgs);
			msgs = basicSetLoadConstraint(newLoadConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__LOAD_CONSTRAINT, newLoadConstraint, newLoadConstraint));
	}
	...
	public EList<TimingConstraintType> getTimingConstraint() {
		if (timingConstraint == null) {
			timingConstraint = new EObjectContainmentEList<TimingConstraintType>(TimingConstraintType.class, this, spiritPackage.CONSTRAINT_SET_TYPE__TIMING_CONSTRAINT);
		}
	...
	public void setConstraintSetId(String newConstraintSetId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONSTRAINT_SET_TYPE__CONSTRAINT_SET_ID, oldConstraintSetId, constraintSetId));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CONSTRAINT_SET_TYPE__VECTOR:
				return basicSetVector(null, msgs);
			case spiritPackage.CONSTRAINT_SET_TYPE__DRIVE_CONSTRAINT:
				return basicSetDriveConstraint(null, msgs);
			case spiritPackage.CONSTRAINT_SET_TYPE__LOAD_CONSTRAINT:
				return basicSetLoadConstraint(null, msgs);
			case spiritPackage.CONSTRAINT_SET_TYPE__TIMING_CONSTRAINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.CONSTRAINT_SET_TYPE__NAME:
				return getName();
			case spiritPackage.CONSTRAINT_SET_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.CONSTRAINT_SET_TYPE__DESCRIPTION:
			...
			case spiritPackage.CONSTRAINT_SET_TYPE__CONSTRAINT_SET_ID:

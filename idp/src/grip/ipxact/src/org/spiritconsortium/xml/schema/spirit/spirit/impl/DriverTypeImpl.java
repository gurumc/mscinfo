...
public class DriverTypeImpl extends MinimalEObjectImpl.Container implements DriverType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getDriverType();
	}
	...
	public NotificationChain basicSetDefaultValue(DefaultValueType newDefaultValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DRIVER_TYPE__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
	...
	public void setDefaultValue(DefaultValueType newDefaultValue) {
		if (newDefaultValue != defaultValue) {
			...
			if (defaultValue != null)
				msgs = ((InternalEObject)defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DRIVER_TYPE__DEFAULT_VALUE, null, msgs);
			if (newDefaultValue != null)
				msgs = ((InternalEObject)newDefaultValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DRIVER_TYPE__DEFAULT_VALUE, null, msgs);
			msgs = basicSetDefaultValue(newDefaultValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DRIVER_TYPE__DEFAULT_VALUE, newDefaultValue, newDefaultValue));
	}
	...
	public NotificationChain basicSetClockDriver(ClockDriverType1 newClockDriver, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DRIVER_TYPE__CLOCK_DRIVER, oldClockDriver, newClockDriver);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setClockDriver(ClockDriverType1 newClockDriver) {
		if (newClockDriver != clockDriver) {
			NotificationChain msgs = null;
			if (clockDriver != null)
				msgs = ((InternalEObject)clockDriver).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DRIVER_TYPE__CLOCK_DRIVER, null, msgs);
			if (newClockDriver != null)
				msgs = ((InternalEObject)newClockDriver).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DRIVER_TYPE__CLOCK_DRIVER, null, msgs);
			msgs = basicSetClockDriver(newClockDriver, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DRIVER_TYPE__CLOCK_DRIVER, newClockDriver, newClockDriver));
	}
	...
	public NotificationChain basicSetSingleShotDriver(SingleShotDriverType newSingleShotDriver, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DRIVER_TYPE__SINGLE_SHOT_DRIVER, oldSingleShotDriver, newSingleShotDriver);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSingleShotDriver(SingleShotDriverType newSingleShotDriver) {
		if (newSingleShotDriver != singleShotDriver) {
			...
			if (singleShotDriver != null)
				msgs = ((InternalEObject)singleShotDriver).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DRIVER_TYPE__SINGLE_SHOT_DRIVER, null, msgs);
			if (newSingleShotDriver != null)
				msgs = ((InternalEObject)newSingleShotDriver).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DRIVER_TYPE__SINGLE_SHOT_DRIVER, null, msgs);
			msgs = basicSetSingleShotDriver(newSingleShotDriver, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DRIVER_TYPE__SINGLE_SHOT_DRIVER, newSingleShotDriver, newSingleShotDriver));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.DRIVER_TYPE__DEFAULT_VALUE:
				return basicSetDefaultValue(null, msgs);
			case spiritPackage.DRIVER_TYPE__CLOCK_DRIVER:
				return basicSetClockDriver(null, msgs);
			case spiritPackage.DRIVER_TYPE__SINGLE_SHOT_DRIVER:

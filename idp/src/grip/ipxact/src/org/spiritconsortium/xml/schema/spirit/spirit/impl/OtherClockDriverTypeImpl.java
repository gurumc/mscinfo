...
public class OtherClockDriverTypeImpl extends ClockDriverTypeImpl implements OtherClockDriverType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getOtherClockDriverType();
	}
	...
	public void setClockName(String newClockName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.OTHER_CLOCK_DRIVER_TYPE__CLOCK_NAME, oldClockName, clockName));
	}
	...
	public void setClockSource(String newClockSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.OTHER_CLOCK_DRIVER_TYPE__CLOCK_SOURCE, oldClockSource, clockSource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.OTHER_CLOCK_DRIVER_TYPE__CLOCK_NAME:
				return getClockName();
			case spiritPackage.OTHER_CLOCK_DRIVER_TYPE__CLOCK_SOURCE:

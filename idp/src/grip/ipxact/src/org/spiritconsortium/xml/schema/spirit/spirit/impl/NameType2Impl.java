 ...
 * @generated
 */
public class NameType2Impl extends MinimalEObjectImpl.Container implements NameType2 {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getNameType2();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.NAME_TYPE2__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.NAME_TYPE2__VALUE:
				return getValue();
		}

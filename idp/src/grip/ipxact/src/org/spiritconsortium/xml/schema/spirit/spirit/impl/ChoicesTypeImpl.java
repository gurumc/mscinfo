 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.ChoicesTypeImpl#getChoice <em>Choice</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoicesTypeImpl extends MinimalEObjectImpl.Container implements ChoicesType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getChoicesType();
	}
	...
	public EList<ChoiceType> getChoice() {
		if (choice == null) {
			choice = new EObjectContainmentEList<ChoiceType>(ChoiceType.class, this, spiritPackage.CHOICES_TYPE__CHOICE);
		}
		return choice;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CHOICES_TYPE__CHOICE:

 ...
 * @generated
 */
public class InterconnectionTypeImpl extends MinimalEObjectImpl.Container implements InterconnectionType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Interface> activeInterface;
	 ...
	 * @generated
	 */
	protected InterconnectionTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getInterconnectionType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERCONNECTION_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERCONNECTION_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERCONNECTION_TYPE__DESCRIPTION, oldDescription, description));
	}
	 ...
	 * @generated
	 */
	public EList<Interface> getActiveInterface() {
		if (activeInterface == null) {
			activeInterface = new EObjectContainmentEList<Interface>(Interface.class, this, spiritPackage.INTERCONNECTION_TYPE__ACTIVE_INTERFACE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.INTERCONNECTION_TYPE__ACTIVE_INTERFACE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.INTERCONNECTION_TYPE__NAME:
				return getName();
			case spiritPackage.INTERCONNECTION_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.INTERCONNECTION_TYPE__DESCRIPTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.INTERCONNECTION_TYPE__ACTIVE_INTERFACE:
				...
				getActiveInterface().addAll((Collection<? extends Interface>)newValue);
				return;
		}

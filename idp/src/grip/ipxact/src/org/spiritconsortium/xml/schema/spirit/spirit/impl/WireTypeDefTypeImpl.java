...
public class WireTypeDefTypeImpl extends MinimalEObjectImpl.Container implements WireTypeDefType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getWireTypeDefType();
	}
	...
	public NotificationChain basicSetTypeName(TypeNameType2 newTypeName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_NAME, oldTypeName, newTypeName);
	...
	public void setTypeName(TypeNameType2 newTypeName) {
		if (newTypeName != typeName) {
			...
			if (typeName != null)
				msgs = ((InternalEObject)typeName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_NAME, null, msgs);
			if (newTypeName != null)
				msgs = ((InternalEObject)newTypeName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_NAME, null, msgs);
			msgs = basicSetTypeName(newTypeName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_NAME, newTypeName, newTypeName));
	}
	...
	public EList<String> getTypeDefinition() {
		if (typeDefinition == null) {
			typeDefinition = new EDataTypeEList<String>(String.class, this, spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_DEFINITION);
		}
	...
	public EList<String> getViewNameRef() {
		if (viewNameRef == null) {
			viewNameRef = new EDataTypeEList<String>(String.class, this, spiritPackage.WIRE_TYPE_DEF_TYPE__VIEW_NAME_REF);
		}
		return viewNameRef;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_NAME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_NAME:
				return getTypeName();
			case spiritPackage.WIRE_TYPE_DEF_TYPE__TYPE_DEFINITION:
				return getTypeDefinition();
			case spiritPackage.WIRE_TYPE_DEF_TYPE__VIEW_NAME_REF:

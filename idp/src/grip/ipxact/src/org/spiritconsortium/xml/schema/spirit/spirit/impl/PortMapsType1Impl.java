 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.PortMapsType1Impl#getPortMap <em>Port Map</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortMapsType1Impl extends MinimalEObjectImpl.Container implements PortMapsType1 {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getPortMapsType1();
	}
	...
	public EList<PortMapType1> getPortMap() {
		if (portMap == null) {
			portMap = new EObjectContainmentEList<PortMapType1>(PortMapType1.class, this, spiritPackage.PORT_MAPS_TYPE1__PORT_MAP);
		}
		return portMap;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.PORT_MAPS_TYPE1__PORT_MAP:

 ...
 * @generated
 */
public class MemoryMapTypeImpl extends MinimalEObjectImpl.Container implements MemoryMapType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<MemoryRemapType> memoryRemap;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getMemoryMapType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public FeatureMap getMemoryMap() {
		if (memoryMap == null) {
			memoryMap = new BasicFeatureMap(this, spiritPackage.MEMORY_MAP_TYPE__MEMORY_MAP);
		}
		return memoryMap;
	}
	...
	public EList<AddressBlockType> getAddressBlock() {
		return getMemoryMap().list(spiritPackage.eINSTANCE.getMemoryMapType_AddressBlock());
	}
	...
	public EList<AddressBankType> getBank() {
		return getMemoryMap().list(spiritPackage.eINSTANCE.getMemoryMapType_Bank());
	}
	...
	public EList<SubspaceRefType> getSubspaceMap() {
		return getMemoryMap().list(spiritPackage.eINSTANCE.getMemoryMapType_SubspaceMap());
	}
	 ...
	 * @generated
	 */
	public EList<MemoryRemapType> getMemoryRemap() {
		if (memoryRemap == null) {
			memoryRemap = new EObjectContainmentEList<MemoryRemapType>(MemoryRemapType.class, this, spiritPackage.MEMORY_MAP_TYPE__MEMORY_REMAP);
		}
		return memoryRemap;
	}
	...
	public void setAddressUnitBits(BigInteger newAddressUnitBits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_TYPE__ADDRESS_UNIT_BITS, oldAddressUnitBits, addressUnitBits));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MEMORY_MAP_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.MEMORY_MAP_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.MEMORY_MAP_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.MEMORY_MAP_TYPE__NAME:
				return getName();
			case spiritPackage.MEMORY_MAP_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.MEMORY_MAP_TYPE__DESCRIPTION:
			...
			case spiritPackage.MEMORY_MAP_TYPE__ADDRESS_UNIT_BITS:
				return getAddressUnitBits();
			case spiritPackage.MEMORY_MAP_TYPE__VENDOR_EXTENSIONS:
				return getVendorExtensions();
			case spiritPackage.MEMORY_MAP_TYPE__ID:
				return getId();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.MEMORY_MAP_TYPE__MEMORY_REMAP:
				...
				getMemoryRemap().addAll((Collection<? extends MemoryRemapType>)newValue);
				return;
			case spiritPackage.MEMORY_MAP_TYPE__ADDRESS_UNIT_BITS:

 ...
 * @generated
 */
public class WhiteboxElementTypeImpl extends MinimalEObjectImpl.Container implements WhiteboxElementType {
	/**
	 ...
	 * @ordered
	 */
	protected static final WhiteboxTypeType WHITEBOX_TYPE_EDEFAULT = WhiteboxTypeType.REGISTER;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getWhiteboxElementType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setWhiteboxType(WhiteboxTypeType newWhiteboxType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__WHITEBOX_TYPE, oldWhiteboxType, whiteboxType, !oldWhiteboxTypeESet));
	}
	...
	public void unsetWhiteboxType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.WHITEBOX_ELEMENT_TYPE__WHITEBOX_TYPE, oldWhiteboxType, WHITEBOX_TYPE_EDEFAULT, oldWhiteboxTypeESet));
	}
	...
	public void setDriveable(boolean newDriveable) {
		...
		driveableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__DRIVEABLE, oldDriveable, driveable, !oldDriveableESet));
	}
	...
	public void unsetDriveable() {
		...
		driveableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.WHITEBOX_ELEMENT_TYPE__DRIVEABLE, oldDriveable, DRIVEABLE_EDEFAULT, oldDriveableESet));
	}
	...
	public void setRegisterRef(String newRegisterRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__REGISTER_REF, oldRegisterRef, registerRef));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__PARAMETERS, oldParameters, newParameters);
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			...
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WHITEBOX_ELEMENT_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WHITEBOX_ELEMENT_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WHITEBOX_ELEMENT_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WHITEBOX_ELEMENT_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WHITEBOX_ELEMENT_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__NAME:
				return getName();
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__WHITEBOX_TYPE:
				return getWhiteboxType();
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__DRIVEABLE:
				return isDriveable();
			case spiritPackage.WHITEBOX_ELEMENT_TYPE__REGISTER_REF:

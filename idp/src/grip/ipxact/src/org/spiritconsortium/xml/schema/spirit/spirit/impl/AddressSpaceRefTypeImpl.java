...
public class AddressSpaceRefTypeImpl extends AddrSpaceRefTypeImpl implements AddressSpaceRefType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAddressSpaceRefType();
	}
	...
	public NotificationChain basicSetBaseAddress(BaseAddressType newBaseAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_SPACE_REF_TYPE__BASE_ADDRESS, oldBaseAddress, newBaseAddress);
	...
	public void setBaseAddress(BaseAddressType newBaseAddress) {
		if (newBaseAddress != baseAddress) {
			...
			if (baseAddress != null)
				msgs = ((InternalEObject)baseAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_SPACE_REF_TYPE__BASE_ADDRESS, null, msgs);
			if (newBaseAddress != null)
				msgs = ((InternalEObject)newBaseAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ADDRESS_SPACE_REF_TYPE__BASE_ADDRESS, null, msgs);
			msgs = basicSetBaseAddress(newBaseAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ADDRESS_SPACE_REF_TYPE__BASE_ADDRESS, newBaseAddress, newBaseAddress));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ADDRESS_SPACE_REF_TYPE__BASE_ADDRESS:

...
public class OtherClocksImpl extends MinimalEObjectImpl.Container implements OtherClocks {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getOtherClocks();
	}
	...
	public EList<OtherClockDriverType> getOtherClockDriver() {
		if (otherClockDriver == null) {
			otherClockDriver = new EObjectContainmentEList<OtherClockDriverType>(OtherClockDriverType.class, this, spiritPackage.OTHER_CLOCKS__OTHER_CLOCK_DRIVER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.OTHER_CLOCKS__OTHER_CLOCK_DRIVER:

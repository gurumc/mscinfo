...
public class AdHocConnectionsTypeImpl extends MinimalEObjectImpl.Container implements AdHocConnectionsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAdHocConnectionsType();
	}
	...
	public EList<AdHocConnectionType> getAdHocConnection() {
		if (adHocConnection == null) {
			adHocConnection = new EObjectContainmentEList<AdHocConnectionType>(AdHocConnectionType.class, this, spiritPackage.AD_HOC_CONNECTIONS_TYPE__AD_HOC_CONNECTION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.AD_HOC_CONNECTIONS_TYPE__AD_HOC_CONNECTION:

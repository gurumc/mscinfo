 ...
 * @generated
 */
public class AlternateRegisterTypeImpl extends MinimalEObjectImpl.Container implements AlternateRegisterType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAlternateRegisterType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetAlternateGroups(AlternateGroupsType newAlternateGroups, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__ALTERNATE_GROUPS, oldAlternateGroups, newAlternateGroups);
	...
	public void setAlternateGroups(AlternateGroupsType newAlternateGroups) {
		if (newAlternateGroups != alternateGroups) {
			...
			if (alternateGroups != null)
				msgs = ((InternalEObject)alternateGroups).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__ALTERNATE_GROUPS, null, msgs);
			if (newAlternateGroups != null)
				msgs = ((InternalEObject)newAlternateGroups).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__ALTERNATE_GROUPS, null, msgs);
			msgs = basicSetAlternateGroups(newAlternateGroups, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__ALTERNATE_GROUPS, newAlternateGroups, newAlternateGroups));
	}
	...
	public void setTypeIdentifier(String newTypeIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__TYPE_IDENTIFIER, oldTypeIdentifier, typeIdentifier));
	}
	...
	public void setVolatile(boolean newVolatile) {
		...
		volatileESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__VOLATILE, oldVolatile, volatile_, !oldVolatileESet));
	}
	...
	public void unsetVolatile() {
		...
		volatileESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ALTERNATE_REGISTER_TYPE__VOLATILE, oldVolatile, VOLATILE_EDEFAULT, oldVolatileESet));
	}
	...
	public void setAccess(AccessType newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__ACCESS, oldAccess, access));
	}
	...
	public NotificationChain basicSetReset(ResetType newReset, NotificationChain msgs) {
		...
		reset = newReset;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__RESET, oldReset, newReset);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReset(ResetType newReset) {
		if (newReset != reset) {
			NotificationChain msgs = null;
			if (reset != null)
				msgs = ((InternalEObject)reset).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__RESET, null, msgs);
			if (newReset != null)
				msgs = ((InternalEObject)newReset).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__RESET, null, msgs);
			msgs = basicSetReset(newReset, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__RESET, newReset, newReset));
	}
	...
	public EList<FieldType> getField() {
		if (field == null) {
			field = new EObjectContainmentEList<FieldType>(FieldType.class, this, spiritPackage.ALTERNATE_REGISTER_TYPE__FIELD);
		}
		return field;
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ALTERNATE_REGISTER_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ALTERNATE_REGISTER_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ALTERNATE_REGISTER_TYPE__ALTERNATE_GROUPS:
				return basicSetAlternateGroups(null, msgs);
			case spiritPackage.ALTERNATE_REGISTER_TYPE__RESET:
				return basicSetReset(null, msgs);
			case spiritPackage.ALTERNATE_REGISTER_TYPE__FIELD:
				return ((InternalEList<?>)getField()).basicRemove(otherEnd, msgs);
			case spiritPackage.ALTERNATE_REGISTER_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.ALTERNATE_REGISTER_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ALTERNATE_REGISTER_TYPE__NAME:
				return getName();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__ALTERNATE_GROUPS:
				return getAlternateGroups();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__TYPE_IDENTIFIER:
				return getTypeIdentifier();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__VOLATILE:
				return isVolatile();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__ACCESS:
				return getAccess();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__RESET:
				return getReset();
			case spiritPackage.ALTERNATE_REGISTER_TYPE__FIELD:
			...
			case spiritPackage.ALTERNATE_REGISTER_TYPE__ID:
				return getId();
		}

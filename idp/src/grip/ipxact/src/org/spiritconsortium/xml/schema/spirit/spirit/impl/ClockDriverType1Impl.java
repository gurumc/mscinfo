...
public class ClockDriverType1Impl extends ClockDriverTypeImpl implements ClockDriverType1 {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getClockDriverType1();
	}
	...
	public void setClockName(String newClockName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE1__CLOCK_NAME, oldClockName, clockName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.CLOCK_DRIVER_TYPE1__CLOCK_NAME:
				return getClockName();
		}

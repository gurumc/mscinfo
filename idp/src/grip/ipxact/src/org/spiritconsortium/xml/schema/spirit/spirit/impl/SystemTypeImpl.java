 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.SystemTypeImpl#getGroup <em>Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemTypeImpl extends MinimalEObjectImpl.Container implements SystemType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getSystemType();
	}
	...
	public void setGroup(String newGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.SYSTEM_TYPE__GROUP, oldGroup, group));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.SYSTEM_TYPE__GROUP:
				return getGroup();
		}

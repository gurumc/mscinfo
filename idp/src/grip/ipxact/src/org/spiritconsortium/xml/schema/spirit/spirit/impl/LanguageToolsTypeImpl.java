...
public class LanguageToolsTypeImpl extends MinimalEObjectImpl.Container implements LanguageToolsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getLanguageToolsType();
	}
	...
	public EList<FileBuilderType1> getFileBuilder() {
		if (fileBuilder == null) {
			fileBuilder = new EObjectContainmentEList<FileBuilderType1>(FileBuilderType1.class, this, spiritPackage.LANGUAGE_TOOLS_TYPE__FILE_BUILDER);
		}
		return fileBuilder;
	}
	...
	public NotificationChain basicSetLinker(LinkerType newLinker, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER, oldLinker, newLinker);
	...
	public void setLinker(LinkerType newLinker) {
		if (newLinker != linker) {
			...
			if (linker != null)
				msgs = ((InternalEObject)linker).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER, null, msgs);
			if (newLinker != null)
				msgs = ((InternalEObject)newLinker).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER, null, msgs);
			msgs = basicSetLinker(newLinker, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER, newLinker, newLinker));
	}
	...
	public NotificationChain basicSetLinkerFlags(LinkerFlagsType newLinkerFlags, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_FLAGS, oldLinkerFlags, newLinkerFlags);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLinkerFlags(LinkerFlagsType newLinkerFlags) {
		if (newLinkerFlags != linkerFlags) {
			NotificationChain msgs = null;
			if (linkerFlags != null)
				msgs = ((InternalEObject)linkerFlags).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_FLAGS, null, msgs);
			if (newLinkerFlags != null)
				msgs = ((InternalEObject)newLinkerFlags).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_FLAGS, null, msgs);
			msgs = basicSetLinkerFlags(newLinkerFlags, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_FLAGS, newLinkerFlags, newLinkerFlags));
	}
	...
	public NotificationChain basicSetLinkerCommandFile(LinkerCommandFileType newLinkerCommandFile, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_COMMAND_FILE, oldLinkerCommandFile, newLinkerCommandFile);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLinkerCommandFile(LinkerCommandFileType newLinkerCommandFile) {
		if (newLinkerCommandFile != linkerCommandFile) {
			...
			if (linkerCommandFile != null)
				msgs = ((InternalEObject)linkerCommandFile).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_COMMAND_FILE, null, msgs);
			if (newLinkerCommandFile != null)
				msgs = ((InternalEObject)newLinkerCommandFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_COMMAND_FILE, null, msgs);
			msgs = basicSetLinkerCommandFile(newLinkerCommandFile, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_COMMAND_FILE, newLinkerCommandFile, newLinkerCommandFile));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.LANGUAGE_TOOLS_TYPE__FILE_BUILDER:
				return ((InternalEList<?>)getFileBuilder()).basicRemove(otherEnd, msgs);
			case spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER:
				return basicSetLinker(null, msgs);
			case spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_FLAGS:
				return basicSetLinkerFlags(null, msgs);
			case spiritPackage.LANGUAGE_TOOLS_TYPE__LINKER_COMMAND_FILE:

 ...
 * @generated
 */
public class BusDefinitionTypeImpl extends MinimalEObjectImpl.Container implements BusDefinitionType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getBusDefinitionType();
	}
	...
	public void setVendor(String newVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setLibrary(String newLibrary) {
		...
		library = newLibrary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setDirectConnection(boolean newDirectConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__DIRECT_CONNECTION, oldDirectConnection, directConnection, !oldDirectConnectionESet));
	}
	...
	public void unsetDirectConnection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.BUS_DEFINITION_TYPE__DIRECT_CONNECTION, oldDirectConnection, DIRECT_CONNECTION_EDEFAULT, oldDirectConnectionESet));
	}
	...
	public void setIsAddressable(boolean newIsAddressable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__IS_ADDRESSABLE, oldIsAddressable, isAddressable, !oldIsAddressableESet));
	}
	...
	public void unsetIsAddressable() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.BUS_DEFINITION_TYPE__IS_ADDRESSABLE, oldIsAddressable, IS_ADDRESSABLE_EDEFAULT, oldIsAddressableESet));
	}
	...
	public NotificationChain basicSetExtends(LibraryRefType newExtends, NotificationChain msgs) {
		...
		extends_ = newExtends;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__EXTENDS, oldExtends, newExtends);
	...
	public void setExtends(LibraryRefType newExtends) {
		if (newExtends != extends_) {
			...
			if (extends_ != null)
				msgs = ((InternalEObject)extends_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_DEFINITION_TYPE__EXTENDS, null, msgs);
			if (newExtends != null)
				msgs = ((InternalEObject)newExtends).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_DEFINITION_TYPE__EXTENDS, null, msgs);
			msgs = basicSetExtends(newExtends, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__EXTENDS, newExtends, newExtends));
	}
	...
	public void setMaxMasters(BigInteger newMaxMasters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__MAX_MASTERS, oldMaxMasters, maxMasters));
	}
	...
	public void setMaxSlaves(BigInteger newMaxSlaves) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__MAX_SLAVES, oldMaxSlaves, maxSlaves));
	}
	...
	public NotificationChain basicSetSystemGroupNames(SystemGroupNamesType newSystemGroupNames, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__SYSTEM_GROUP_NAMES, oldSystemGroupNames, newSystemGroupNames);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSystemGroupNames(SystemGroupNamesType newSystemGroupNames) {
		if (newSystemGroupNames != systemGroupNames) {
			...
			if (systemGroupNames != null)
				msgs = ((InternalEObject)systemGroupNames).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_DEFINITION_TYPE__SYSTEM_GROUP_NAMES, null, msgs);
			if (newSystemGroupNames != null)
				msgs = ((InternalEObject)newSystemGroupNames).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_DEFINITION_TYPE__SYSTEM_GROUP_NAMES, null, msgs);
			msgs = basicSetSystemGroupNames(newSystemGroupNames, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__SYSTEM_GROUP_NAMES, newSystemGroupNames, newSystemGroupNames));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_DEFINITION_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_DEFINITION_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_DEFINITION_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.BUS_DEFINITION_TYPE__EXTENDS:
				return basicSetExtends(null, msgs);
			case spiritPackage.BUS_DEFINITION_TYPE__SYSTEM_GROUP_NAMES:
				return basicSetSystemGroupNames(null, msgs);
			case spiritPackage.BUS_DEFINITION_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.BUS_DEFINITION_TYPE__VENDOR:
				return getVendor();
			case spiritPackage.BUS_DEFINITION_TYPE__LIBRARY:
				return getLibrary();
			case spiritPackage.BUS_DEFINITION_TYPE__NAME:
				return getName();
			case spiritPackage.BUS_DEFINITION_TYPE__VERSION:
				return getVersion();
			case spiritPackage.BUS_DEFINITION_TYPE__DIRECT_CONNECTION:
				return isDirectConnection();
			case spiritPackage.BUS_DEFINITION_TYPE__IS_ADDRESSABLE:
				return isIsAddressable();
			case spiritPackage.BUS_DEFINITION_TYPE__EXTENDS:
				return getExtends();
			case spiritPackage.BUS_DEFINITION_TYPE__MAX_MASTERS:
				return getMaxMasters();
			case spiritPackage.BUS_DEFINITION_TYPE__MAX_SLAVES:
				return getMaxSlaves();
			case spiritPackage.BUS_DEFINITION_TYPE__SYSTEM_GROUP_NAMES:
				return getSystemGroupNames();
			case spiritPackage.BUS_DEFINITION_TYPE__DESCRIPTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.BUS_DEFINITION_TYPE__VERSION:
				...
				return;
			case spiritPackage.BUS_DEFINITION_TYPE__DIRECT_CONNECTION:
				setDirectConnection((Boolean)newValue);
				return;
			case spiritPackage.BUS_DEFINITION_TYPE__IS_ADDRESSABLE:
				setIsAddressable((Boolean)newValue);
				return;
			case spiritPackage.BUS_DEFINITION_TYPE__EXTENDS:

 ...
 * @generated
 */
public class InterconnectionConfigurationTypeImpl extends MinimalEObjectImpl.Container implements InterconnectionConfigurationType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getInterconnectionConfigurationType();
	}
	...
	public void setInterconnectionRef(String newInterconnectionRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERCONNECTION_CONFIGURATION_TYPE__INTERCONNECTION_REF, oldInterconnectionRef, interconnectionRef));
	}
	...
	public NotificationChain basicSetAbstractors(AbstractorsType newAbstractors, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.INTERCONNECTION_CONFIGURATION_TYPE__ABSTRACTORS, oldAbstractors, newAbstractors);
	...
	public void setAbstractors(AbstractorsType newAbstractors) {
		if (newAbstractors != abstractors) {
			...
			if (abstractors != null)
				msgs = ((InternalEObject)abstractors).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.INTERCONNECTION_CONFIGURATION_TYPE__ABSTRACTORS, null, msgs);
			if (newAbstractors != null)
				msgs = ((InternalEObject)newAbstractors).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.INTERCONNECTION_CONFIGURATION_TYPE__ABSTRACTORS, null, msgs);
			msgs = basicSetAbstractors(newAbstractors, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERCONNECTION_CONFIGURATION_TYPE__ABSTRACTORS, newAbstractors, newAbstractors));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.INTERCONNECTION_CONFIGURATION_TYPE__ABSTRACTORS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.INTERCONNECTION_CONFIGURATION_TYPE__INTERCONNECTION_REF:

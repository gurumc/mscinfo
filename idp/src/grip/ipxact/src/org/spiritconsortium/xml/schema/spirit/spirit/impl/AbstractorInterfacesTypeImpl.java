...
public class AbstractorInterfacesTypeImpl extends MinimalEObjectImpl.Container implements AbstractorInterfacesType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractorInterfacesType();
	}
	...
	public EList<AbstractorBusInterfaceType> getAbstractorInterface() {
		if (abstractorInterface == null) {
			abstractorInterface = new EObjectContainmentEList<AbstractorBusInterfaceType>(AbstractorBusInterfaceType.class, this, spiritPackage.ABSTRACTOR_INTERFACES_TYPE__ABSTRACTOR_INTERFACE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_INTERFACES_TYPE__ABSTRACTOR_INTERFACE:

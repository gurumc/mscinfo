...
public class MemoryMapsTypeImpl extends MinimalEObjectImpl.Container implements MemoryMapsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getMemoryMapsType();
	}
	...
	public EList<MemoryMapType> getMemoryMap() {
		if (memoryMap == null) {
			memoryMap = new EObjectContainmentEList<MemoryMapType>(MemoryMapType.class, this, spiritPackage.MEMORY_MAPS_TYPE__MEMORY_MAP);
		}
		return memoryMap;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.MEMORY_MAPS_TYPE__MEMORY_MAP:

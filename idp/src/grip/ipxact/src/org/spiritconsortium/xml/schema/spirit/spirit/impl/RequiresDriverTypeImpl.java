...
public class RequiresDriverTypeImpl extends MinimalEObjectImpl.Container implements RequiresDriverType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getRequiresDriverType();
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REQUIRES_DRIVER_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.REQUIRES_DRIVER_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setDriverType(DriverTypeType newDriverType) {
		...
		driverTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REQUIRES_DRIVER_TYPE__DRIVER_TYPE, oldDriverType, driverType, !oldDriverTypeESet));
	}
	...
	public void unsetDriverType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.REQUIRES_DRIVER_TYPE__DRIVER_TYPE, oldDriverType, DRIVER_TYPE_EDEFAULT, oldDriverTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.REQUIRES_DRIVER_TYPE__VALUE:
				return isValue();
			case spiritPackage.REQUIRES_DRIVER_TYPE__DRIVER_TYPE:

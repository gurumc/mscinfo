 ...
 * @generated
 */
public class DesignConfigurationTypeImpl extends MinimalEObjectImpl.Container implements DesignConfigurationType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<GeneratorChainConfigurationType> generatorChainConfiguration;
	 ...
	 * @ordered
	 */
	protected EList<InterconnectionConfigurationType> interconnectionConfiguration;
	 ...
	 * @ordered
	 */
	protected EList<ViewConfigurationType> viewConfiguration;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getDesignConfigurationType();
	}
	...
	public void setVendor(String newVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setLibrary(String newLibrary) {
		...
		library = newLibrary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__VERSION, oldVersion, version));
	}
	...
	public NotificationChain basicSetDesignRef(LibraryRefType newDesignRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__DESIGN_REF, oldDesignRef, newDesignRef);
	...
	public void setDesignRef(LibraryRefType newDesignRef) {
		if (newDesignRef != designRef) {
			...
			if (designRef != null)
				msgs = ((InternalEObject)designRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_CONFIGURATION_TYPE__DESIGN_REF, null, msgs);
			if (newDesignRef != null)
				msgs = ((InternalEObject)newDesignRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_CONFIGURATION_TYPE__DESIGN_REF, null, msgs);
			msgs = basicSetDesignRef(newDesignRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__DESIGN_REF, newDesignRef, newDesignRef));
	}
	 ...
	 * @generated
	 */
	public EList<GeneratorChainConfigurationType> getGeneratorChainConfiguration() {
		if (generatorChainConfiguration == null) {
			generatorChainConfiguration = new EObjectContainmentEList<GeneratorChainConfigurationType>(GeneratorChainConfigurationType.class, this, spiritPackage.DESIGN_CONFIGURATION_TYPE__GENERATOR_CHAIN_CONFIGURATION);
		}
	 ...
	 * @generated
	 */
	public EList<InterconnectionConfigurationType> getInterconnectionConfiguration() {
		if (interconnectionConfiguration == null) {
			interconnectionConfiguration = new EObjectContainmentEList<InterconnectionConfigurationType>(InterconnectionConfigurationType.class, this, spiritPackage.DESIGN_CONFIGURATION_TYPE__INTERCONNECTION_CONFIGURATION);
		}
	 ...
	 * @generated
	 */
	public EList<ViewConfigurationType> getViewConfiguration() {
		if (viewConfiguration == null) {
			viewConfiguration = new EObjectContainmentEList<ViewConfigurationType>(ViewConfigurationType.class, this, spiritPackage.DESIGN_CONFIGURATION_TYPE__VIEW_CONFIGURATION);
		}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_CONFIGURATION_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.DESIGN_CONFIGURATION_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.DESIGN_CONFIGURATION_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__DESIGN_REF:
				return basicSetDesignRef(null, msgs);
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__GENERATOR_CHAIN_CONFIGURATION:
				return ((InternalEList<?>)getGeneratorChainConfiguration()).basicRemove(otherEnd, msgs);
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__INTERCONNECTION_CONFIGURATION:
				return ((InternalEList<?>)getInterconnectionConfiguration()).basicRemove(otherEnd, msgs);
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__VIEW_CONFIGURATION:
				return ((InternalEList<?>)getViewConfiguration()).basicRemove(otherEnd, msgs);
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__VENDOR:
				return getVendor();
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__LIBRARY:
				return getLibrary();
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__NAME:
				return getName();
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__VERSION:
				return getVersion();
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__DESIGN_REF:
				return getDesignRef();
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__GENERATOR_CHAIN_CONFIGURATION:
			...
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__DESCRIPTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__GENERATOR_CHAIN_CONFIGURATION:
				...
				getGeneratorChainConfiguration().addAll((Collection<? extends GeneratorChainConfigurationType>)newValue);
				return;
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__INTERCONNECTION_CONFIGURATION:
				getInterconnectionConfiguration().clear();
				getInterconnectionConfiguration().addAll((Collection<? extends InterconnectionConfigurationType>)newValue);
				return;
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__VIEW_CONFIGURATION:
				getViewConfiguration().clear();
				getViewConfiguration().addAll((Collection<? extends ViewConfigurationType>)newValue);
				return;
			case spiritPackage.DESIGN_CONFIGURATION_TYPE__DESCRIPTION:

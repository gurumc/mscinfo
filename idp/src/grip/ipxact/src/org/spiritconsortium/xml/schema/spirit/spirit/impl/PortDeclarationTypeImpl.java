 ...
 * @generated
 */
public class PortDeclarationTypeImpl extends MinimalEObjectImpl.Container implements PortDeclarationType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getPortDeclarationType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetWire(PortWireType newWire, NotificationChain msgs) {
		...
		wire = newWire;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__WIRE, oldWire, newWire);
	...
	public void setWire(PortWireType newWire) {
		if (newWire != wire) {
			...
			if (wire != null)
				msgs = ((InternalEObject)wire).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_DECLARATION_TYPE__WIRE, null, msgs);
			if (newWire != null)
				msgs = ((InternalEObject)newWire).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_DECLARATION_TYPE__WIRE, null, msgs);
			msgs = basicSetWire(newWire, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__WIRE, newWire, newWire));
	}
	...
	public NotificationChain basicSetTransactional(PortTransactionalType newTransactional, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__TRANSACTIONAL, oldTransactional, newTransactional);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTransactional(PortTransactionalType newTransactional) {
		if (newTransactional != transactional) {
			...
			if (transactional != null)
				msgs = ((InternalEObject)transactional).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_DECLARATION_TYPE__TRANSACTIONAL, null, msgs);
			if (newTransactional != null)
				msgs = ((InternalEObject)newTransactional).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_DECLARATION_TYPE__TRANSACTIONAL, null, msgs);
			msgs = basicSetTransactional(newTransactional, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__TRANSACTIONAL, newTransactional, newTransactional));
	}
	...
	public NotificationChain basicSetAccess(PortAccessType newAccess, NotificationChain msgs) {
		...
		access = newAccess;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__ACCESS, oldAccess, newAccess);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAccess(PortAccessType newAccess) {
		if (newAccess != access) {
			NotificationChain msgs = null;
			if (access != null)
				msgs = ((InternalEObject)access).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_DECLARATION_TYPE__ACCESS, null, msgs);
			if (newAccess != null)
				msgs = ((InternalEObject)newAccess).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_DECLARATION_TYPE__ACCESS, null, msgs);
			msgs = basicSetAccess(newAccess, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_DECLARATION_TYPE__ACCESS, newAccess, newAccess));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.PORT_DECLARATION_TYPE__WIRE:
				return basicSetWire(null, msgs);
			case spiritPackage.PORT_DECLARATION_TYPE__TRANSACTIONAL:
				return basicSetTransactional(null, msgs);
			case spiritPackage.PORT_DECLARATION_TYPE__ACCESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.PORT_DECLARATION_TYPE__NAME:
				return getName();
			case spiritPackage.PORT_DECLARATION_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.PORT_DECLARATION_TYPE__DESCRIPTION:

...
public class LogicalPortTypeImpl extends MinimalEObjectImpl.Container implements LogicalPortType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getLogicalPortType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOGICAL_PORT_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetVector(VectorType1 newVector, NotificationChain msgs) {
		...
		vector = newVector;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.LOGICAL_PORT_TYPE__VECTOR, oldVector, newVector);
	...
	public void setVector(VectorType1 newVector) {
		if (newVector != vector) {
			...
			if (vector != null)
				msgs = ((InternalEObject)vector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LOGICAL_PORT_TYPE__VECTOR, null, msgs);
			if (newVector != null)
				msgs = ((InternalEObject)newVector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LOGICAL_PORT_TYPE__VECTOR, null, msgs);
			msgs = basicSetVector(newVector, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOGICAL_PORT_TYPE__VECTOR, newVector, newVector));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.LOGICAL_PORT_TYPE__VECTOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.LOGICAL_PORT_TYPE__NAME:
				return getName();
			case spiritPackage.LOGICAL_PORT_TYPE__VECTOR:
				return getVector();
		}

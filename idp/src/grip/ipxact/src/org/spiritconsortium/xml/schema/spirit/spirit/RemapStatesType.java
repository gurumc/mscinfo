 ...
 * </p>
 *
 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getRemapStatesType()
...
public interface RemapStatesType extends EObject {
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getRemapStatesType_RemapState()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='remapState' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<RemapStateType> getRemapState();

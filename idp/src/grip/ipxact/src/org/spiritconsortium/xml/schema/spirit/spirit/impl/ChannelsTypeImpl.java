 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.ChannelsTypeImpl#getChannel <em>Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChannelsTypeImpl extends MinimalEObjectImpl.Container implements ChannelsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getChannelsType();
	}
	...
	public EList<ChannelType> getChannel() {
		if (channel == null) {
			channel = new EObjectContainmentEList<ChannelType>(ChannelType.class, this, spiritPackage.CHANNELS_TYPE__CHANNEL);
		}
		return channel;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CHANNELS_TYPE__CHANNEL:

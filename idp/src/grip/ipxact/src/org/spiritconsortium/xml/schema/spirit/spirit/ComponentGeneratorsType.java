 ...
 * </p>
 *
 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getComponentGeneratorsType()
...
public interface ComponentGeneratorsType extends EObject {
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getComponentGeneratorsType_ComponentGenerator()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='componentGenerator' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<ComponentGeneratorType> getComponentGenerator();

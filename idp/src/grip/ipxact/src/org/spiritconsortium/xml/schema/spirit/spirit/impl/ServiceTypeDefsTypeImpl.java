...
public class ServiceTypeDefsTypeImpl extends MinimalEObjectImpl.Container implements ServiceTypeDefsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getServiceTypeDefsType();
	}
	...
	public EList<ServiceTypeDefType> getServiceTypeDef() {
		if (serviceTypeDef == null) {
			serviceTypeDef = new EObjectContainmentEList<ServiceTypeDefType>(ServiceTypeDefType.class, this, spiritPackage.SERVICE_TYPE_DEFS_TYPE__SERVICE_TYPE_DEF);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.SERVICE_TYPE_DEFS_TYPE__SERVICE_TYPE_DEF:

...
public class ComponentTypeImpl extends MinimalEObjectImpl.Container implements ComponentType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getComponentType();
	}
	...
	public void setVendor(String newVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setLibrary(String newLibrary) {
		...
		library = newLibrary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__VERSION, oldVersion, version));
	}
	...
	public NotificationChain basicSetBusInterfaces(BusInterfacesType newBusInterfaces, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__BUS_INTERFACES, oldBusInterfaces, newBusInterfaces);
	...
	public void setBusInterfaces(BusInterfacesType newBusInterfaces) {
		if (newBusInterfaces != busInterfaces) {
			...
			if (busInterfaces != null)
				msgs = ((InternalEObject)busInterfaces).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__BUS_INTERFACES, null, msgs);
			if (newBusInterfaces != null)
				msgs = ((InternalEObject)newBusInterfaces).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__BUS_INTERFACES, null, msgs);
			msgs = basicSetBusInterfaces(newBusInterfaces, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__BUS_INTERFACES, newBusInterfaces, newBusInterfaces));
	}
	...
	public NotificationChain basicSetChannels(ChannelsType newChannels, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__CHANNELS, oldChannels, newChannels);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setChannels(ChannelsType newChannels) {
		if (newChannels != channels) {
			NotificationChain msgs = null;
			if (channels != null)
				msgs = ((InternalEObject)channels).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__CHANNELS, null, msgs);
			if (newChannels != null)
				msgs = ((InternalEObject)newChannels).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__CHANNELS, null, msgs);
			msgs = basicSetChannels(newChannels, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__CHANNELS, newChannels, newChannels));
	}
	...
	public NotificationChain basicSetRemapStates(RemapStatesType newRemapStates, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__REMAP_STATES, oldRemapStates, newRemapStates);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRemapStates(RemapStatesType newRemapStates) {
		if (newRemapStates != remapStates) {
			NotificationChain msgs = null;
			if (remapStates != null)
				msgs = ((InternalEObject)remapStates).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__REMAP_STATES, null, msgs);
			if (newRemapStates != null)
				msgs = ((InternalEObject)newRemapStates).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__REMAP_STATES, null, msgs);
			msgs = basicSetRemapStates(newRemapStates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__REMAP_STATES, newRemapStates, newRemapStates));
	}
	...
	public NotificationChain basicSetAddressSpaces(AddressSpacesType newAddressSpaces, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__ADDRESS_SPACES, oldAddressSpaces, newAddressSpaces);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAddressSpaces(AddressSpacesType newAddressSpaces) {
		if (newAddressSpaces != addressSpaces) {
			...
			if (addressSpaces != null)
				msgs = ((InternalEObject)addressSpaces).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__ADDRESS_SPACES, null, msgs);
			if (newAddressSpaces != null)
				msgs = ((InternalEObject)newAddressSpaces).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__ADDRESS_SPACES, null, msgs);
			msgs = basicSetAddressSpaces(newAddressSpaces, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__ADDRESS_SPACES, newAddressSpaces, newAddressSpaces));
	}
	...
	public NotificationChain basicSetMemoryMaps(MemoryMapsType newMemoryMaps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__MEMORY_MAPS, oldMemoryMaps, newMemoryMaps);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMemoryMaps(MemoryMapsType newMemoryMaps) {
		if (newMemoryMaps != memoryMaps) {
			NotificationChain msgs = null;
			if (memoryMaps != null)
				msgs = ((InternalEObject)memoryMaps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__MEMORY_MAPS, null, msgs);
			if (newMemoryMaps != null)
				msgs = ((InternalEObject)newMemoryMaps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__MEMORY_MAPS, null, msgs);
			msgs = basicSetMemoryMaps(newMemoryMaps, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__MEMORY_MAPS, newMemoryMaps, newMemoryMaps));
	}
	...
	public NotificationChain basicSetModel(ModelType newModel, NotificationChain msgs) {
		...
		model = newModel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__MODEL, oldModel, newModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setModel(ModelType newModel) {
		if (newModel != model) {
			NotificationChain msgs = null;
			if (model != null)
				msgs = ((InternalEObject)model).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__MODEL, null, msgs);
			if (newModel != null)
				msgs = ((InternalEObject)newModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__MODEL, null, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__MODEL, newModel, newModel));
	}
	...
	public NotificationChain basicSetComponentGenerators(ComponentGeneratorsType newComponentGenerators, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__COMPONENT_GENERATORS, oldComponentGenerators, newComponentGenerators);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setComponentGenerators(ComponentGeneratorsType newComponentGenerators) {
		if (newComponentGenerators != componentGenerators) {
			...
			if (componentGenerators != null)
				msgs = ((InternalEObject)componentGenerators).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__COMPONENT_GENERATORS, null, msgs);
			if (newComponentGenerators != null)
				msgs = ((InternalEObject)newComponentGenerators).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__COMPONENT_GENERATORS, null, msgs);
			msgs = basicSetComponentGenerators(newComponentGenerators, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__COMPONENT_GENERATORS, newComponentGenerators, newComponentGenerators));
	}
	...
	public NotificationChain basicSetChoices(ChoicesType newChoices, NotificationChain msgs) {
		...
		choices = newChoices;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__CHOICES, oldChoices, newChoices);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setChoices(ChoicesType newChoices) {
		if (newChoices != choices) {
			NotificationChain msgs = null;
			if (choices != null)
				msgs = ((InternalEObject)choices).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__CHOICES, null, msgs);
			if (newChoices != null)
				msgs = ((InternalEObject)newChoices).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__CHOICES, null, msgs);
			msgs = basicSetChoices(newChoices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__CHOICES, newChoices, newChoices));
	}
	...
	public NotificationChain basicSetFileSets(FileSetsType newFileSets, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__FILE_SETS, oldFileSets, newFileSets);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFileSets(FileSetsType newFileSets) {
		if (newFileSets != fileSets) {
			NotificationChain msgs = null;
			if (fileSets != null)
				msgs = ((InternalEObject)fileSets).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__FILE_SETS, null, msgs);
			if (newFileSets != null)
				msgs = ((InternalEObject)newFileSets).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__FILE_SETS, null, msgs);
			msgs = basicSetFileSets(newFileSets, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__FILE_SETS, newFileSets, newFileSets));
	}
	...
	public NotificationChain basicSetWhiteboxElements(WhiteboxElementsType newWhiteboxElements, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__WHITEBOX_ELEMENTS, oldWhiteboxElements, newWhiteboxElements);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWhiteboxElements(WhiteboxElementsType newWhiteboxElements) {
		if (newWhiteboxElements != whiteboxElements) {
			...
			if (whiteboxElements != null)
				msgs = ((InternalEObject)whiteboxElements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__WHITEBOX_ELEMENTS, null, msgs);
			if (newWhiteboxElements != null)
				msgs = ((InternalEObject)newWhiteboxElements).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__WHITEBOX_ELEMENTS, null, msgs);
			msgs = basicSetWhiteboxElements(newWhiteboxElements, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__WHITEBOX_ELEMENTS, newWhiteboxElements, newWhiteboxElements));
	}
	...
	public NotificationChain basicSetCpus(CpusType newCpus, NotificationChain msgs) {
		...
		cpus = newCpus;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__CPUS, oldCpus, newCpus);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCpus(CpusType newCpus) {
		if (newCpus != cpus) {
			NotificationChain msgs = null;
			if (cpus != null)
				msgs = ((InternalEObject)cpus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__CPUS, null, msgs);
			if (newCpus != null)
				msgs = ((InternalEObject)newCpus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__CPUS, null, msgs);
			msgs = basicSetCpus(newCpus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__CPUS, newCpus, newCpus));
	}
	...
	public NotificationChain basicSetOtherClockDrivers(OtherClocks newOtherClockDrivers, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__OTHER_CLOCK_DRIVERS, oldOtherClockDrivers, newOtherClockDrivers);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOtherClockDrivers(OtherClocks newOtherClockDrivers) {
		if (newOtherClockDrivers != otherClockDrivers) {
			...
			if (otherClockDrivers != null)
				msgs = ((InternalEObject)otherClockDrivers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__OTHER_CLOCK_DRIVERS, null, msgs);
			if (newOtherClockDrivers != null)
				msgs = ((InternalEObject)newOtherClockDrivers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__OTHER_CLOCK_DRIVERS, null, msgs);
			msgs = basicSetOtherClockDrivers(newOtherClockDrivers, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__OTHER_CLOCK_DRIVERS, newOtherClockDrivers, newOtherClockDrivers));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.COMPONENT_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.COMPONENT_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.COMPONENT_TYPE__BUS_INTERFACES:
				return basicSetBusInterfaces(null, msgs);
			case spiritPackage.COMPONENT_TYPE__CHANNELS:
				return basicSetChannels(null, msgs);
			case spiritPackage.COMPONENT_TYPE__REMAP_STATES:
				return basicSetRemapStates(null, msgs);
			case spiritPackage.COMPONENT_TYPE__ADDRESS_SPACES:
				return basicSetAddressSpaces(null, msgs);
			case spiritPackage.COMPONENT_TYPE__MEMORY_MAPS:
				return basicSetMemoryMaps(null, msgs);
			case spiritPackage.COMPONENT_TYPE__MODEL:
				return basicSetModel(null, msgs);
			case spiritPackage.COMPONENT_TYPE__COMPONENT_GENERATORS:
				return basicSetComponentGenerators(null, msgs);
			case spiritPackage.COMPONENT_TYPE__CHOICES:
				return basicSetChoices(null, msgs);
			case spiritPackage.COMPONENT_TYPE__FILE_SETS:
				return basicSetFileSets(null, msgs);
			case spiritPackage.COMPONENT_TYPE__WHITEBOX_ELEMENTS:
				return basicSetWhiteboxElements(null, msgs);
			case spiritPackage.COMPONENT_TYPE__CPUS:
				return basicSetCpus(null, msgs);
			case spiritPackage.COMPONENT_TYPE__OTHER_CLOCK_DRIVERS:
				return basicSetOtherClockDrivers(null, msgs);
			case spiritPackage.COMPONENT_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.COMPONENT_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.COMPONENT_TYPE__VENDOR:
				return getVendor();
			case spiritPackage.COMPONENT_TYPE__LIBRARY:
				return getLibrary();
			case spiritPackage.COMPONENT_TYPE__NAME:
				return getName();
			case spiritPackage.COMPONENT_TYPE__VERSION:
				return getVersion();
			case spiritPackage.COMPONENT_TYPE__BUS_INTERFACES:
			...
			case spiritPackage.COMPONENT_TYPE__DESCRIPTION:

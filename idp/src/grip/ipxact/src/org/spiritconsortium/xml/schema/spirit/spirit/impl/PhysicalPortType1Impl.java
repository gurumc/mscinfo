...
public class PhysicalPortType1Impl extends MinimalEObjectImpl.Container implements PhysicalPortType1 {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getPhysicalPortType1();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PHYSICAL_PORT_TYPE1__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetVector(VectorType2 newVector, NotificationChain msgs) {
		...
		vector = newVector;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PHYSICAL_PORT_TYPE1__VECTOR, oldVector, newVector);
	...
	public void setVector(VectorType2 newVector) {
		if (newVector != vector) {
			...
			if (vector != null)
				msgs = ((InternalEObject)vector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PHYSICAL_PORT_TYPE1__VECTOR, null, msgs);
			if (newVector != null)
				msgs = ((InternalEObject)newVector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PHYSICAL_PORT_TYPE1__VECTOR, null, msgs);
			msgs = basicSetVector(newVector, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PHYSICAL_PORT_TYPE1__VECTOR, newVector, newVector));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.PHYSICAL_PORT_TYPE1__VECTOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.PHYSICAL_PORT_TYPE1__NAME:
				return getName();
			case spiritPackage.PHYSICAL_PORT_TYPE1__VECTOR:
				return getVector();
		}

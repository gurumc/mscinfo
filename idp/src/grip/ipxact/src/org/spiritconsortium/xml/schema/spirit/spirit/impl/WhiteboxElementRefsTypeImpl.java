...
public class WhiteboxElementRefsTypeImpl extends MinimalEObjectImpl.Container implements WhiteboxElementRefsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getWhiteboxElementRefsType();
	}
	...
	public EList<WhiteboxElementRefType> getWhiteboxElementRef() {
		if (whiteboxElementRef == null) {
			whiteboxElementRef = new EObjectContainmentEList<WhiteboxElementRefType>(WhiteboxElementRefType.class, this, spiritPackage.WHITEBOX_ELEMENT_REFS_TYPE__WHITEBOX_ELEMENT_REF);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.WHITEBOX_ELEMENT_REFS_TYPE__WHITEBOX_ELEMENT_REF:

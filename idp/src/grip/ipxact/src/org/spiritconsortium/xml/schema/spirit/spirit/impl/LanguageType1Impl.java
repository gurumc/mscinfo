...
public class LanguageType1Impl extends MinimalEObjectImpl.Container implements LanguageType1 {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getLanguageType1();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TYPE1__VALUE, oldValue, value));
	}
	...
	public void setStrict(boolean newStrict) {
		...
		strictESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LANGUAGE_TYPE1__STRICT, oldStrict, strict, !oldStrictESet));
	}
	...
	public void unsetStrict() {
		...
		strictESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.LANGUAGE_TYPE1__STRICT, oldStrict, STRICT_EDEFAULT, oldStrictESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.LANGUAGE_TYPE1__VALUE:
				return getValue();
			case spiritPackage.LANGUAGE_TYPE1__STRICT:
				return isStrict();
		}

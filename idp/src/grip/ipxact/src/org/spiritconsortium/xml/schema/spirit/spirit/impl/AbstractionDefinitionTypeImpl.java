 ...
 * @generated
 */
public class AbstractionDefinitionTypeImpl extends MinimalEObjectImpl.Container implements AbstractionDefinitionType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractionDefinitionType();
	}
	...
	public void setVendor(String newVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setLibrary(String newLibrary) {
		...
		library = newLibrary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__VERSION, oldVersion, version));
	}
	...
	public NotificationChain basicSetBusType(LibraryRefType newBusType, NotificationChain msgs) {
		...
		busType = newBusType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__BUS_TYPE, oldBusType, newBusType);
	...
	public void setBusType(LibraryRefType newBusType) {
		if (newBusType != busType) {
			...
			if (busType != null)
				msgs = ((InternalEObject)busType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__BUS_TYPE, null, msgs);
			if (newBusType != null)
				msgs = ((InternalEObject)newBusType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__BUS_TYPE, null, msgs);
			msgs = basicSetBusType(newBusType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__BUS_TYPE, newBusType, newBusType));
	}
	...
	public NotificationChain basicSetExtends(LibraryRefType newExtends, NotificationChain msgs) {
		...
		extends_ = newExtends;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__EXTENDS, oldExtends, newExtends);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExtends(LibraryRefType newExtends) {
		if (newExtends != extends_) {
			NotificationChain msgs = null;
			if (extends_ != null)
				msgs = ((InternalEObject)extends_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__EXTENDS, null, msgs);
			if (newExtends != null)
				msgs = ((InternalEObject)newExtends).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__EXTENDS, null, msgs);
			msgs = basicSetExtends(newExtends, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__EXTENDS, newExtends, newExtends));
	}
	...
	public NotificationChain basicSetPorts(PortsType newPorts, NotificationChain msgs) {
		...
		ports = newPorts;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__PORTS, oldPorts, newPorts);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPorts(PortsType newPorts) {
		if (newPorts != ports) {
			NotificationChain msgs = null;
			if (ports != null)
				msgs = ((InternalEObject)ports).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__PORTS, null, msgs);
			if (newPorts != null)
				msgs = ((InternalEObject)newPorts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__PORTS, null, msgs);
			msgs = basicSetPorts(newPorts, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__PORTS, newPorts, newPorts));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTION_DEFINITION_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTION_DEFINITION_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__BUS_TYPE:
				return basicSetBusType(null, msgs);
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__EXTENDS:
				return basicSetExtends(null, msgs);
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__PORTS:
				return basicSetPorts(null, msgs);
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__VENDOR:
				return getVendor();
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__LIBRARY:
				return getLibrary();
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__NAME:
				return getName();
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__VERSION:
				return getVersion();
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__BUS_TYPE:
				return getBusType();
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__EXTENDS:
			...
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__PORTS:
				return getPorts();
			case spiritPackage.ABSTRACTION_DEFINITION_TYPE__DESCRIPTION:

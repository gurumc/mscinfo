 ...
 * @generated
 */
public class EnumeratedValueTypeImpl extends MinimalEObjectImpl.Container implements EnumeratedValueType {
	/**
	 ...
	 * @ordered
	 */
	protected static final UsageType USAGE_EDEFAULT = UsageType.READ_WRITE;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getEnumeratedValueType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ENUMERATED_VALUE_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ENUMERATED_VALUE_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ENUMERATED_VALUE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ENUMERATED_VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ENUMERATED_VALUE_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ENUMERATED_VALUE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ENUMERATED_VALUE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ENUMERATED_VALUE_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setUsage(UsageType newUsage) {
		...
		usageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ENUMERATED_VALUE_TYPE__USAGE, oldUsage, usage, !oldUsageESet));
	}
	...
	public void unsetUsage() {
		...
		usageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ENUMERATED_VALUE_TYPE__USAGE, oldUsage, USAGE_EDEFAULT, oldUsageESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ENUMERATED_VALUE_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ENUMERATED_VALUE_TYPE__NAME:
				return getName();
			case spiritPackage.ENUMERATED_VALUE_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.ENUMERATED_VALUE_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.ENUMERATED_VALUE_TYPE__VALUE:
				return getValue();
			case spiritPackage.ENUMERATED_VALUE_TYPE__VENDOR_EXTENSIONS:
				return getVendorExtensions();
			case spiritPackage.ENUMERATED_VALUE_TYPE__USAGE:
				return getUsage();
		}

...
public class RemapPortTypeImpl extends MinimalEObjectImpl.Container implements RemapPortType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getRemapPortType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_PORT_TYPE__VALUE, oldValue, value));
	}
	...
	public void setPortIndex(BigInteger newPortIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_PORT_TYPE__PORT_INDEX, oldPortIndex, portIndex));
	}
	...
	public void setPortNameRef(String newPortNameRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_PORT_TYPE__PORT_NAME_REF, oldPortNameRef, portNameRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.REMAP_PORT_TYPE__VALUE:
				return getValue();
			case spiritPackage.REMAP_PORT_TYPE__PORT_INDEX:
				return getPortIndex();
			case spiritPackage.REMAP_PORT_TYPE__PORT_NAME_REF:

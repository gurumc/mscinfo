...
public class FunctionTypeImpl extends MinimalEObjectImpl.Container implements FunctionType {
	 ...
	 * @ordered
	 */
	protected static final ReturnTypeType RETURN_TYPE_EDEFAULT = ReturnTypeType.VOID;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFunctionType();
	}
	...
	public void setEntryPoint(String newEntryPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FUNCTION_TYPE__ENTRY_POINT, oldEntryPoint, entryPoint));
	}
	...
	public void setFileRef(String newFileRef) {
		...
		fileRef = newFileRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FUNCTION_TYPE__FILE_REF, oldFileRef, fileRef));
	}
	...
	public void setReturnType(ReturnTypeType newReturnType) {
		...
		returnTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FUNCTION_TYPE__RETURN_TYPE, oldReturnType, returnType, !oldReturnTypeESet));
	}
	...
	public void unsetReturnType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.FUNCTION_TYPE__RETURN_TYPE, oldReturnType, RETURN_TYPE_EDEFAULT, oldReturnTypeESet));
	}
	...
	public EList<ArgumentType> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<ArgumentType>(ArgumentType.class, this, spiritPackage.FUNCTION_TYPE__ARGUMENT);
		}
		return argument;
	}
	...
	public NotificationChain basicSetDisabled(DisabledType newDisabled, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FUNCTION_TYPE__DISABLED, oldDisabled, newDisabled);
	...
	public void setDisabled(DisabledType newDisabled) {
		if (newDisabled != disabled) {
			...
			if (disabled != null)
				msgs = ((InternalEObject)disabled).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FUNCTION_TYPE__DISABLED, null, msgs);
			if (newDisabled != null)
				msgs = ((InternalEObject)newDisabled).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FUNCTION_TYPE__DISABLED, null, msgs);
			msgs = basicSetDisabled(newDisabled, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FUNCTION_TYPE__DISABLED, newDisabled, newDisabled));
	}
	...
	public EList<SourceFileType> getSourceFile() {
		if (sourceFile == null) {
			sourceFile = new EObjectContainmentEList<SourceFileType>(SourceFileType.class, this, spiritPackage.FUNCTION_TYPE__SOURCE_FILE);
		}
		return sourceFile;
	}
	...
	public void setReplicate(boolean newReplicate) {
		...
		replicateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FUNCTION_TYPE__REPLICATE, oldReplicate, replicate, !oldReplicateESet));
	}
	...
	public void unsetReplicate() {
		...
		replicateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.FUNCTION_TYPE__REPLICATE, oldReplicate, REPLICATE_EDEFAULT, oldReplicateESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.FUNCTION_TYPE__ARGUMENT:
				return ((InternalEList<?>)getArgument()).basicRemove(otherEnd, msgs);
			case spiritPackage.FUNCTION_TYPE__DISABLED:
				return basicSetDisabled(null, msgs);
			case spiritPackage.FUNCTION_TYPE__SOURCE_FILE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.FUNCTION_TYPE__ENTRY_POINT:
				return getEntryPoint();
			case spiritPackage.FUNCTION_TYPE__FILE_REF:
				return getFileRef();
			case spiritPackage.FUNCTION_TYPE__RETURN_TYPE:
			...
			case spiritPackage.FUNCTION_TYPE__REPLICATE:
				return isReplicate();
		}

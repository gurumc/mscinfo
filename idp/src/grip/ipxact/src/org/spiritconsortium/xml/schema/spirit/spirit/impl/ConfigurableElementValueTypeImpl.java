 ...
 * @generated
 */
public class ConfigurableElementValueTypeImpl extends MinimalEObjectImpl.Container implements ConfigurableElementValueType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getConfigurableElementValueType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONFIGURABLE_ELEMENT_VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setReferenceId(String newReferenceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CONFIGURABLE_ELEMENT_VALUE_TYPE__REFERENCE_ID, oldReferenceId, referenceId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.CONFIGURABLE_ELEMENT_VALUE_TYPE__VALUE:
				return getValue();
			case spiritPackage.CONFIGURABLE_ELEMENT_VALUE_TYPE__REFERENCE_ID:

 ...
 * @generated
 */
public class AbstractorBusInterfaceTypeImpl extends MinimalEObjectImpl.Container implements AbstractorBusInterfaceType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractorBusInterfaceType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetAbstractionType(LibraryRefType newAbstractionType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, oldAbstractionType, newAbstractionType);
	...
	public void setAbstractionType(LibraryRefType newAbstractionType) {
		if (newAbstractionType != abstractionType) {
			...
			if (abstractionType != null)
				msgs = ((InternalEObject)abstractionType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, null, msgs);
			if (newAbstractionType != null)
				msgs = ((InternalEObject)newAbstractionType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, null, msgs);
			msgs = basicSetAbstractionType(newAbstractionType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, newAbstractionType, newAbstractionType));
	}
	...
	public NotificationChain basicSetPortMaps(PortMapsType1 newPortMaps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PORT_MAPS, oldPortMaps, newPortMaps);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPortMaps(PortMapsType1 newPortMaps) {
		if (newPortMaps != portMaps) {
			NotificationChain msgs = null;
			if (portMaps != null)
				msgs = ((InternalEObject)portMaps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PORT_MAPS, null, msgs);
			if (newPortMaps != null)
				msgs = ((InternalEObject)newPortMaps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PORT_MAPS, null, msgs);
			msgs = basicSetPortMaps(newPortMaps, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PORT_MAPS, newPortMaps, newPortMaps));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__ABSTRACTION_TYPE:
				return basicSetAbstractionType(null, msgs);
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PORT_MAPS:
				return basicSetPortMaps(null, msgs);
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS:
				return basicSetVendorExtensions(null, msgs);
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__NAME:
				return getName();
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.ABSTRACTOR_BUS_INTERFACE_TYPE__DESCRIPTION:

 ...
 * @generated
 */
public class CellFunctionTypeImpl extends MinimalEObjectImpl.Container implements CellFunctionType {
	/**
	 ...
	 * @ordered
	 */
	protected static final CellFunctionValueType VALUE_EDEFAULT = CellFunctionValueType.NAND2;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getCellFunctionType();
	}
	...
	public void setValue(CellFunctionValueType newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CELL_FUNCTION_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.CELL_FUNCTION_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setCellStrength(CellStrengthValueType newCellStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CELL_FUNCTION_TYPE__CELL_STRENGTH, oldCellStrength, cellStrength, !oldCellStrengthESet));
	}
	...
	public void unsetCellStrength() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.CELL_FUNCTION_TYPE__CELL_STRENGTH, oldCellStrength, CELL_STRENGTH_EDEFAULT, oldCellStrengthESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.CELL_FUNCTION_TYPE__VALUE:
				return getValue();
			case spiritPackage.CELL_FUNCTION_TYPE__CELL_STRENGTH:

...
public class ModelParametersTypeImpl extends MinimalEObjectImpl.Container implements ModelParametersType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getModelParametersType();
	}
	...
	public EList<NameValueTypeType> getModelParameter() {
		if (modelParameter == null) {
			modelParameter = new EObjectContainmentEList<NameValueTypeType>(NameValueTypeType.class, this, spiritPackage.MODEL_PARAMETERS_TYPE__MODEL_PARAMETER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.MODEL_PARAMETERS_TYPE__MODEL_PARAMETER:

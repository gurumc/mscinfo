 ...
 * @generated
 */
public class LocalMemoryMapTypeImpl extends MinimalEObjectImpl.Container implements LocalMemoryMapType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getLocalMemoryMapType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOCAL_MEMORY_MAP_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOCAL_MEMORY_MAP_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOCAL_MEMORY_MAP_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public FeatureMap getMemoryMap() {
		if (memoryMap == null) {
			memoryMap = new BasicFeatureMap(this, spiritPackage.LOCAL_MEMORY_MAP_TYPE__MEMORY_MAP);
		}
		return memoryMap;
	}
	...
	public EList<AddressBlockType> getAddressBlock() {
		return getMemoryMap().list(spiritPackage.eINSTANCE.getLocalMemoryMapType_AddressBlock());
	}
	...
	public EList<AddressBankType> getBank() {
		return getMemoryMap().list(spiritPackage.eINSTANCE.getLocalMemoryMapType_Bank());
	}
	...
	public EList<SubspaceRefType> getSubspaceMap() {
		return getMemoryMap().list(spiritPackage.eINSTANCE.getLocalMemoryMapType_SubspaceMap());
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOCAL_MEMORY_MAP_TYPE__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__MEMORY_MAP:
				return ((InternalEList<?>)getMemoryMap()).basicRemove(otherEnd, msgs);
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__ADDRESS_BLOCK:
				return ((InternalEList<?>)getAddressBlock()).basicRemove(otherEnd, msgs);
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__BANK:
				return ((InternalEList<?>)getBank()).basicRemove(otherEnd, msgs);
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__SUBSPACE_MAP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__NAME:
				return getName();
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__DESCRIPTION:
			...
			case spiritPackage.LOCAL_MEMORY_MAP_TYPE__ID:
				return getId();
		}

 ...
 * @generated
 */
public class WriteValueConstraintTypeImpl extends MinimalEObjectImpl.Container implements WriteValueConstraintType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getWriteValueConstraintType();
	}
	...
	public void setWriteAsRead(boolean newWriteAsRead) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__WRITE_AS_READ, oldWriteAsRead, writeAsRead, !oldWriteAsReadESet));
	}
	...
	public void unsetWriteAsRead() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__WRITE_AS_READ, oldWriteAsRead, WRITE_AS_READ_EDEFAULT, oldWriteAsReadESet));
	}
	...
	public void setUseEnumeratedValues(boolean newUseEnumeratedValues) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__USE_ENUMERATED_VALUES, oldUseEnumeratedValues, useEnumeratedValues, !oldUseEnumeratedValuesESet));
	}
	...
	public void unsetUseEnumeratedValues() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__USE_ENUMERATED_VALUES, oldUseEnumeratedValues, USE_ENUMERATED_VALUES_EDEFAULT, oldUseEnumeratedValuesESet));
	}
	...
	public NotificationChain basicSetMinimum(MinimumType newMinimum, NotificationChain msgs) {
		...
		minimum = newMinimum;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MINIMUM, oldMinimum, newMinimum);
	...
	public void setMinimum(MinimumType newMinimum) {
		if (newMinimum != minimum) {
			...
			if (minimum != null)
				msgs = ((InternalEObject)minimum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MINIMUM, null, msgs);
			if (newMinimum != null)
				msgs = ((InternalEObject)newMinimum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MINIMUM, null, msgs);
			msgs = basicSetMinimum(newMinimum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MINIMUM, newMinimum, newMinimum));
	}
	...
	public NotificationChain basicSetMaximum(MaximumType newMaximum, NotificationChain msgs) {
		...
		maximum = newMaximum;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MAXIMUM, oldMaximum, newMaximum);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaximum(MaximumType newMaximum) {
		if (newMaximum != maximum) {
			NotificationChain msgs = null;
			if (maximum != null)
				msgs = ((InternalEObject)maximum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MAXIMUM, null, msgs);
			if (newMaximum != null)
				msgs = ((InternalEObject)newMaximum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MAXIMUM, null, msgs);
			msgs = basicSetMaximum(newMaximum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MAXIMUM, newMaximum, newMaximum));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MINIMUM:
				return basicSetMinimum(null, msgs);
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MAXIMUM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__WRITE_AS_READ:
				return isWriteAsRead();
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__USE_ENUMERATED_VALUES:
				return isUseEnumeratedValues();
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MINIMUM:
				return getMinimum();
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MAXIMUM:
				return getMaximum();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__WRITE_AS_READ:
				setWriteAsRead((Boolean)newValue);
				return;
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__USE_ENUMERATED_VALUES:
				setUseEnumeratedValues((Boolean)newValue);
				return;
			case spiritPackage.WRITE_VALUE_CONSTRAINT_TYPE__MINIMUM:

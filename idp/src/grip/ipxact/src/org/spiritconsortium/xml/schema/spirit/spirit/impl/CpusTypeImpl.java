 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.CpusTypeImpl#getCpu <em>Cpu</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CpusTypeImpl extends MinimalEObjectImpl.Container implements CpusType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getCpusType();
	}
	...
	public EList<CpuType> getCpu() {
		if (cpu == null) {
			cpu = new EObjectContainmentEList<CpuType>(CpuType.class, this, spiritPackage.CPUS_TYPE__CPU);
		}
		return cpu;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CPUS_TYPE__CPU:

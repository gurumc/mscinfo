...
public class SourceFileTypeImpl extends MinimalEObjectImpl.Container implements SourceFileType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getSourceFileType();
	}
	...
	public NotificationChain basicSetSourceName(SourceNameType newSourceName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.SOURCE_FILE_TYPE__SOURCE_NAME, oldSourceName, newSourceName);
	...
	public void setSourceName(SourceNameType newSourceName) {
		if (newSourceName != sourceName) {
			...
			if (sourceName != null)
				msgs = ((InternalEObject)sourceName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.SOURCE_FILE_TYPE__SOURCE_NAME, null, msgs);
			if (newSourceName != null)
				msgs = ((InternalEObject)newSourceName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.SOURCE_FILE_TYPE__SOURCE_NAME, null, msgs);
			msgs = basicSetSourceName(newSourceName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.SOURCE_FILE_TYPE__SOURCE_NAME, newSourceName, newSourceName));
	}
	...
	public void setFileType(FileTypeType newFileType) {
		...
		fileTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.SOURCE_FILE_TYPE__FILE_TYPE, oldFileType, fileType, !oldFileTypeESet));
	}
	...
	public void unsetFileType() {
		...
		fileTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.SOURCE_FILE_TYPE__FILE_TYPE, oldFileType, FILE_TYPE_EDEFAULT, oldFileTypeESet));
	}
	...
	public void setUserFileType(String newUserFileType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.SOURCE_FILE_TYPE__USER_FILE_TYPE, oldUserFileType, userFileType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.SOURCE_FILE_TYPE__SOURCE_NAME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case spiritPackage.SOURCE_FILE_TYPE__FILE_TYPE:
				return getFileType();
			case spiritPackage.SOURCE_FILE_TYPE__USER_FILE_TYPE:

...
public class RemapStateTypeImpl extends MinimalEObjectImpl.Container implements RemapStateType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getRemapStateType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_STATE_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_STATE_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_STATE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetRemapPorts(RemapPortsType newRemapPorts, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_STATE_TYPE__REMAP_PORTS, oldRemapPorts, newRemapPorts);
	...
	public void setRemapPorts(RemapPortsType newRemapPorts) {
		if (newRemapPorts != remapPorts) {
			...
			if (remapPorts != null)
				msgs = ((InternalEObject)remapPorts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REMAP_STATE_TYPE__REMAP_PORTS, null, msgs);
			if (newRemapPorts != null)
				msgs = ((InternalEObject)newRemapPorts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.REMAP_STATE_TYPE__REMAP_PORTS, null, msgs);
			msgs = basicSetRemapPorts(newRemapPorts, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.REMAP_STATE_TYPE__REMAP_PORTS, newRemapPorts, newRemapPorts));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.REMAP_STATE_TYPE__REMAP_PORTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.REMAP_STATE_TYPE__NAME:
				return getName();
			case spiritPackage.REMAP_STATE_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.REMAP_STATE_TYPE__DESCRIPTION:

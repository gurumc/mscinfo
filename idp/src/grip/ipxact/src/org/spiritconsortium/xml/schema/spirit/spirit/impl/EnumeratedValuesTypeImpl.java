...
public class EnumeratedValuesTypeImpl extends MinimalEObjectImpl.Container implements EnumeratedValuesType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getEnumeratedValuesType();
	}
	...
	public EList<EnumeratedValueType> getEnumeratedValue() {
		if (enumeratedValue == null) {
			enumeratedValue = new EObjectContainmentEList<EnumeratedValueType>(EnumeratedValueType.class, this, spiritPackage.ENUMERATED_VALUES_TYPE__ENUMERATED_VALUE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ENUMERATED_VALUES_TYPE__ENUMERATED_VALUE:

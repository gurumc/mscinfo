 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.impl.SegmentsTypeImpl#getSegment <em>Segment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SegmentsTypeImpl extends MinimalEObjectImpl.Container implements SegmentsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getSegmentsType();
	}
	...
	public EList<SegmentType> getSegment() {
		if (segment == null) {
			segment = new EObjectContainmentEList<SegmentType>(SegmentType.class, this, spiritPackage.SEGMENTS_TYPE__SEGMENT);
		}
		return segment;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.SEGMENTS_TYPE__SEGMENT:

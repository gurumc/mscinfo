...
public class NameValueTypeTypeImpl extends NameValuePairTypeImpl implements NameValueTypeType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getNameValueTypeType();
	}
	...
	public void setDataType(String newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.NAME_VALUE_TYPE_TYPE__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setUsageType(UsageTypeType newUsageType) {
		...
		usageTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.NAME_VALUE_TYPE_TYPE__USAGE_TYPE, oldUsageType, usageType, !oldUsageTypeESet));
	}
	...
	public void unsetUsageType() {
		...
		usageTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.NAME_VALUE_TYPE_TYPE__USAGE_TYPE, oldUsageType, USAGE_TYPE_EDEFAULT, oldUsageTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.NAME_VALUE_TYPE_TYPE__DATA_TYPE:
				return getDataType();
			case spiritPackage.NAME_VALUE_TYPE_TYPE__USAGE_TYPE:
				return getUsageType();
		}

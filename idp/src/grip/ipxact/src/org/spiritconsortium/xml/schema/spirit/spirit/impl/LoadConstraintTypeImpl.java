 ...
 * @generated
 */
public class LoadConstraintTypeImpl extends MinimalEObjectImpl.Container implements LoadConstraintType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getLoadConstraintType();
	}
	...
	public NotificationChain basicSetCellSpecification(CellSpecificationType newCellSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.LOAD_CONSTRAINT_TYPE__CELL_SPECIFICATION, oldCellSpecification, newCellSpecification);
	...
	public void setCellSpecification(CellSpecificationType newCellSpecification) {
		if (newCellSpecification != cellSpecification) {
			...
			if (cellSpecification != null)
				msgs = ((InternalEObject)cellSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LOAD_CONSTRAINT_TYPE__CELL_SPECIFICATION, null, msgs);
			if (newCellSpecification != null)
				msgs = ((InternalEObject)newCellSpecification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.LOAD_CONSTRAINT_TYPE__CELL_SPECIFICATION, null, msgs);
			msgs = basicSetCellSpecification(newCellSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOAD_CONSTRAINT_TYPE__CELL_SPECIFICATION, newCellSpecification, newCellSpecification));
	}
	...
	public void setCount(BigInteger newCount) {
		...
		countESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LOAD_CONSTRAINT_TYPE__COUNT, oldCount, count, !oldCountESet));
	}
	...
	public void unsetCount() {
		...
		countESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.LOAD_CONSTRAINT_TYPE__COUNT, oldCount, COUNT_EDEFAULT, oldCountESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.LOAD_CONSTRAINT_TYPE__CELL_SPECIFICATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case spiritPackage.LOAD_CONSTRAINT_TYPE__COUNT:
				return getCount();
		}

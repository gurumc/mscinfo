 ...
 * @generated
 */
public class ClockDriverTypeImpl extends MinimalEObjectImpl.Container implements ClockDriverType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getClockDriverType();
	}
	...
	public NotificationChain basicSetClockPeriod(ClockPeriodType newClockPeriod, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PERIOD, oldClockPeriod, newClockPeriod);
	...
	public void setClockPeriod(ClockPeriodType newClockPeriod) {
		if (newClockPeriod != clockPeriod) {
			...
			if (clockPeriod != null)
				msgs = ((InternalEObject)clockPeriod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PERIOD, null, msgs);
			if (newClockPeriod != null)
				msgs = ((InternalEObject)newClockPeriod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PERIOD, null, msgs);
			msgs = basicSetClockPeriod(newClockPeriod, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PERIOD, newClockPeriod, newClockPeriod));
	}
	...
	public NotificationChain basicSetClockPulseOffset(ClockPulseOffsetType newClockPulseOffset, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_OFFSET, oldClockPulseOffset, newClockPulseOffset);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setClockPulseOffset(ClockPulseOffsetType newClockPulseOffset) {
		if (newClockPulseOffset != clockPulseOffset) {
			...
			if (clockPulseOffset != null)
				msgs = ((InternalEObject)clockPulseOffset).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_OFFSET, null, msgs);
			if (newClockPulseOffset != null)
				msgs = ((InternalEObject)newClockPulseOffset).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_OFFSET, null, msgs);
			msgs = basicSetClockPulseOffset(newClockPulseOffset, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_OFFSET, newClockPulseOffset, newClockPulseOffset));
	}
	...
	public NotificationChain basicSetClockPulseValue(ClockPulseValueType newClockPulseValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_VALUE, oldClockPulseValue, newClockPulseValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setClockPulseValue(ClockPulseValueType newClockPulseValue) {
		if (newClockPulseValue != clockPulseValue) {
			...
			if (clockPulseValue != null)
				msgs = ((InternalEObject)clockPulseValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_VALUE, null, msgs);
			if (newClockPulseValue != null)
				msgs = ((InternalEObject)newClockPulseValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_VALUE, null, msgs);
			msgs = basicSetClockPulseValue(newClockPulseValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_VALUE, newClockPulseValue, newClockPulseValue));
	}
	...
	public NotificationChain basicSetClockPulseDuration(ClockPulseDurationType newClockPulseDuration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_DURATION, oldClockPulseDuration, newClockPulseDuration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setClockPulseDuration(ClockPulseDurationType newClockPulseDuration) {
		if (newClockPulseDuration != clockPulseDuration) {
			...
			if (clockPulseDuration != null)
				msgs = ((InternalEObject)clockPulseDuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_DURATION, null, msgs);
			if (newClockPulseDuration != null)
				msgs = ((InternalEObject)newClockPulseDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_DURATION, null, msgs);
			msgs = basicSetClockPulseDuration(newClockPulseDuration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_DURATION, newClockPulseDuration, newClockPulseDuration));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PERIOD:
				return basicSetClockPeriod(null, msgs);
			case spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_OFFSET:
				return basicSetClockPulseOffset(null, msgs);
			case spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_VALUE:
				return basicSetClockPulseValue(null, msgs);
			case spiritPackage.CLOCK_DRIVER_TYPE__CLOCK_PULSE_DURATION:

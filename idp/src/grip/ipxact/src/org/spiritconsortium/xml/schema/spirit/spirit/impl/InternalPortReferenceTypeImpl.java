 ...
 * @generated
 */
public class InternalPortReferenceTypeImpl extends MinimalEObjectImpl.Container implements InternalPortReferenceType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getInternalPortReferenceType();
	}
	...
	public void setComponentRef(String newComponentRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__COMPONENT_REF, oldComponentRef, componentRef));
	}
	...
	public void setLeft(BigInteger newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__LEFT, oldLeft, left));
	}
	...
	public void setPortRef(String newPortRef) {
		...
		portRef = newPortRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__PORT_REF, oldPortRef, portRef));
	}
	...
	public void setRight(BigInteger newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__RIGHT, oldRight, right));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__COMPONENT_REF:
				return getComponentRef();
			case spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__LEFT:
				return getLeft();
			case spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__PORT_REF:
				return getPortRef();
			case spiritPackage.INTERNAL_PORT_REFERENCE_TYPE__RIGHT:
				return getRight();
		}

 ...
 * @generated
 */
public class OnMasterTypeImpl extends MinimalEObjectImpl.Container implements OnMasterType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getOnMasterType();
	}
	...
	public void setPresence(PresenceType newPresence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_MASTER_TYPE__PRESENCE, oldPresence, presence, !oldPresenceESet));
	}
	...
	public void unsetPresence() {
		...
		presenceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.ON_MASTER_TYPE__PRESENCE, oldPresence, PRESENCE_EDEFAULT, oldPresenceESet));
	}
	...
	public NotificationChain basicSetService(ServiceType newService, NotificationChain msgs) {
		...
		service = newService;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.ON_MASTER_TYPE__SERVICE, oldService, newService);
	...
	public void setService(ServiceType newService) {
		if (newService != service) {
			...
			if (service != null)
				msgs = ((InternalEObject)service).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ON_MASTER_TYPE__SERVICE, null, msgs);
			if (newService != null)
				msgs = ((InternalEObject)newService).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.ON_MASTER_TYPE__SERVICE, null, msgs);
			msgs = basicSetService(newService, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.ON_MASTER_TYPE__SERVICE, newService, newService));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ON_MASTER_TYPE__SERVICE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ON_MASTER_TYPE__PRESENCE:
				return getPresence();
			case spiritPackage.ON_MASTER_TYPE__SERVICE:
				return getService();
		}

 ...
 * @generated
 */
public class GeneratorType1Impl extends MinimalEObjectImpl.Container implements GeneratorType1 {
	/**
	 ...
	 * @ordered
	 */
	protected static final ApiTypeType API_TYPE_EDEFAULT = ApiTypeType.TGI;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getGeneratorType1();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetPhase(PhaseType newPhase, NotificationChain msgs) {
		...
		phase = newPhase;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__PHASE, oldPhase, newPhase);
	...
	public void setPhase(PhaseType newPhase) {
		if (newPhase != phase) {
			...
			if (phase != null)
				msgs = ((InternalEObject)phase).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__PHASE, null, msgs);
			if (newPhase != null)
				msgs = ((InternalEObject)newPhase).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__PHASE, null, msgs);
			msgs = basicSetPhase(newPhase, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__PHASE, newPhase, newPhase));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__PARAMETERS, newParameters, newParameters));
	}
	...
	public void setApiType(ApiTypeType newApiType) {
		...
		apiTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__API_TYPE, oldApiType, apiType, !oldApiTypeESet));
	}
	...
	public void unsetApiType() {
		...
		apiTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.GENERATOR_TYPE1__API_TYPE, oldApiType, API_TYPE_EDEFAULT, oldApiTypeESet));
	}
	...
	public NotificationChain basicSetTransportMethods(TransportMethodsType newTransportMethods, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__TRANSPORT_METHODS, oldTransportMethods, newTransportMethods);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTransportMethods(TransportMethodsType newTransportMethods) {
		if (newTransportMethods != transportMethods) {
			...
			if (transportMethods != null)
				msgs = ((InternalEObject)transportMethods).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__TRANSPORT_METHODS, null, msgs);
			if (newTransportMethods != null)
				msgs = ((InternalEObject)newTransportMethods).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__TRANSPORT_METHODS, null, msgs);
			msgs = basicSetTransportMethods(newTransportMethods, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__TRANSPORT_METHODS, newTransportMethods, newTransportMethods));
	}
	...
	public void setGeneratorExe(String newGeneratorExe) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__GENERATOR_EXE, oldGeneratorExe, generatorExe));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.GENERATOR_TYPE1__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setHidden(boolean newHidden) {
		...
		hiddenESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.GENERATOR_TYPE1__HIDDEN, oldHidden, hidden, !oldHiddenESet));
	}
	...
	public void unsetHidden() {
		...
		hiddenESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.GENERATOR_TYPE1__HIDDEN, oldHidden, HIDDEN_EDEFAULT, oldHiddenESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.GENERATOR_TYPE1__PHASE:
				return basicSetPhase(null, msgs);
			case spiritPackage.GENERATOR_TYPE1__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.GENERATOR_TYPE1__TRANSPORT_METHODS:
				return basicSetTransportMethods(null, msgs);
			case spiritPackage.GENERATOR_TYPE1__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.GENERATOR_TYPE1__NAME:
				return getName();
			case spiritPackage.GENERATOR_TYPE1__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.GENERATOR_TYPE1__DESCRIPTION:
				return getDescription();
			case spiritPackage.GENERATOR_TYPE1__PHASE:
				return getPhase();
			case spiritPackage.GENERATOR_TYPE1__PARAMETERS:
				return getParameters();
			case spiritPackage.GENERATOR_TYPE1__API_TYPE:
				return getApiType();
			case spiritPackage.GENERATOR_TYPE1__TRANSPORT_METHODS:
				return getTransportMethods();
			case spiritPackage.GENERATOR_TYPE1__GENERATOR_EXE:
				return getGeneratorExe();
			case spiritPackage.GENERATOR_TYPE1__VENDOR_EXTENSIONS:
				return getVendorExtensions();
			case spiritPackage.GENERATOR_TYPE1__HIDDEN:
				return isHidden();
		}

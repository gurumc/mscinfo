...
public class AlternateGroupsTypeImpl extends MinimalEObjectImpl.Container implements AlternateGroupsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAlternateGroupsType();
	}
	...
	public EList<String> getAlternateGroup() {
		if (alternateGroup == null) {
			alternateGroup = new EDataTypeEList<String>(String.class, this, spiritPackage.ALTERNATE_GROUPS_TYPE__ALTERNATE_GROUP);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.ALTERNATE_GROUPS_TYPE__ALTERNATE_GROUP:

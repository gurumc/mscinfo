 ...
 * @generated
 */
public class BusInterfaceTypeImpl extends MinimalEObjectImpl.Container implements BusInterfaceType {
	/**
	 ...
	 * @ordered
	 */
	protected static final EndianessType ENDIANNESS_EDEFAULT = EndianessType.BIG;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getBusInterfaceType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetBusType(LibraryRefType newBusType, NotificationChain msgs) {
		...
		busType = newBusType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__BUS_TYPE, oldBusType, newBusType);
	...
	public void setBusType(LibraryRefType newBusType) {
		if (newBusType != busType) {
			...
			if (busType != null)
				msgs = ((InternalEObject)busType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__BUS_TYPE, null, msgs);
			if (newBusType != null)
				msgs = ((InternalEObject)newBusType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__BUS_TYPE, null, msgs);
			msgs = basicSetBusType(newBusType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__BUS_TYPE, newBusType, newBusType));
	}
	...
	public NotificationChain basicSetAbstractionType(LibraryRefType newAbstractionType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, oldAbstractionType, newAbstractionType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAbstractionType(LibraryRefType newAbstractionType) {
		if (newAbstractionType != abstractionType) {
			...
			if (abstractionType != null)
				msgs = ((InternalEObject)abstractionType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, null, msgs);
			if (newAbstractionType != null)
				msgs = ((InternalEObject)newAbstractionType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, null, msgs);
			msgs = basicSetAbstractionType(newAbstractionType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__ABSTRACTION_TYPE, newAbstractionType, newAbstractionType));
	}
	...
	public NotificationChain basicSetMaster(MasterType newMaster, NotificationChain msgs) {
		...
		master = newMaster;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MASTER, oldMaster, newMaster);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaster(MasterType newMaster) {
		if (newMaster != master) {
			NotificationChain msgs = null;
			if (master != null)
				msgs = ((InternalEObject)master).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MASTER, null, msgs);
			if (newMaster != null)
				msgs = ((InternalEObject)newMaster).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MASTER, null, msgs);
			msgs = basicSetMaster(newMaster, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MASTER, newMaster, newMaster));
	}
	...
	public NotificationChain basicSetSlave(SlaveType newSlave, NotificationChain msgs) {
		...
		slave = newSlave;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__SLAVE, oldSlave, newSlave);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSlave(SlaveType newSlave) {
		if (newSlave != slave) {
			NotificationChain msgs = null;
			if (slave != null)
				msgs = ((InternalEObject)slave).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__SLAVE, null, msgs);
			if (newSlave != null)
				msgs = ((InternalEObject)newSlave).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__SLAVE, null, msgs);
			msgs = basicSetSlave(newSlave, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__SLAVE, newSlave, newSlave));
	}
	...
	public NotificationChain basicSetSystem(SystemType newSystem, NotificationChain msgs) {
		...
		system = newSystem;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__SYSTEM, oldSystem, newSystem);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSystem(SystemType newSystem) {
		if (newSystem != system) {
			NotificationChain msgs = null;
			if (system != null)
				msgs = ((InternalEObject)system).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__SYSTEM, null, msgs);
			if (newSystem != null)
				msgs = ((InternalEObject)newSystem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__SYSTEM, null, msgs);
			msgs = basicSetSystem(newSystem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__SYSTEM, newSystem, newSystem));
	}
	...
	public NotificationChain basicSetMirroredSlave(MirroredSlaveType newMirroredSlave, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SLAVE, oldMirroredSlave, newMirroredSlave);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMirroredSlave(MirroredSlaveType newMirroredSlave) {
		if (newMirroredSlave != mirroredSlave) {
			...
			if (mirroredSlave != null)
				msgs = ((InternalEObject)mirroredSlave).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SLAVE, null, msgs);
			if (newMirroredSlave != null)
				msgs = ((InternalEObject)newMirroredSlave).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SLAVE, null, msgs);
			msgs = basicSetMirroredSlave(newMirroredSlave, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SLAVE, newMirroredSlave, newMirroredSlave));
	}
	...
	public NotificationChain basicSetMirroredMaster(MirroredMasterType newMirroredMaster, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_MASTER, oldMirroredMaster, newMirroredMaster);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMirroredMaster(MirroredMasterType newMirroredMaster) {
		if (newMirroredMaster != mirroredMaster) {
			...
			if (mirroredMaster != null)
				msgs = ((InternalEObject)mirroredMaster).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_MASTER, null, msgs);
			if (newMirroredMaster != null)
				msgs = ((InternalEObject)newMirroredMaster).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_MASTER, null, msgs);
			msgs = basicSetMirroredMaster(newMirroredMaster, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_MASTER, newMirroredMaster, newMirroredMaster));
	}
	...
	public NotificationChain basicSetMirroredSystem(MirroredSystemType newMirroredSystem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SYSTEM, oldMirroredSystem, newMirroredSystem);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMirroredSystem(MirroredSystemType newMirroredSystem) {
		if (newMirroredSystem != mirroredSystem) {
			...
			if (mirroredSystem != null)
				msgs = ((InternalEObject)mirroredSystem).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SYSTEM, null, msgs);
			if (newMirroredSystem != null)
				msgs = ((InternalEObject)newMirroredSystem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SYSTEM, null, msgs);
			msgs = basicSetMirroredSystem(newMirroredSystem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SYSTEM, newMirroredSystem, newMirroredSystem));
	}
	...
	public NotificationChain basicSetMonitor(MonitorType newMonitor, NotificationChain msgs) {
		...
		monitor = newMonitor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MONITOR, oldMonitor, newMonitor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMonitor(MonitorType newMonitor) {
		if (newMonitor != monitor) {
			NotificationChain msgs = null;
			if (monitor != null)
				msgs = ((InternalEObject)monitor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MONITOR, null, msgs);
			if (newMonitor != null)
				msgs = ((InternalEObject)newMonitor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__MONITOR, null, msgs);
			msgs = basicSetMonitor(newMonitor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__MONITOR, newMonitor, newMonitor));
	}
	...
	public void setConnectionRequired(boolean newConnectionRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__CONNECTION_REQUIRED, oldConnectionRequired, connectionRequired, !oldConnectionRequiredESet));
	}
	...
	public void unsetConnectionRequired() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.BUS_INTERFACE_TYPE__CONNECTION_REQUIRED, oldConnectionRequired, CONNECTION_REQUIRED_EDEFAULT, oldConnectionRequiredESet));
	}
	...
	public NotificationChain basicSetPortMaps(PortMapsType newPortMaps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__PORT_MAPS, oldPortMaps, newPortMaps);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPortMaps(PortMapsType newPortMaps) {
		if (newPortMaps != portMaps) {
			NotificationChain msgs = null;
			if (portMaps != null)
				msgs = ((InternalEObject)portMaps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__PORT_MAPS, null, msgs);
			if (newPortMaps != null)
				msgs = ((InternalEObject)newPortMaps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__PORT_MAPS, null, msgs);
			msgs = basicSetPortMaps(newPortMaps, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__PORT_MAPS, newPortMaps, newPortMaps));
	}
	...
	public void setBitsInLau(BigInteger newBitsInLau) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__BITS_IN_LAU, oldBitsInLau, bitsInLau));
	}
	...
	public NotificationChain basicSetBitSteering(BitSteeringType1 newBitSteering, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__BIT_STEERING, oldBitSteering, newBitSteering);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBitSteering(BitSteeringType1 newBitSteering) {
		if (newBitSteering != bitSteering) {
			NotificationChain msgs = null;
			if (bitSteering != null)
				msgs = ((InternalEObject)bitSteering).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__BIT_STEERING, null, msgs);
			if (newBitSteering != null)
				msgs = ((InternalEObject)newBitSteering).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__BIT_STEERING, null, msgs);
			msgs = basicSetBitSteering(newBitSteering, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__BIT_STEERING, newBitSteering, newBitSteering));
	}
	...
	public void setEndianness(EndianessType newEndianness) {
		...
		endiannessESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__ENDIANNESS, oldEndianness, endianness, !oldEndiannessESet));
	}
	...
	public void unsetEndianness() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.BUS_INTERFACE_TYPE__ENDIANNESS, oldEndianness, ENDIANNESS_EDEFAULT, oldEndiannessESet));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, spiritPackage.BUS_INTERFACE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.BUS_INTERFACE_TYPE__BUS_TYPE:
				return basicSetBusType(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__ABSTRACTION_TYPE:
				return basicSetAbstractionType(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__MASTER:
				return basicSetMaster(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__SLAVE:
				return basicSetSlave(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__SYSTEM:
				return basicSetSystem(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SLAVE:
				return basicSetMirroredSlave(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_MASTER:
				return basicSetMirroredMaster(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__MIRRORED_SYSTEM:
				return basicSetMirroredSystem(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__MONITOR:
				return basicSetMonitor(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__PORT_MAPS:
				return basicSetPortMaps(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__BIT_STEERING:
				return basicSetBitSteering(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__PARAMETERS:
				return basicSetParameters(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__VENDOR_EXTENSIONS:
				return basicSetVendorExtensions(null, msgs);
			case spiritPackage.BUS_INTERFACE_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.BUS_INTERFACE_TYPE__NAME:
				return getName();
			case spiritPackage.BUS_INTERFACE_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.BUS_INTERFACE_TYPE__DESCRIPTION:
			...
			case spiritPackage.BUS_INTERFACE_TYPE__MONITOR:
				return getMonitor();
			case spiritPackage.BUS_INTERFACE_TYPE__CONNECTION_REQUIRED:
				return isConnectionRequired();
			case spiritPackage.BUS_INTERFACE_TYPE__PORT_MAPS:
				return getPortMaps();
			case spiritPackage.BUS_INTERFACE_TYPE__BITS_IN_LAU:
				return getBitsInLau();
			case spiritPackage.BUS_INTERFACE_TYPE__BIT_STEERING:
				return getBitSteering();
			case spiritPackage.BUS_INTERFACE_TYPE__ENDIANNESS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.BUS_INTERFACE_TYPE__MONITOR:
				...
				return;
			case spiritPackage.BUS_INTERFACE_TYPE__CONNECTION_REQUIRED:
				setConnectionRequired((Boolean)newValue);
				return;
			case spiritPackage.BUS_INTERFACE_TYPE__PORT_MAPS:

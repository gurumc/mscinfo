...
public class IsIncludeFileTypeImpl extends MinimalEObjectImpl.Container implements IsIncludeFileType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getIsIncludeFileType();
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.IS_INCLUDE_FILE_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.IS_INCLUDE_FILE_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setExternalDeclarations(boolean newExternalDeclarations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.IS_INCLUDE_FILE_TYPE__EXTERNAL_DECLARATIONS, oldExternalDeclarations, externalDeclarations, !oldExternalDeclarationsESet));
	}
	...
	public void unsetExternalDeclarations() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.IS_INCLUDE_FILE_TYPE__EXTERNAL_DECLARATIONS, oldExternalDeclarations, EXTERNAL_DECLARATIONS_EDEFAULT, oldExternalDeclarationsESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.IS_INCLUDE_FILE_TYPE__VALUE:
				return isValue();
			case spiritPackage.IS_INCLUDE_FILE_TYPE__EXTERNAL_DECLARATIONS:

 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getLogicalName <em>Logical Name</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getDisplayName <em>Display Name</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getDescription <em>Description</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getWire <em>Wire</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getTransactional <em>Transactional</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getVendorExtensions <em>Vendor Extensions</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getPortType()
...
public interface PortType extends EObject {
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getPortType_LogicalName()
	...
	/**
	 * Sets the value of the '{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getLogicalName <em>Logical Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getPortType_DisplayName()
	...
	/**
	 * Sets the value of the '{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getDisplayName <em>Display Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getPortType_Description()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getDescription <em>Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getPortType_Wire()
	...
	/**
	 * Sets the value of the '{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getWire <em>Wire</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getPortType_Transactional()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.spiritconsortium.xml.schema.spirit.spirit.PortType#getTransactional <em>Transactional</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.spiritconsortium.xml.schema.spirit.spirit.spiritPackage#getPortType_VendorExtensions()
	 * @model containment="true"

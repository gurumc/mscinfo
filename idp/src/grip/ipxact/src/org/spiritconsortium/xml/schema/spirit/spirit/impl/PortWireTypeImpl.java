 ...
 * @generated
 */
public class PortWireTypeImpl extends MinimalEObjectImpl.Container implements PortWireType {
	/**
	 ...
	 * @ordered
	 */
	protected static final ComponentPortDirectionType DIRECTION_EDEFAULT = ComponentPortDirectionType.IN;
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getPortWireType();
	}
	...
	public void setDirection(ComponentPortDirectionType newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__DIRECTION, oldDirection, direction, !oldDirectionESet));
	}
	...
	public void unsetDirection() {
		...
		directionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.PORT_WIRE_TYPE__DIRECTION, oldDirection, DIRECTION_EDEFAULT, oldDirectionESet));
	}
	...
	public NotificationChain basicSetVector(VectorType2 newVector, NotificationChain msgs) {
		...
		vector = newVector;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__VECTOR, oldVector, newVector);
	...
	public void setVector(VectorType2 newVector) {
		if (newVector != vector) {
			...
			if (vector != null)
				msgs = ((InternalEObject)vector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__VECTOR, null, msgs);
			if (newVector != null)
				msgs = ((InternalEObject)newVector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__VECTOR, null, msgs);
			msgs = basicSetVector(newVector, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__VECTOR, newVector, newVector));
	}
	...
	public NotificationChain basicSetWireTypeDefs(WireTypeDefsType newWireTypeDefs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__WIRE_TYPE_DEFS, oldWireTypeDefs, newWireTypeDefs);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWireTypeDefs(WireTypeDefsType newWireTypeDefs) {
		if (newWireTypeDefs != wireTypeDefs) {
			...
			if (wireTypeDefs != null)
				msgs = ((InternalEObject)wireTypeDefs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__WIRE_TYPE_DEFS, null, msgs);
			if (newWireTypeDefs != null)
				msgs = ((InternalEObject)newWireTypeDefs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__WIRE_TYPE_DEFS, null, msgs);
			msgs = basicSetWireTypeDefs(newWireTypeDefs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__WIRE_TYPE_DEFS, newWireTypeDefs, newWireTypeDefs));
	}
	...
	public NotificationChain basicSetDriver(DriverType newDriver, NotificationChain msgs) {
		...
		driver = newDriver;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__DRIVER, oldDriver, newDriver);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDriver(DriverType newDriver) {
		if (newDriver != driver) {
			NotificationChain msgs = null;
			if (driver != null)
				msgs = ((InternalEObject)driver).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__DRIVER, null, msgs);
			if (newDriver != null)
				msgs = ((InternalEObject)newDriver).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__DRIVER, null, msgs);
			msgs = basicSetDriver(newDriver, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__DRIVER, newDriver, newDriver));
	}
	...
	public NotificationChain basicSetConstraintSets(ConstraintSetsType newConstraintSets, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__CONSTRAINT_SETS, oldConstraintSets, newConstraintSets);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConstraintSets(ConstraintSetsType newConstraintSets) {
		if (newConstraintSets != constraintSets) {
			...
			if (constraintSets != null)
				msgs = ((InternalEObject)constraintSets).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__CONSTRAINT_SETS, null, msgs);
			if (newConstraintSets != null)
				msgs = ((InternalEObject)newConstraintSets).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.PORT_WIRE_TYPE__CONSTRAINT_SETS, null, msgs);
			msgs = basicSetConstraintSets(newConstraintSets, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__CONSTRAINT_SETS, newConstraintSets, newConstraintSets));
	}
	...
	public void setAllLogicalDirectionsAllowed(boolean newAllLogicalDirectionsAllowed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.PORT_WIRE_TYPE__ALL_LOGICAL_DIRECTIONS_ALLOWED, oldAllLogicalDirectionsAllowed, allLogicalDirectionsAllowed, !oldAllLogicalDirectionsAllowedESet));
	}
	...
	public void unsetAllLogicalDirectionsAllowed() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.PORT_WIRE_TYPE__ALL_LOGICAL_DIRECTIONS_ALLOWED, oldAllLogicalDirectionsAllowed, ALL_LOGICAL_DIRECTIONS_ALLOWED_EDEFAULT, oldAllLogicalDirectionsAllowedESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.PORT_WIRE_TYPE__VECTOR:
				return basicSetVector(null, msgs);
			case spiritPackage.PORT_WIRE_TYPE__WIRE_TYPE_DEFS:
				return basicSetWireTypeDefs(null, msgs);
			case spiritPackage.PORT_WIRE_TYPE__DRIVER:
				return basicSetDriver(null, msgs);
			case spiritPackage.PORT_WIRE_TYPE__CONSTRAINT_SETS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.PORT_WIRE_TYPE__DIRECTION:
				return getDirection();
			case spiritPackage.PORT_WIRE_TYPE__VECTOR:
				return getVector();
			case spiritPackage.PORT_WIRE_TYPE__WIRE_TYPE_DEFS:
			...
			case spiritPackage.PORT_WIRE_TYPE__ALL_LOGICAL_DIRECTIONS_ALLOWED:
				return isAllLogicalDirectionsAllowed();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case spiritPackage.PORT_WIRE_TYPE__CONSTRAINT_SETS:
				...
				return;
			case spiritPackage.PORT_WIRE_TYPE__ALL_LOGICAL_DIRECTIONS_ALLOWED:
				setAllLogicalDirectionsAllowed((Boolean)newValue);
				return;
		}

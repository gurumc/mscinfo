 ...
 * @generated
 */
public class LibraryRefTypeImpl extends MinimalEObjectImpl.Container implements LibraryRefType {
	/**
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getLibraryRefType();
	}
	...
	public void setLibrary(String newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LIBRARY_REF_TYPE__LIBRARY, oldLibrary, library));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LIBRARY_REF_TYPE__NAME, oldName, name));
	}
	...
	public void setVendor(String newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LIBRARY_REF_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.LIBRARY_REF_TYPE__VERSION, oldVersion, version));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.LIBRARY_REF_TYPE__LIBRARY:
				return getLibrary();
			case spiritPackage.LIBRARY_REF_TYPE__NAME:
				return getName();
			case spiritPackage.LIBRARY_REF_TYPE__VENDOR:
				return getVendor();
			case spiritPackage.LIBRARY_REF_TYPE__VERSION:
				return getVersion();
		}

...
public class FileSetTypeImpl extends MinimalEObjectImpl.Container implements FileSetType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFileSetType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_SET_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_SET_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_SET_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<String> getGroup() {
		if (group == null) {
			group = new EDataTypeEList<String>(String.class, this, spiritPackage.FILE_SET_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<FileType> getFile() {
		if (file == null) {
			file = new EObjectContainmentEList<FileType>(FileType.class, this, spiritPackage.FILE_SET_TYPE__FILE);
		}
		return file;
	}
	...
	public EList<FileBuilderType> getDefaultFileBuilder() {
		if (defaultFileBuilder == null) {
			defaultFileBuilder = new EObjectContainmentEList<FileBuilderType>(FileBuilderType.class, this, spiritPackage.FILE_SET_TYPE__DEFAULT_FILE_BUILDER);
		}
	...
	public EList<String> getDependency() {
		if (dependency == null) {
			dependency = new EDataTypeEList<String>(String.class, this, spiritPackage.FILE_SET_TYPE__DEPENDENCY);
		}
		return dependency;
	}
	...
	public EList<FunctionType> getFunction() {
		if (function == null) {
			function = new EObjectContainmentEList<FunctionType>(FunctionType.class, this, spiritPackage.FILE_SET_TYPE__FUNCTION);
		}
		return function;
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_SET_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_SET_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - spiritPackage.FILE_SET_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_SET_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.FILE_SET_TYPE__FILE:
				return ((InternalEList<?>)getFile()).basicRemove(otherEnd, msgs);
			case spiritPackage.FILE_SET_TYPE__DEFAULT_FILE_BUILDER:
				return ((InternalEList<?>)getDefaultFileBuilder()).basicRemove(otherEnd, msgs);
			case spiritPackage.FILE_SET_TYPE__FUNCTION:
				return ((InternalEList<?>)getFunction()).basicRemove(otherEnd, msgs);
			case spiritPackage.FILE_SET_TYPE__VENDOR_EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.FILE_SET_TYPE__NAME:
				return getName();
			case spiritPackage.FILE_SET_TYPE__DISPLAY_NAME:
				return getDisplayName();
			case spiritPackage.FILE_SET_TYPE__DESCRIPTION:
				return getDescription();
			case spiritPackage.FILE_SET_TYPE__GROUP:
				return getGroup();
			case spiritPackage.FILE_SET_TYPE__FILE:
				return getFile();
			case spiritPackage.FILE_SET_TYPE__DEFAULT_FILE_BUILDER:
				return getDefaultFileBuilder();
			case spiritPackage.FILE_SET_TYPE__DEPENDENCY:

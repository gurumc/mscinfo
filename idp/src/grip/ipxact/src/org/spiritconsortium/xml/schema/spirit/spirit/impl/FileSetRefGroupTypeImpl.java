...
public class FileSetRefGroupTypeImpl extends MinimalEObjectImpl.Container implements FileSetRefGroupType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getFileSetRefGroupType();
	}
	...
	public void setGroup(String newGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.FILE_SET_REF_GROUP_TYPE__GROUP, oldGroup, group));
	}
	...
	public EList<FileSetRefType> getFileSetRef() {
		if (fileSetRef == null) {
			fileSetRef = new EObjectContainmentEList<FileSetRefType>(FileSetRefType.class, this, spiritPackage.FILE_SET_REF_GROUP_TYPE__FILE_SET_REF);
		}
		return fileSetRef;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.FILE_SET_REF_GROUP_TYPE__FILE_SET_REF:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.FILE_SET_REF_GROUP_TYPE__GROUP:
				return getGroup();
			case spiritPackage.FILE_SET_REF_GROUP_TYPE__FILE_SET_REF:

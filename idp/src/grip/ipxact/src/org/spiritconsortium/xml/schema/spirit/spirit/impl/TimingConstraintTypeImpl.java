...
public class TimingConstraintTypeImpl extends MinimalEObjectImpl.Container implements TimingConstraintType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getTimingConstraintType();
	}
	...
	public void setValue(float newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TIMING_CONSTRAINT_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.TIMING_CONSTRAINT_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setClockEdge(EdgeValueType newClockEdge) {
		...
		clockEdgeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TIMING_CONSTRAINT_TYPE__CLOCK_EDGE, oldClockEdge, clockEdge, !oldClockEdgeESet));
	}
	...
	public void unsetClockEdge() {
		...
		clockEdgeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.TIMING_CONSTRAINT_TYPE__CLOCK_EDGE, oldClockEdge, CLOCK_EDGE_EDEFAULT, oldClockEdgeESet));
	}
	...
	public void setClockName(String newClockName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TIMING_CONSTRAINT_TYPE__CLOCK_NAME, oldClockName, clockName));
	}
	...
	public void setDelayType(DelayValueType newDelayType) {
		...
		delayTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, spiritPackage.TIMING_CONSTRAINT_TYPE__DELAY_TYPE, oldDelayType, delayType, !oldDelayTypeESet));
	}
	...
	public void unsetDelayType() {
		...
		delayTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, spiritPackage.TIMING_CONSTRAINT_TYPE__DELAY_TYPE, oldDelayType, DELAY_TYPE_EDEFAULT, oldDelayTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case spiritPackage.TIMING_CONSTRAINT_TYPE__VALUE:
				return getValue();
			case spiritPackage.TIMING_CONSTRAINT_TYPE__CLOCK_EDGE:
				return getClockEdge();
			case spiritPackage.TIMING_CONSTRAINT_TYPE__CLOCK_NAME:
				return getClockName();
			case spiritPackage.TIMING_CONSTRAINT_TYPE__DELAY_TYPE:
				return getDelayType();
		}

...
public class AbstractorsTypeImpl extends MinimalEObjectImpl.Container implements AbstractorsType {
	...
	protected EClass eStaticClass() {
		return spiritPackage.eINSTANCE.getAbstractorsType();
	}
	...
	public EList<AbstractorType> getAbstractor() {
		if (abstractor == null) {
			abstractor = new EObjectContainmentEList<AbstractorType>(AbstractorType.class, this, spiritPackage.ABSTRACTORS_TYPE__ABSTRACTOR);
		}
		return abstractor;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case spiritPackage.ABSTRACTORS_TYPE__ABSTRACTOR:

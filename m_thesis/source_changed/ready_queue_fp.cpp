...
//  typename List::BaseIterator it = List::iter(prio_next[prio_highest].front());
//    dbgprintf("fp_rq: ");
//    do
//    {
//      dbgprintf("%lx => ",Kobject_dbg::obj_to_id(it->context()));
//    }while (++it != List::iter(prio_next[prio_highest].front()));
//    dbgprintf("end\n");
...
//template<typename E>
//bool
//Ready_queue_fp<E>::rqfp_empty(unsigned prio)
//{
//	return prio_next[prio].empty();
//}
